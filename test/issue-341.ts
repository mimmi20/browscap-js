...
suite('checking for issue 341. (2 tests)', function() {
  test('issue-341-A ["Mozilla/5.0 (Linux; GoogleTV 3.2; NSZ-GS7/GX70 Build/MASTER) AppleWebKit/534.24 (KHTML, like Gecko) Chrome/11.0.696.77 Safari/534.24"]', function() {
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Platform\" to be 'Android for GoogleTV' (was '" +
        browser['Platform'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'Android OS for GoogleTV',
      "Expected actual \"Platform_Description\" to be 'Android OS for GoogleTV' (was '" +
        browser['Platform_Description'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'NSZ-GS7/GX70',
      "Expected actual \"Device_Name\" to be 'NSZ-GS7/GX70' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'NSZ-GS7/GX70',
      "Expected actual \"Device_Code_Name\" to be 'NSZ-GS7/GX70' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-341-B ["Mozilla/5.0 (X11; Linux i686) AppleWebKit/534.24 (KHTML, like Gecko) Chrome/11.0.696.77 Large Screen Safari/534.24 GoogleTV/092754"]', function() {
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'Google TV',
      "Expected actual \"Device_Name\" to be 'Google TV' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Code_Name'],
      'Google TV',
      "Expected actual \"Device_Code_Name\" to be 'Google TV' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
