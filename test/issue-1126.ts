...
suite('checking for issue 1126. (1 test)', function() {
  test('issue-1126 ["Mozilla/5.0 (Linux; Android 5.1.1; SAMSUNG-SM-T817A Build/LMY47X; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/52.0.2743.98 Safari/537.36"]', function() {
    ...
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (Linux; Android 5.1.1; SAMSUNG-SM-T817A Build/LMY47X; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/52.0.2743.98 Safari/537.36'
    );
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'Galaxy Tab S2 9.7 LTE (AT&T)',
      "Expected actual \"Device_Name\" to be 'Galaxy Tab S2 9.7 LTE (AT&T)' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'SM-T817A',
      "Expected actual \"Device_Code_Name\" to be 'SM-T817A' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
