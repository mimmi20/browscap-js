...
suite('checking for issue 2089. (1 test)', function() {
  test('issue-2089-A ["APIs-Google (+https://developers.google.com/webmasters/APIs-Google.html)"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'APIs Google',
      "Expected actual \"Comment\" to be 'APIs Google' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
    ...
    assert.strictEqual(
      browser['Browser'],
      'APIs Google',
      "Expected actual \"Browser\" to be 'APIs Google' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
