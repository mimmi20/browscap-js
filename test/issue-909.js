...
suite('checking for issue 909.', function () {
  test('issue-909 ["Echoping/6.0.2"]', function () {
    ...
    assert.strictEqual(browser['Browser_Maker'], 'Stephane Bortzmeyer', 'Expected actual "Browser_Maker" to be \'Stephane Bortzmeyer\' (was \'' + browser['Browser_Maker'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
