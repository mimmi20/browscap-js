...
suite('checking for issue 184. (26 tests)', function() {
  test('issue-184-A ["Mozilla/4.0 (compatible; MSIE 8.0; Windows NT 6.1; Trident/4.0; Avant Browser; SLCC2; .NET CLR 2.0.50727; .NET CLR 3.5.30729; .NET CLR 3.0.30729; Media Center PC 6.0)"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Avant/IE 8.0',
      "Expected actual \"Comment\" to be 'Avant/IE 8.0' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
    ...
    assert.strictEqual(
      browser['Browser'],
      'Avant',
      "Expected actual \"Browser\" to be 'Avant' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'Avant Force',
      "Expected actual \"Browser_Maker\" to be 'Avant Force' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-184-D ["Mozilla/4.0 (compatible; MSIE 7.0; Windows NT 6.0; Avant Browser; Avant Browser; SLCC1; .NET CLR 2.0.50727; Media Center PC 5.0; .NET CLR 3.0.04506; Tablet PC 2.0)"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Avant/IE 7.0',
      "Expected actual \"Comment\" to be 'Avant/IE 7.0' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-184-G ["Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.2; Avant Browser; Avant Browser; .NET CLR 1.1.4322; .NET CLR 2.0.50727)"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Avant/IE 6.0',
      "Expected actual \"Comment\" to be 'Avant/IE 6.0' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
