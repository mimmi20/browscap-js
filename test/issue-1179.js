...
suite('checking for issue 1179.', function () {
  test('issue-1179-A ["Mozilla/4.0 (compatible; MSIE 6.0; Nitro) Opera 8.50 [ja]"]', function () {
    ...
    assert.strictEqual(browser['Comment'], 'Opera Mobile 8.50', 'Expected actual "Comment" to be \'Opera Mobile 8.50\' (was \'' + browser['Comment'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
