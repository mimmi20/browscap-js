...
suite('checking for issue 969. (1 test)', function () {
  test('issue-969 ["Mozilla/5.0 (compatible; MSIE 10.0; Windows Phone 8.0; Trident/6.0; IEMobile/10.0; ARM; Touch; rv:11; NOKIA; Lumia 920) like Gecko"]', function () {
    const browscap = new Browscap();
    const browser = browscap.getBrowser('Mozilla/5.0 (compatible; MSIE 10.0; Windows Phone 8.0; Trident/6.0; IEMobile/10.0; ARM; Touch; rv:11; NOKIA; Lumia 920) like Gecko');

    assert.strictEqual(browser['Comment'], 'IEMobile 11.0 in IEMobile 10.0 Compatibility Mode', 'Expected actual "Comment" to be \'IEMobile 11.0 in IEMobile 10.0 Compatibility Mode\' (was \'' + browser['Comment'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
    ...
    assert.strictEqual(browser['Browser_Modus'], 'IEMobile 10.0 Compatibility Mode', 'Expected actual "Browser_Modus" to be \'IEMobile 10.0 Compatibility Mode\' (was \'' + browser['Browser_Modus'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
