...
suite('checking for issue 1202. (3 tests)', function() {
  test('issue-1202-1 ["Mozilla/5.0 (compatible; IBrowse 3.0; AmigaOS4.0)"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'IBrowse',
      "Expected actual \"Comment\" to be 'IBrowse' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
    ...
    assert.strictEqual(
      browser['Browser'],
      'IBrowse',
      "Expected actual \"Browser\" to be 'IBrowse' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'Stefan Burstroem',
      "Expected actual \"Browser_Maker\" to be 'Stefan Burstroem' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Platform'],
      'Amiga OS',
      "Expected actual \"Platform\" to be 'Amiga OS' (was '" +
        browser['Platform'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'Amiga OS',
      "Expected actual \"Platform_Description\" to be 'Amiga OS' (was '" +
        browser['Platform_Description'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Platform_Maker\" to be 'Commodore International' (was '" +
        browser['Platform_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'Amiga',
      "Expected actual \"Device_Name\" to be 'Amiga' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'Commodore International',
      "Expected actual \"Device_Maker\" to be 'Commodore International' (was '" +
        browser['Device_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'Amiga',
      "Expected actual \"Device_Code_Name\" to be 'Amiga' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'Commodore',
      "Expected actual \"Device_Brand_Name\" to be 'Commodore' (was '" +
        browser['Device_Brand_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1202-2 ["Mozilla/5.0 (Macintosh; PowerPC AmigaOS 4.1; Odyssey Web Browser; rv:1.23) AppleWebKit/538.1 (KHTML, like Gecko) OWB/1.23 Safari/538.1"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Odyssey Web Browser',
      "Expected actual \"Comment\" to be 'Odyssey Web Browser' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser'],
      'Odyssey Web Browser',
      "Expected actual \"Browser\" to be 'Odyssey Web Browser' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser_Maker'],
      'Fabien Coeurjoly',
      "Expected actual \"Browser_Maker\" to be 'Fabien Coeurjoly' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Version'],
      '1.23',
      "Expected actual \"Version\" to be '1.23' (was '" +
        browser['Version'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
