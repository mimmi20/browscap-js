...
suite('checking for issue 1236. (1 test)', function () {
  test('issue-1236-A ["Mozilla/5.0 (New Nintendo 3DS like iPhone) AppleWebKit/536.30 (KHTML, like Gecko) NX/3.0.0.5.20 Mobile NintendoBrowser/1.8.10156.US"]', function () {
    ...
    const browser = browscap.getBrowser('Mozilla/5.0 (New Nintendo 3DS like iPhone) AppleWebKit/536.30 (KHTML, like Gecko) NX/3.0.0.5.20 Mobile NintendoBrowser/1.8.10156.US');

    assert.strictEqual(browser['Comment'], 'Nintendo Browser 1.8', 'Expected actual "Comment" to be \'Nintendo Browser 1.8\' (was \'' + browser['Comment'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
    ...
    assert.strictEqual(browser['Platform'], 'Nintendo 3DS', 'Expected actual "Platform" to be \'Nintendo 3DS\' (was \'' + browser['Platform'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
    ...
    assert.strictEqual(browser['Platform_Description'], 'Nintendo 3DS/New Nintendo 3DS System Software', 'Expected actual "Platform_Description" to be \'Nintendo 3DS/New Nintendo 3DS System Software\' (was \'' + browser['Platform_Description'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
    ...
    assert.strictEqual(browser['Device_Name'], 'New 3DS', 'Expected actual "Device_Name" to be \'New 3DS\' (was \'' + browser['Device_Name'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
    ...
    assert.strictEqual(browser['Device_Code_Name'], 'New 3DS', 'Expected actual "Device_Code_Name" to be \'New 3DS\' (was \'' + browser['Device_Code_Name'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
