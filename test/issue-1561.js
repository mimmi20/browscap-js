...
suite('checking for issue 1561. (1 test)', function () {
  test('issue-1561-A ["Mozilla/5.0 (compatible; Discordbot/2.0; +https://discordapp.com)"]', function () {
    ...
    assert.strictEqual(browser['Browser_Maker'], 'Discord', 'Expected actual "Browser_Maker" to be \'Discord\' (was \'' + browser['Browser_Maker'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
