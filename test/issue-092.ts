...
suite('checking for issue 092. (2 tests)', function() {
  test('issue-092-B ["Mozilla/5.0 (Series40; Nokia306/03.63; Profile/MIDP-2.1 Configuration/CLDC-1.1) Gecko/20100401 S40OviBrowser/3.9.0.0.22"]', function() {
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Comment\" to be 'Nokia Proxy Browser 3.9' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
  ...
  test('issue-092-A ["Mozilla/5.0 (compatible; proximic; +http://www.proximic.com/info/spider.php)"]', function() {
    ...
    assert.strictEqual(
      browser['Browser'],
      'proximic',
      "Expected actual \"Browser\" to be 'proximic' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser_Maker'],
      'comScore, Inc.',
      "Expected actual \"Browser_Maker\" to be 'comScore, Inc.' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
