...
suite('checking for issue 877. (1 test)', function() {
  test('issue-877 ["Roku/DVP-6.2 (096.02E06005A)"]', function() {
    ...
    let browser = browscap.getBrowser('Roku/DVP-6.2 (096.02E06005A)');

    assert.strictEqual(
      browser['Comment'],
      'Roku DVP',
      "Expected actual \"Comment\" to be 'Roku DVP' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
    ...
    assert.strictEqual(
      browser['Browser'],
      'Roku DVP',
      "Expected actual \"Browser\" to be 'Roku DVP' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'Roku, Inc.',
      "Expected actual \"Browser_Maker\" to be 'Roku, Inc.' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
