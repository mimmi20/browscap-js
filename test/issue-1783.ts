...
suite('checking for issue 1783. (1 test)', function() {
  test('issue-1783-A ["Mozilla/5.0 (compatible; adscanner/)"]', function() {
    ...
    let browser = browscap.getBrowser('Mozilla/5.0 (compatible; adscanner/)');
    ...
    assert.strictEqual(
      browser['Browser'],
      'adscanner Bot',
      "Expected actual \"Browser\" to be 'adscanner Bot' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'adscanner.tv',
      "Expected actual \"Browser_Maker\" to be 'adscanner.tv' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
