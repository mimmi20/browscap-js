...
suite('checking for issue 972. (1 test)', function() {
  test('issue-972 ["CaptiveNetworkSupport-324 wispr"]', function() {
    ...
    let browser = browscap.getBrowser('CaptiveNetworkSupport-324 wispr');

    assert.strictEqual(
      browser['Comment'],
      'CaptiveNetworkAgent',
      "Expected actual \"Comment\" to be 'CaptiveNetworkAgent' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
    ...
    assert.strictEqual(
      browser['Browser'],
      'CaptiveNetworkAgent',
      "Expected actual \"Browser\" to be 'CaptiveNetworkAgent' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
