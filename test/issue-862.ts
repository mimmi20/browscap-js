...
suite('checking for issue 862. (1 test)', function() {
  test('issue-862 ["Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9) AppleWebKit/537.71 (KHTML, like Gecko) Version/7.0 Safari/537.71 (Rival IQ, rivaliq.com)"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Rival IQ Bot',
      "Expected actual \"Comment\" to be 'Rival IQ Bot' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
    ...
    assert.strictEqual(
      browser['Browser'],
      'Rival IQ Bot',
      "Expected actual \"Browser\" to be 'Rival IQ Bot' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Browser_Maker\" to be 'Rival IQ Corporation' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
