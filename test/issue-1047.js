...
suite('checking for issue 1047.', function () {
  test('issue-1047-A ["Kodi/16.1 (Windows NT 10.0; WOW64) App_Bitness/32 Version/16.1-Git:20160424-c327c53"]', function () {
    ...
    assert.strictEqual(browser['Browser_Maker'], 'XBMC Foundation', 'Expected actual "Browser_Maker" to be \'XBMC Foundation\' (was \'' + browser['Browser_Maker'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
    ...
    assert.strictEqual(browser['Version'], '16.1', 'Expected actual "Version" to be \'16.1\' (was \'' + browser['Version'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
