...
suite('checking for issue 923. (1 test)', function() {
  test('issue-923 ["FeedlyBot/1.0 (http://feedly.com)"]', function() {
    ...
    let browser = browscap.getBrowser('FeedlyBot/1.0 (http://feedly.com)');
    ...
    assert.strictEqual(
      browser['Browser'],
      'FeedlyBot',
      "Expected actual \"Browser\" to be 'FeedlyBot' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'feedly.com',
      "Expected actual \"Browser_Maker\" to be 'feedly.com' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
