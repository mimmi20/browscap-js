...
suite('checking for issue 908. (3 tests)', function() {
  test('issue-908-A ["GetintentCrawler getintent.com"]', function() {
    ...
    let browser = browscap.getBrowser('GetintentCrawler getintent.com');

    assert.strictEqual(
      browser['Comment'],
      'GetintentCrawler',
      "Expected actual \"Comment\" to be 'GetintentCrawler' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
    ...
    assert.strictEqual(
      browser['Browser'],
      'Getintent Crawler',
      "Expected actual \"Browser\" to be 'Getintent Crawler' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'getintent.com',
      "Expected actual \"Browser_Maker\" to be 'getintent.com' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-908-B ["MonitorBacklinksWP (+http://monitorbacklinks.com/blog/incoming-links/)"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'BCKLINKS',
      "Expected actual \"Comment\" to be 'BCKLINKS' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Browser\" to be 'Incoming Links - WordPress Plugin' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Browser_Maker\" to be 'Monitor Backlinks Ltd.' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-908-C ["AddThis.com (http://support.addthis.com/)"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'AddThis.com robot',
      "Expected actual \"Comment\" to be 'AddThis.com robot' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser'],
      'AddThis.com robot',
      "Expected actual \"Browser\" to be 'AddThis.com robot' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser_Maker'],
      'AddThis.com',
      "Expected actual \"Browser_Maker\" to be 'AddThis.com' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
