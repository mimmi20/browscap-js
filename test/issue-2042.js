...
suite('checking for issue 2042. (1 test)', function () {
  test('issue-2042-A ["Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:65.0) Gecko/20100101 Firefox/65.0"]', function () {
    const browscap = new Browscap();
    const browser = browscap.getBrowser('Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:65.0) Gecko/20100101 Firefox/65.0');

    assert.strictEqual(browser['Comment'], 'Firefox 65.0', 'Expected actual "Comment" to be \'Firefox 65.0\' (was \'' + browser['Comment'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
    ...
    assert.strictEqual(browser['RenderingEngine_Version'], '65.0', 'Expected actual "RenderingEngine_Version" to be \'65.0\' (was \'' + browser['RenderingEngine_Version'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
