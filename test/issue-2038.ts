...
suite('checking for issue 2038. (2 tests)', function() {
  test('issue-2038-A ["Mozilla/5.0 (Linux; U; Android 6.0.1; ru-ru; Redmi 4 Build/MMB29M) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/61.0.3163.128 Mobile Safari/537.36 XiaoMi/MiuiBrowser/10.3.6-g"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Miui Browser 10.3',
      "Expected actual \"Comment\" to be 'Miui Browser 10.3' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
  ...
  test('issue-2038-B ["Mozilla/5.0 (Linux; U; Android 7.1.2; ru-ru; Redmi 4A Build/N2G47H) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/61.0.3163.128 Mobile Safari/537.36 XiaoMi/Mint Browser/1.3.3"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Mint Browser 1.3',
      "Expected actual \"Comment\" to be 'Mint Browser 1.3' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'Redmi 4A',
      "Expected actual \"Device_Name\" to be 'Redmi 4A' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Code_Name'],
      'Redmi 4A',
      "Expected actual \"Device_Code_Name\" to be 'Redmi 4A' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
