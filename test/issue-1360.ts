...
suite('checking for issue 1360. (7 tests)', function() {
  test('issue-1360-D ["Mozilla/5.0 (X11; NetBSD amd64; rv:30.0) Gecko/20100101 Firefox/30.0"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Firefox 30.0',
      "Expected actual \"Comment\" to be 'Firefox 30.0' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
    ...
    assert.strictEqual(
      ...
      '30.0',
      "Expected actual \"RenderingEngine_Version\" to be '30.0' (was '" +
        browser['RenderingEngine_Version'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1360-F ["Mozilla/5.0 (X11; NetBSD amd64; rv:36.0) Gecko/20100101 Firefox/36.0"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Firefox 36.0',
      "Expected actual \"Comment\" to be 'Firefox 36.0' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['RenderingEngine_Version'],
      '36.0',
      "Expected actual \"RenderingEngine_Version\" to be '36.0' (was '" +
        browser['RenderingEngine_Version'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1360-G ["Mozilla/5.0 (X11; NetBSD amd64; rv:42.0) Gecko/20100101 Firefox/42.0"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Firefox 42.0',
      "Expected actual \"Comment\" to be 'Firefox 42.0' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1360-J ["Mozilla/5.0 (X11; NetBSD amd64; rv:49.0) Gecko/20100101 Firefox/49.0"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Firefox 49.0',
      "Expected actual \"Comment\" to be 'Firefox 49.0' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
