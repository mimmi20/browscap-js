...
suite('checking for issue 648. (3 tests)', function() {
  test('issue-648-A ["AppleCoreMedia/1.0.0.12F69 (Apple TV; U; CPU OS 8_3 like Mac OS X; en_us)"]', function() {
    ...
    assert.strictEqual(
      browser['Platform'],
      'ATV OS X',
      "Expected actual \"Platform\" to be 'ATV OS X' (was '" +
        browser['Platform'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'ATV OS X is a special variant of iOS optimized for Apple TV',
      "Expected actual \"Platform_Description\" to be 'ATV OS X is a special variant of iOS optimized for Apple TV' (was '" +
        browser['Platform_Description'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'AppleTV',
      "Expected actual \"Device_Name\" to be 'AppleTV' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'AppleTV',
      "Expected actual \"Device_Code_Name\" to be 'AppleTV' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-648-B ["Mail/53 CFNetwork/711.2.23 Darwin/14.0.0"]', function() {
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Comment\" to be 'Apple Mail for Darwin' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-648-C ["Safari/10600.3.18 CFNetwork/720.2.4 Darwin/14.1.0 (x86_64)"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Safari 8.0',
      "Expected actual \"Comment\" to be 'Safari 8.0' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
