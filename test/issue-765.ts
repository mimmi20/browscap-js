...
suite('checking for issue 765. (13 tests)', function() {
  ...
  test('issue-765-C ["Mozilla/5.0 (Linux; Android 4.4.2; A3-A11 Build/KOT49H) AppleWebKit/537.36 (KHTML like Gecko) Version/4.0 Chrome/30.0.0.0 Safari/537.36 [Pinterest/Android]"]', function() {
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'Iconia A3',
      "Expected actual \"Device_Name\" to be 'Iconia A3' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Code_Name'],
      'A3-A11',
      "Expected actual \"Device_Code_Name\" to be 'A3-A11' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-765-E ["Pinterest for Android Tablet/1.8.4 (SGP321; 4.3)"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Pinterest App 1.8',
      "Expected actual \"Comment\" to be 'Pinterest App 1.8' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-765-F ["Pinterest for Android Tablet/4.3.1 (A7600-H; 4.4.2)"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Pinterest App 4.3',
      "Expected actual \"Comment\" to be 'Pinterest App 4.3' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-765-G ["Pinterest for Android/1.1.1 (endeavoru; 4.1.1)"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Pinterest App 1.1',
      "Expected actual \"Comment\" to be 'Pinterest App 1.1' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Code_Name'],
      'Endeavoru',
      "Expected actual \"Device_Code_Name\" to be 'Endeavoru' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-765-H ["Pinterest for Android/3.6.2 (klte; 4.4.2)"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Pinterest App 3.6',
      "Expected actual \"Comment\" to be 'Pinterest App 3.6' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-765-I ["Pinterest/0.1"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser('Pinterest/0.1');

    assert.strictEqual(
      browser['Comment'],
      'Pinterest Bot 0.1',
      "Expected actual \"Comment\" to be 'Pinterest Bot 0.1' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-765-K ["Pinterest/3.2 CFNetwork/672.0.8 Darwin/14.0.0"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Pinterest App 3.2',
      "Expected actual \"Comment\" to be 'Pinterest App 3.2' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-765-L ["Pinterest/3.3.3 CFNetwork/609.1.4 Darwin/13.0.0"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Pinterest App 3.3',
      "Expected actual \"Comment\" to be 'Pinterest App 3.3' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-765-N ["Pinterest/4.1.3 CFNetwork/672.1.14 Darwin/14.0.0"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Pinterest App 4.1',
      "Expected actual \"Comment\" to be 'Pinterest App 4.1' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
