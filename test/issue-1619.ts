...
suite('checking for issue 1619. (7 tests)', function() {
  test('issue-1619-A ["Mozilla/5.0 (Windows NT 10.0; rv:25.9) Gecko/20160817 FossaMail/25.2.3"]', function() {
    ...
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (Windows NT 10.0; rv:25.9) Gecko/20160817 FossaMail/25.2.3'
    );

    assert.strictEqual(
      browser['Comment'],
      'FossaMail 25.2',
      "Expected actual \"Comment\" to be 'FossaMail 25.2' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
    ...
    assert.strictEqual(
      browser['Browser'],
      'FossaMail',
      "Expected actual \"Browser\" to be 'FossaMail' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Version'],
      '25.2',
      "Expected actual \"Version\" to be '25.2' (was '" +
        browser['Version'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1619-B ["Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:25.8) Gecko/20160107 FossaMail/25.2.0"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:25.8) Gecko/20160107 FossaMail/25.2.0'
    );
  ...
  test('issue-1619-C ["Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:3.2) Gecko/20100101 Goanna/20170325 FossaMail/38.2.0"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:3.2) Gecko/20100101 Goanna/20170325 FossaMail/38.2.0'
    );

    assert.strictEqual(
      browser['Comment'],
      'FossaMail 38.2',
      "Expected actual \"Comment\" to be 'FossaMail 38.2' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Version'],
      '38.2',
      "Expected actual \"Version\" to be '38.2' (was '" +
        browser['Version'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1619-D ["Mozilla/5.0 (Windows NT 6.1; Win64; x64; rv:3.0) Gecko/20100101 Goanna/20170123 FossaMail/27.0.0 Lightning/2.9.0"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (Windows NT 6.1; Win64; x64; rv:3.0) Gecko/20100101 Goanna/20170123 FossaMail/27.0.0 Lightning/2.9.0'
    );

    assert.strictEqual(
      browser['Comment'],
      'FossaMail 27.0',
      "Expected actual \"Comment\" to be 'FossaMail 27.0' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1619-E ["Mozilla/5.0 (Windows NT 10.0; rv:3.0) Gecko/20100101 Goanna/20170215 FossaMail/38.0.0 Lightning/4.0.0"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (Windows NT 10.0; rv:3.0) Gecko/20100101 Goanna/20170215 FossaMail/38.0.0 Lightning/4.0.0'
    );

    assert.strictEqual(
      browser['Comment'],
      'FossaMail 38.0',
      "Expected actual \"Comment\" to be 'FossaMail 38.0' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1619-F ["Mozilla/5.0 (Windows NT 10.0; WOW64; rv:25.8) Gecko/20160107 FossaMail/25.2.0	"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (Windows NT 10.0; WOW64; rv:25.8) Gecko/20160107 FossaMail/25.2.0	'
    );
  ...
  test('issue-1619-G ["Mozilla/5.0 (Windows NT 6.1; Win64; x64; rv:25.8) Gecko/20151117 FossaMail/25.1.9"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (Windows NT 6.1; Win64; x64; rv:25.8) Gecko/20151117 FossaMail/25.1.9'
    );

    assert.strictEqual(
      browser['Comment'],
      'FossaMail 25.1',
      "Expected actual \"Comment\" to be 'FossaMail 25.1' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
