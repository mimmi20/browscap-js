...
suite('checking for issue 650. (5 tests)', function() {
  test('issue-650-A ["Opera/9.80 (Linux armv7l; U; NETRANGEMMH;HbbTV/1.1.1;CE-HTML/1.0;Vendor/THOM;SW-Version/V8-MT51F01-LF1V307;Cnt/DEU;Lan/bul) Presto/2.12.362 Version/12.11"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Opera 12.11',
      "Expected actual \"Comment\" to be 'Opera 12.11' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
    ...
    assert.strictEqual(
      browser['Version'],
      '12.11',
      "Expected actual \"Version\" to be '12.11' (was '" +
        browser['Version'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'LF1V307',
      "Expected actual \"Device_Name\" to be 'LF1V307' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'LF1V307',
      "Expected actual \"Device_Code_Name\" to be 'LF1V307' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-650-B ["Opera/9.80 (Linux armv7l; U; NETRANGEMMH;HbbTV/1.1.1;CE-HTML/1.0;Vendor/THOMSON;SW-Version/V8-MT51F01-LF1V325;Cnt/HRV;Lan/swe; NETRANGEMMH;HbbTV/1.1.1;CE-HTML/1.0) Presto/2.12.362 Version/12.11"]', function() {
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'LF1V325',
      "Expected actual \"Device_Name\" to be 'LF1V325' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Code_Name'],
      'LF1V325',
      "Expected actual \"Device_Code_Name\" to be 'LF1V325' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-650-C ["Opera/9.80 (Linux armv6l; U; NETRANGEMMH;HbbTV/1.1.1;CE-HTML/1.0;THOM LF1V373; en) Presto/2.10.250 Version/11.60"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Opera 11.60',
      "Expected actual \"Comment\" to be 'Opera 11.60' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Version'],
      '11.60',
      "Expected actual \"Version\" to be '11.60' (was '" +
        browser['Version'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'LF1V373',
      "Expected actual \"Device_Name\" to be 'LF1V373' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Code_Name'],
      'LF1V373',
      "Expected actual \"Device_Code_Name\" to be 'LF1V373' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-650-D ["Opera/9.80 (Linux armv6l; U; NETRANGEMMH;HbbTV/1.1.1;CE-HTML/1.0;THOMSON LF1V394; en) Presto/2.10.250 Version/11.60"]', function() {
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'LF1V394',
      "Expected actual \"Device_Name\" to be 'LF1V394' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Code_Name'],
      'LF1V394',
      "Expected actual \"Device_Code_Name\" to be 'LF1V394' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-650-E ["Opera/9.80 (Linux armv6l; U; NETRANGEMMH;HbbTV/1.1.1;CE-HTML/1.0;THOMSON LF1V401; en) Presto/2.10.250 Version/11.60"]', function() {
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'LF1V401',
      "Expected actual \"Device_Name\" to be 'LF1V401' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Code_Name'],
      'LF1V401',
      "Expected actual \"Device_Code_Name\" to be 'LF1V401' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
