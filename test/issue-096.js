...
suite('checking for issue 096.', function () {
  ...
  test('issue-096-BV ["SonyEricssonS312/R1EA Browser/OpenWave/1.0 Profile/MIDP-2.1 Configuration/CLDC-1.1"]', function () {
    ...
    assert.strictEqual(browser['Comment'], 'Openwave Mobile Browser', 'Expected actual "Comment" to be \'Openwave Mobile Browser\' (was \'' + browser['Comment'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
