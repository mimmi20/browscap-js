...
suite('checking for issue 716.', function () {
  ...
  test('issue-716-D ["Mozilla/5.0 (Windows NT 10.0; WOW64; rv:39.0) Gecko/20100101 Firefox/39.0"]', function () {
    ...
    assert.strictEqual(browser['Comment'], 'Firefox 39.0', 'Expected actual "Comment" to be \'Firefox 39.0\' (was \'' + browser['Comment'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
    ...
    assert.strictEqual(browser['RenderingEngine_Version'], '39.0', 'Expected actual "RenderingEngine_Version" to be \'39.0\' (was \'' + browser['RenderingEngine_Version'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
