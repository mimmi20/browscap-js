...
suite('checking for issue 337. (3 tests)', function() {
  test('issue-337-A ["Mozilla/5.0 (Linux; U; Android 4.2.2; de-de; FP1 Build/JDQ39) AppleWebKit/534.30 (KHTML, like Gecko) Version/4.0 Mobile Safari/534.30"]', function() {
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'FP1',
      "Expected actual \"Device_Name\" to be 'FP1' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'Fairphone',
      "Expected actual \"Device_Maker\" to be 'Fairphone' (was '" +
        browser['Device_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'FP1',
      "Expected actual \"Device_Code_Name\" to be 'FP1' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'Fairphone',
      "Expected actual \"Device_Brand_Name\" to be 'Fairphone' (was '" +
        browser['Device_Brand_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
