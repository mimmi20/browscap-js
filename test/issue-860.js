...
suite('checking for issue 860.', function () {
  test('issue-860-A ["SoundCloud/3.0.0 build 2547; iPhone/iPhone OS/7.1.1"]', function () {
    ...
    assert.strictEqual(browser['Comment'], 'SoundCloud App 3.0 for iOS', 'Expected actual "Comment" to be \'SoundCloud App 3.0 for iOS\' (was \'' + browser['Comment'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
    assert.strictEqual(browser['Browser'], 'SoundCloud App', 'Expected actual "Browser" to be \'SoundCloud App\' (was \'' + browser['Browser'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
    ...
    assert.strictEqual(browser['Browser_Maker'], 'SoundCloud Limited', 'Expected actual "Browser_Maker" to be \'SoundCloud Limited\' (was \'' + browser['Browser_Maker'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
  ...
  test('issue-860-B ["SoundCloud-Android/14.08.21-17 (Android 4.4.2; samsung SAMSUNG-SGH-I337)"]', function () {
    browser = browscap.getBrowser('SoundCloud-Android/14.08.21-17 (Android 4.4.2; samsung SAMSUNG-SGH-I337)');

    assert.strictEqual(browser['Comment'], 'SoundCloud App 14.08 for Android', 'Expected actual "Comment" to be \'SoundCloud App 14.08 for Android\' (was \'' + browser['Comment'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
    assert.strictEqual(browser['Browser'], 'SoundCloud App', 'Expected actual "Browser" to be \'SoundCloud App\' (was \'' + browser['Browser'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
    assert.strictEqual(browser['Browser_Type'], 'Application', 'Expected actual "Browser_Type" to be \'Application\' (was \'' + browser['Browser_Type'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
    assert.strictEqual(browser['Browser_Bits'], '32', 'Expected actual "Browser_Bits" to be \'32\' (was \'' + browser['Browser_Bits'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
    assert.strictEqual(browser['Browser_Maker'], 'SoundCloud Limited', 'Expected actual "Browser_Maker" to be \'SoundCloud Limited\' (was \'' + browser['Browser_Maker'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
    assert.strictEqual(browser['Browser_Modus'], 'unknown', 'Expected actual "Browser_Modus" to be \'unknown\' (was \'' + browser['Browser_Modus'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
    assert.strictEqual(browser['Version'], '14.08', 'Expected actual "Version" to be \'14.08\' (was \'' + browser['Version'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
    ...
    assert.strictEqual(browser['MinorVer'], '08', 'Expected actual "MinorVer" to be \'08\' (was \'' + browser['MinorVer'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
