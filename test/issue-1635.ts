...
suite('checking for issue 1635. (7 tests)', function() {
  test('issue-1635-A ["Mozilla/5.0 (X11; Linux i686) AppleWebKit/534.34 (KHTML, like Gecko) kmail2 Safari/534.34"]', function() {
    ...
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (X11; Linux i686) AppleWebKit/534.34 (KHTML, like Gecko) kmail2 Safari/534.34'
    );

    assert.strictEqual(
      browser['Comment'],
      'KMail2 Generic',
      "Expected actual \"Comment\" to be 'KMail2 Generic' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
  ...
  test('issue-1635-B ["Mozilla/5.0 (X11; Linux i686) AppleWebKit/537.21 (KHTML, like Gecko) kmail2 Safari/537.21"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (X11; Linux i686) AppleWebKit/537.21 (KHTML, like Gecko) kmail2 Safari/537.21'
    );
  ...
  test('issue-1635-C ["Mozilla/5.0 (X11; Linux i686) AppleWebKit/538.1 (KHTML, like Gecko) kmail2/5.2.3 Safari/538.1"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (X11; Linux i686) AppleWebKit/538.1 (KHTML, like Gecko) kmail2/5.2.3 Safari/538.1'
    );

    assert.strictEqual(
      browser['Comment'],
      'KMail2 5.2',
      "Expected actual \"Comment\" to be 'KMail2 5.2' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1635-D ["Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/534.34 (KHTML, like Gecko) kmail2 Safari/534.34"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/534.34 (KHTML, like Gecko) kmail2 Safari/534.34'
    );
  ...
  test('issue-1635-E ["Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/534.34 (KHTML, like Gecko) kmail2/4.12.5 Safari/534.34"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/534.34 (KHTML, like Gecko) kmail2/4.12.5 Safari/534.34'
    );

    assert.strictEqual(
      browser['Comment'],
      'KMail2 4.12',
      "Expected actual \"Comment\" to be 'KMail2 4.12' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Version'],
      '4.12',
      "Expected actual \"Version\" to be '4.12' (was '" +
        browser['Version'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1635-F ["Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.21 (KHTML, like Gecko) kmail2 Safari/537.21"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.21 (KHTML, like Gecko) kmail2 Safari/537.21'
    );
  ...
  test('issue-1635-G ["Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/538.1 (KHTML, like Gecko) kmail2/5.2.3 Safari/538.1"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/538.1 (KHTML, like Gecko) kmail2/5.2.3 Safari/538.1'
    );
