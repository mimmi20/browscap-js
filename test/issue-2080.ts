...
suite('checking for issue 2080. (2 tests)', function() {
  test('issue-2080-A ["arquivo-web-crawler (compatible; heritrix/3.3.0-SNAPSHOT-2018-05-28T10:30:31Z +http://arquivo.pt)"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'FCCN Crawler',
      "Expected actual \"Comment\" to be 'FCCN Crawler' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
    ...
    assert.strictEqual(
      browser['Browser'],
      'FCCN Crawler',
      "Expected actual \"Browser\" to be 'FCCN Crawler' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'FCCN',
      "Expected actual \"Browser_Maker\" to be 'FCCN' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-2080-B ["Arquivo-web-crawler (compatible; heritrix/1.14.4 +http://arquivo.pt/faq-crawling)"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
