...
suite('checking for issue 1819. (1 test)', function () {
  test('issue-1819-A ["Barkrowler/0.7 (+http://www.exensa.com/crawl)"]', function () {
    const browscap = new Browscap();
    const browser = browscap.getBrowser('Barkrowler/0.7 (+http://www.exensa.com/crawl)');
    ...
    assert.strictEqual(browser['Browser'], 'Barkrowler', 'Expected actual "Browser" to be \'Barkrowler\' (was \'' + browser['Browser'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
    ...
    assert.strictEqual(browser['Browser_Maker'], 'eXenSa', 'Expected actual "Browser_Maker" to be \'eXenSa\' (was \'' + browser['Browser_Maker'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
