...
suite('checking for issue 1941. (1 test)', function () {
  test('issue-1941-A ["BLP_bbot/0.1"]', function () {
    const browscap = new Browscap();
    const browser = browscap.getBrowser('BLP_bbot/0.1');
    ...
    assert.strictEqual(browser['Browser'], 'Bloomberg bot', 'Expected actual "Browser" to be \'Bloomberg bot\' (was \'' + browser['Browser'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
    ...
    assert.strictEqual(browser['Browser_Maker'], 'Bloomberg', 'Expected actual "Browser_Maker" to be \'Bloomberg\' (was \'' + browser['Browser_Maker'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
