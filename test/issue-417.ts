...
suite('checking for issue 417. (1 test)', function() {
  test('issue-417 ["psbot-page (+http://www.picsearch.com/bot.html)"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Picsearch Bot',
      "Expected actual \"Comment\" to be 'Picsearch Bot' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
    ...
    assert.strictEqual(
      browser['Browser'],
      'Picsearch Bot',
      "Expected actual \"Browser\" to be 'Picsearch Bot' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'Picsearch Services AB',
      "Expected actual \"Browser_Maker\" to be 'Picsearch Services AB' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
