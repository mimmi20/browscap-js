...
suite('checking for issue 1253. (5 tests)', function() {
  test('issue-1253-A ["Mozilla/5.0 (Linux; U; xx-xx) AppleWebKit/528.5+ (KHTML, like Gecko, Safari/528.5+) Version/4.0 Kindle/3.0"]', function() {
    ...
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (Linux; U; xx-xx) AppleWebKit/528.5+ (KHTML, like Gecko, Safari/528.5+) Version/4.0 Kindle/3.0'
    );
  ...
  test('issue-1253-B ["Mozilla/5.0 (Linux; U; Android 2.3.4; en-us; Kindle Fire Build/GINGERBREAD) AppleWebKit/533.1 (KHTML, like Gecko) Version/4.0 Mobile Safari/533.1"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Kindle Fire',
      "Expected actual \"Comment\" to be 'Kindle Fire' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser'],
      'Kindle Fire',
      "Expected actual \"Browser\" to be 'Kindle Fire' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'Kindle Fire',
      "Expected actual \"Device_Name\" to be 'Kindle Fire' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Code_Name'],
      'Kindle Fire',
      "Expected actual \"Device_Code_Name\" to be 'Kindle Fire' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1253-C ["Mozilla/5.0 (X11; U; Linux armv7l like Android; en-us) AppleWebKit/531.2+ (KHTML, like Gecko) Version/5.0 Safari/533.2+ Kindle/3.0+"]', function() {
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'Kindle 3',
      "Expected actual \"Device_Name\" to be 'Kindle 3' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Code_Name'],
      'Kindle 3',
      "Expected actual \"Device_Code_Name\" to be 'Kindle 3' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1253-E ["Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/52.0.2743.82 Safari/537.36 OPR/39.0.2256.43"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Opera 39.0',
      "Expected actual \"Comment\" to be 'Opera 39.0' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
