...
suite('checking for issue 1858. (1 test)', function() {
  test('issue-1858-00000 ["Mozilla/5.0 (Linux; Android 8.0.0; Mi MIX 2 Build/OPR1.170623.027) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/65.0.3325.109 Mobile Safari/537.36"]', function() {
    ...
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (Linux; Android 8.0.0; Mi MIX 2 Build/OPR1.170623.027) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/65.0.3325.109 Mobile Safari/537.36'
    );
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'Mi Mix 2',
      "Expected actual \"Device_Name\" to be 'Mi Mix 2' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'Mi Mix 2',
      "Expected actual \"Device_Code_Name\" to be 'Mi Mix 2' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
