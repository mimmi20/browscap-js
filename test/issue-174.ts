...
suite('checking for issue 174. (1 test)', function() {
  test('issue-174 ["Mozilla/5.0 (compatible; spbot/4.0.9; +http://OpenLinkProfiler.org/bot )"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'spbot',
      "Expected actual \"Comment\" to be 'spbot' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
    ...
    assert.strictEqual(
      browser['Browser'],
      'SEOprofiler',
      "Expected actual \"Browser\" to be 'SEOprofiler' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'Axandra GmbH',
      "Expected actual \"Browser_Maker\" to be 'Axandra GmbH' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
