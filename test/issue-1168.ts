...
suite('checking for issue 1168. (5 tests)', function() {
  test('issue-1168-A ["Mozilla/5.0 (X11; Linux aarch64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/52.0.2743.84 Safari/537.36 CrKey/1.22.74257"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Chrome 52.0',
      "Expected actual \"Comment\" to be 'Chrome 52.0' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
    ...
    assert.strictEqual(
      browser['Platform'],
      'Chromecast OS',
      "Expected actual \"Platform\" to be 'Chromecast OS' (was '" +
        browser['Platform'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'Chromecast OS is a Linux/Android based Platform for the Chromecast',
      "Expected actual \"Platform_Description\" to be 'Chromecast OS is a Linux/Android based Platform for the Chromecast' (was '" +
        browser['Platform_Description'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'Chromecast',
      "Expected actual \"Device_Name\" to be 'Chromecast' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'Chromecast',
      "Expected actual \"Device_Code_Name\" to be 'Chromecast' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1168-B ["Mozilla/5.0 (X11; Linux armv7l) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2272.75 Safari/537.36 CrKey/1.14.32904"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
  ...
  test('issue-1168-D ["Mozilla/5.0 (X11; Linux armv7l) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/39.0.2171.51 Safari/537.36 CrKey/1.12.27946"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
  ...
  test('issue-1168-E ["Mozilla/5.0 (X11; Linux armv7l) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2272.75 Safari/537.36 CrKey/1.13.31432"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
  ...
  test('issue-1168-F ["Mozilla/5.0 (CrKey armv7l 1.4.15250) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/31.0.1650.0 Safari/537.36"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
