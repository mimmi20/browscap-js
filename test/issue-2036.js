...
suite('checking for issue 2036. (1 test)', function () {
  test('issue-2036-A ["Google-AdWords-Express"]', function () {
    const browscap = new Browscap();
    const browser = browscap.getBrowser('Google-AdWords-Express');
    ...
    assert.strictEqual(browser['Browser'], 'Google Adwords Express', 'Expected actual "Browser" to be \'Google Adwords Express\' (was \'' + browser['Browser'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
