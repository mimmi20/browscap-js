...
suite('checking for issue 728. (3 tests)', function() {
  test('issue-728-A ["Mozilla/5.0 (Linux; Android 4.2.2; Plane 10.5 3G PS1005MG Build/JDQ39) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2272.118 YaBrowser/15.4.2272.3842.01 Safari/537.36"]', function() {
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'Plane 10.5 3G',
      "Expected actual \"Device_Name\" to be 'Plane 10.5 3G' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'PS1005MG',
      "Expected actual \"Device_Code_Name\" to be 'PS1005MG' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-728-B ["Mozilla/5.0 (Linux; Android 4.2.2; PMT5777_3G Build/JDQ39) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/33.0.1750.136 Safari/537.36"]', function() {
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Device_Name\" to be 'MultiPad Color 7.0 3G WiFi' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Code_Name'],
      'PMT5777_3G',
      "Expected actual \"Device_Code_Name\" to be 'PMT5777_3G' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-728-C ["Mozilla/5.0 (Linux; Android 5.0.2; SM-T555 Build/LRX22G) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2272.118 YaBrowser/15.4.2272.3842.01 Safari/537.36"]', function() {
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Device_Name\" to be 'Galaxy Tab A 9.7 LTE' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Code_Name'],
      'SM-T555',
      "Expected actual \"Device_Code_Name\" to be 'SM-T555' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
