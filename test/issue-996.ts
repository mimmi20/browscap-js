...
suite('checking for issue 996. (3 tests)', function() {
  test('issue-996-A ["Mozilla/5.0 (Linux; Android 5.0.1; GT-I9505 Build/LRX22C) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/47.0.2526.111 YaBrowser/16.2.1.1239.00 Mobile Safari/537.36"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Yandex Browser 16.2',
      "Expected actual \"Comment\" to be 'Yandex Browser 16.2' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
    ...
    assert.strictEqual(
      browser['Version'],
      '16.2',
      "Expected actual \"Version\" to be '16.2' (was '" +
        browser['Version'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-996-B ["Mozilla/5.0 (Linux; Android 4.4.2; SM-G800F Build/KOT49H) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/36.0.1985.135 MobileIron/1.6.0 Mobile Safari/537.36"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'MobileIron 1.6',
      "Expected actual \"Comment\" to be 'MobileIron 1.6' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-996-C ["Mozilla/5.0 (Linux; Android 4.4.4; GT-I9195I Build/KTU84P) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/43.0.2357.130 Crosswalk/14.43.343.17 Mobile Safari/537.36"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Crosswalk App 14.0',
      "Expected actual \"Comment\" to be 'Crosswalk App 14.0' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser'],
      'Crosswalk App',
      "Expected actual \"Browser\" to be 'Crosswalk App' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser_Maker'],
      'Intel Corporation',
      "Expected actual \"Browser_Maker\" to be 'Intel Corporation' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Code_Name'],
      'GT-I9195I',
      "Expected actual \"Device_Code_Name\" to be 'GT-I9195I' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
