...
suite('checking for issue 305. (1 test)', function() {
  test('issue-305 ["Microsoft Office Protocol Discovery"]', function() {
    ...
    let browser = browscap.getBrowser('Microsoft Office Protocol Discovery');

    assert.strictEqual(
      browser['Comment'],
      'Microsoft',
      "Expected actual \"Comment\" to be 'Microsoft' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
    ...
    assert.strictEqual(
      browser['Browser'],
      'MS OPD',
      "Expected actual \"Browser\" to be 'MS OPD' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
