...
suite('checking for issue 749. (1 test)', function () {
  test('issue-749 ["[\'Mozilla/5.0 (Windows NT 6.2; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/38.0.2125.111 Safari/537.36 GD\']"]', function () {
    ...
    const browser = browscap.getBrowser('[\'Mozilla/5.0 (Windows NT 6.2; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/38.0.2125.111 Safari/537.36 GD\']');
