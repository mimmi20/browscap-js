...
suite('checking for issue 1442. (2 tests)', function() {
  test('issue-1442-A ["Mozilla/4.0 (compatible; Linux 2.6.22) NetFront/3.4 Kindle/2.0 (screen 600x800)"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Access NetFront 3.4',
      "Expected actual \"Comment\" to be 'Access NetFront 3.4' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
    ...
    assert.strictEqual(
      browser['Browser'],
      'NetFront',
      "Expected actual \"Browser\" to be 'NetFront' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'NetFront',
      "Expected actual \"RenderingEngine_Name\" to be 'NetFront' (was '" +
        browser['RenderingEngine_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'Access',
      "Expected actual \"RenderingEngine_Maker\" to be 'Access' (was '" +
        browser['RenderingEngine_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1442-B ["SonyEricssonJ10i2/R7CA Browser/NetFront/3.5 Profile/MIDP-2.1 Configuration/CLDC-1.1 JavaPlatform/JP-8.5.2"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'SonyEricssonJ10i2/R7CA Browser/NetFront/3.5 Profile/MIDP-2.1 Configuration/CLDC-1.1 JavaPlatform/JP-8.5.2'
    );

    assert.strictEqual(
      browser['Comment'],
      'Access NetFront 3.5',
      "Expected actual \"Comment\" to be 'Access NetFront 3.5' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'Elm',
      "Expected actual \"Device_Name\" to be 'Elm' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Code_Name'],
      'J10i2',
      "Expected actual \"Device_Code_Name\" to be 'J10i2' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
