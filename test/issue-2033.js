...
suite('checking for issue 2033. (1 test)', function () {
  test('issue-2033-A ["Mozilla/5.0 (Linux; Android 7.1.1; SM-T380) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/71.0.3578.99 Mobile Safari/537.36"]', function () {
    const browscap = new Browscap();
    const browser = browscap.getBrowser('Mozilla/5.0 (Linux; Android 7.1.1; SM-T380) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/71.0.3578.99 Mobile Safari/537.36');
    ...
    assert.strictEqual(browser['Device_Name'], 'Galaxy Tab A 8.0 Wi-Fi (2017)', 'Expected actual "Device_Name" to be \'Galaxy Tab A 8.0 Wi-Fi (2017)\' (was \'' + browser['Device_Name'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
    ...
    assert.strictEqual(browser['Device_Code_Name'], 'SM-T380', 'Expected actual "Device_Code_Name" to be \'SM-T380\' (was \'' + browser['Device_Code_Name'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
