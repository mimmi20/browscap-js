...
suite('checking for issue 081. (7 tests)', function() {
  test('issue-081-G ["Mozilla/5.0 (compatible; Linux x86_64; Mail.RU_Bot/2.0; +http://go.mail.ru/help/robots)"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Mail.Ru Bot',
      "Expected actual \"Comment\" to be 'Mail.Ru Bot' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
    ...
    assert.strictEqual(
      browser['Browser'],
      'Mail.Ru Bot',
      "Expected actual \"Browser\" to be 'Mail.Ru Bot' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-081-F ["masscan/1.0 (https://github.com/robertdavidgraham/masscan)"]', function() {
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Browser\" to be 'Download Accelerator' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-081-E ["ZmEu"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser('ZmEu');

    assert.strictEqual(
      browser['Comment'],
      'ZmEu',
      "Expected actual \"Comment\" to be 'ZmEu' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser'],
      'ZmEu',
      "Expected actual \"Browser\" to be 'ZmEu' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-081-D ["Mozilla/5.0 (X11; Linux i686; U;rv: 1.7.13) Gecko/20070322 Kazehakase/0.4.4.1"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Kazehakase 0.4',
      "Expected actual \"Comment\" to be 'Kazehakase 0.4' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-081-C ["woobot/1.1"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser('woobot/1.1');

    assert.strictEqual(
      browser['Comment'],
      'WooRank',
      "Expected actual \"Comment\" to be 'WooRank' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser'],
      'WooRank',
      "Expected actual \"Browser\" to be 'WooRank' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser_Maker'],
      'woorank.com',
      "Expected actual \"Browser_Maker\" to be 'woorank.com' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-081-A ["Sogou web spider/4.0(+http://www.sogou.com/docs/help/webmasters.htm#07)"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Sogou',
      "Expected actual \"Comment\" to be 'Sogou' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser'],
      'Sogou Web Spider',
      "Expected actual \"Browser\" to be 'Sogou Web Spider' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
