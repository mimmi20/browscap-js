...
suite('checking for issue 2074. (3 tests)', function() {
  test('issue-2074-A ["Mozilla/5.0 (Linux; Android 5.1.1; AEOKN Build/LVY48F; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/59.0.3071.125 Safari/537.36"]', function() {
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'Echo Show',
      "Expected actual \"Device_Name\" to be 'Echo Show' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'AEOKN',
      "Expected actual \"Device_Code_Name\" to be 'AEOKN' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-2074-B ["Dalvik/2.1.0 (Linux; U; Android 5.1.1; AEOBC Build/LVY48F)"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'Echo Dot',
      "Expected actual \"Device_Name\" to be 'Echo Dot' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Code_Name'],
      'AEOBC',
      "Expected actual \"Device_Code_Name\" to be 'AEOBC' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-2074-C ["AndroidDownloadManager/5.1.1 (Linux; U; Android 5.1.1; AEOBC Build/LVY48F)"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'AndroidDownloadManager/5.1.1 (Linux; U; Android 5.1.1; AEOBC Build/LVY48F)'
    );

    assert.strictEqual(
      browser['Comment'],
      'Android Download Manager 5.1',
      "Expected actual \"Comment\" to be 'Android Download Manager 5.1' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
