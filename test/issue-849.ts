...
suite('checking for issue 849. (17 tests)', function() {
  test('issue-849-A ["SophosUpdateManager/1.5.7.50 SDDS/2.0 (u= EO2ANA123G c= 6342da15-f351-4ab7-9656-3f5f2d50885d )"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'SophosUpdateManager',
      "Expected actual \"Comment\" to be 'SophosUpdateManager' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
    ...
    assert.strictEqual(
      browser['Browser'],
      'SophosUpdateManager',
      "Expected actual \"Browser\" to be 'SophosUpdateManager' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'Sophos Ltd.',
      "Expected actual \"Browser_Maker\" to be 'Sophos Ltd.' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-849-B ["Debian APT-HTTP/1.3 (1.0.1ubuntu2)"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser('Debian APT-HTTP/1.3 (1.0.1ubuntu2)');

    assert.strictEqual(
      browser['Comment'],
      'Debian APT-HTTP',
      "Expected actual \"Comment\" to be 'Debian APT-HTTP' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser'],
      'Apt HTTP Transport',
      "Expected actual \"Browser\" to be 'Apt HTTP Transport' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-849-C ["Windows-Update-Agent/7.9.9600.17729 Client-Protocol/1.21"]', function() {
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Comment\" to be 'Windows-Update-Agent' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser'],
      'Windows-Update-Agent',
      "Expected actual \"Browser\" to be 'Windows-Update-Agent' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-849-D ["urlgrabber/3.9.1 yum/3.2.29"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser('urlgrabber/3.9.1 yum/3.2.29');

    assert.strictEqual(
      browser['Comment'],
      'urlgrabber',
      "Expected actual \"Comment\" to be 'urlgrabber' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser'],
      'URL Grabber',
      "Expected actual \"Browser\" to be 'URL Grabber' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-849-F ["urlgrabber/3.10 yum/3.4.3"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser('urlgrabber/3.10 yum/3.4.3');
    ...
    assert.strictEqual(
      browser['Version'],
      '3.10',
      "Expected actual \"Version\" to be '3.10' (was '" +
        browser['Version'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-849-G ["UCS (ESX) - 4.0-3 errata302 - 28d414cc-2dac-4c0e-a34a-734020b8af66 - 00000000-0000-0000-0000-000000000000 -"]', function() {
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Comment\" to be 'Univention Corporate Server 4.0' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Browser\" to be 'Univention Corporate Server' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser_Maker'],
      'Univention GmbH',
      "Expected actual \"Browser_Maker\" to be 'Univention GmbH' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-849-H ["Ubuntu APT-HTTP/1.3 (0.7.20.2ubuntu6)"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser('Ubuntu APT-HTTP/1.3 (0.7.20.2ubuntu6)');

    assert.strictEqual(
      browser['Comment'],
      'Ubuntu APT-HTTP',
      "Expected actual \"Comment\" to be 'Ubuntu APT-HTTP' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-849-J ["Microsoft-CryptoAPI/6.3"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser('Microsoft-CryptoAPI/6.3');
  ...
  test('issue-849-K ["libwww-perl/6.05"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser('libwww-perl/6.05');

    assert.strictEqual(
      browser['Comment'],
      'libwww',
      "Expected actual \"Comment\" to be 'libwww' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser'],
      'libwww',
      "Expected actual \"Browser\" to be 'libwww' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Version'],
      '6.05',
      "Expected actual \"Version\" to be '6.05' (was '" +
        browser['Version'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-849-L ["OpenBSD ftp"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser('OpenBSD ftp');

    assert.strictEqual(
      browser['Comment'],
      'OpenBSD ftp',
      "Expected actual \"Comment\" to be 'OpenBSD ftp' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser'],
      'OpenBSD ftp',
      "Expected actual \"Browser\" to be 'OpenBSD ftp' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-849-M ["SophosAgent/1.0 (type= spa )"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser('SophosAgent/1.0 (type= spa )');

    assert.strictEqual(
      browser['Comment'],
      'SophosAgent',
      "Expected actual \"Comment\" to be 'SophosAgent' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser'],
      'SophosAgent',
      "Expected actual \"Browser\" to be 'SophosAgent' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-849-N ["libcurl-agent/1.0"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser('libcurl-agent/1.0');

    assert.strictEqual(
      browser['Comment'],
      'libcurl',
      "Expected actual \"Comment\" to be 'libcurl' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser'],
      'libcurl',
      "Expected actual \"Browser\" to be 'libcurl' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-849-O ["Wget/1.14 (linux-gnu)"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser('Wget/1.14 (linux-gnu)');

    assert.strictEqual(
      browser['Comment'],
      'wget 1.14',
      "Expected actual \"Comment\" to be 'wget 1.14' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Version'],
      '1.14',
      "Expected actual \"Version\" to be '1.14' (was '" +
        browser['Version'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-849-Q ["curl/7.29.0"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser('curl/7.29.0');
    ...
    assert.strictEqual(
      browser['Version'],
      '7.29',
      "Expected actual \"Version\" to be '7.29' (was '" +
        browser['Version'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-849-R ["jupdate"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser('jupdate');

    assert.strictEqual(
      browser['Comment'],
      'Jupdate',
      "Expected actual \"Comment\" to be 'Jupdate' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser'],
      'Jupdate',
      "Expected actual \"Browser\" to be 'Jupdate' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser_Maker'],
      'DM Solutions e.K.',
      "Expected actual \"Browser_Maker\" to be 'DM Solutions e.K.' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
