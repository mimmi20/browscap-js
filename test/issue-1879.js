...
suite('checking for issue 1879. (1 test)', function () {
  test('issue-1879-A ["Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/602.1 (KHTML, like Gecko) splash Version/9.0 Safari/602.1"]', function () {
    const browscap = new Browscap();
    const browser = browscap.getBrowser('Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/602.1 (KHTML, like Gecko) splash Version/9.0 Safari/602.1');
    ...
    assert.strictEqual(browser['Browser'], 'Splash', 'Expected actual "Browser" to be \'Splash\' (was \'' + browser['Browser'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
    ...
    assert.strictEqual(browser['Browser_Maker'], 'Scrapinghub Limited', 'Expected actual "Browser_Maker" to be \'Scrapinghub Limited\' (was \'' + browser['Browser_Maker'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
