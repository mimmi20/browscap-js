...
suite('checking for issue 426.', function () {
  test('issue-426 ["Mozilla/5.0 (iPhone; CPU iPhone OS 7_1_2 like Mac OS X) AppleWebKit/537.51.1 (KHTML, like Gecko) GSA/4.1.0.31802 Mobile/11D257 Safari/9537.53"]', function () {
    ...
    assert.strictEqual(browser['Comment'], 'Google App 4.1', 'Expected actual "Comment" to be \'Google App 4.1\' (was \'' + browser['Comment'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
