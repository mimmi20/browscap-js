...
suite('checking for issue 2014. (1 test)', function () {
  test('issue-2014-A ["DomainStatsBot/1.0 (https://domainstats.com/pages/our-bot)"]', function () {
    const browscap = new Browscap();
    const browser = browscap.getBrowser('DomainStatsBot/1.0 (https://domainstats.com/pages/our-bot)');
    ...
    assert.strictEqual(browser['Browser'], 'DomainStatsBot', 'Expected actual "Browser" to be \'DomainStatsBot\' (was \'' + browser['Browser'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
    ...
    assert.strictEqual(browser['Browser_Maker'], 'Domainstats International AB', 'Expected actual "Browser_Maker" to be \'Domainstats International AB\' (was \'' + browser['Browser_Maker'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
