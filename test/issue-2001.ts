...
suite('checking for issue 2001. (2 tests)', function() {
  test('issue-2001-A ["Acast/1.25.2 (Phone; Android 8.0.2; OnePlus 5.0)"]', function() {
    ...
    let browser = browscap.getBrowser(
      'Acast/1.25.2 (Phone; Android 8.0.2; OnePlus 5.0)'
    );

    assert.strictEqual(
      browser['Comment'],
      'Acast Podcast App',
      "Expected actual \"Comment\" to be 'Acast Podcast App' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
    ...
    assert.strictEqual(
      browser['Browser'],
      'Acast Podcast App',
      "Expected actual \"Browser\" to be 'Acast Podcast App' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'Acast AB',
      "Expected actual \"Browser_Maker\" to be 'Acast AB' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-2001-B ["Acast/1.46.0 (CarPlay; iOS 12.0.0, iPhone10,3)"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'Acast/1.46.0 (CarPlay; iOS 12.0.0, iPhone10,3)'
    );
