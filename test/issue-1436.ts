...
suite('checking for issue 1436. (2 tests)', function() {
  test('issue-1436-A ["Dalvik/1.5.1 (Linux; U; Android 3.2.1; A500 Build/HTK55D)"]', function() {
    ...
    let browser = browscap.getBrowser(
      'Dalvik/1.5.1 (Linux; U; Android 3.2.1; A500 Build/HTK55D)'
    );

    assert.strictEqual(
      browser['Comment'],
      'Dalvik 1.5',
      "Expected actual \"Comment\" to be 'Dalvik 1.5' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
    ...
    assert.strictEqual(
      ...
      'A500',
      "Expected actual \"Device_Code_Name\" to be 'A500' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1436-B ["Dalvik/1.5.1 (Linux; U; Android 3.1; GT-P7510 Build/HMJ37)"]', function() {
    ...
    assert.strictEqual(
      browser['Device_Code_Name'],
      'GT-P7510',
      "Expected actual \"Device_Code_Name\" to be 'GT-P7510' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
