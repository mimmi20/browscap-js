...
suite('checking for issue 1642. (1 test)', function() {
  test('issue-1642 ["Mozilla/5.0 (X11; SunOS i86pc; rv:52.0) Gecko/20100101 Thunderbird/52.3.0"]', function() {
    ...
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (X11; SunOS i86pc; rv:52.0) Gecko/20100101 Thunderbird/52.3.0'
    );

    assert.strictEqual(
      browser['Comment'],
      'Thunderbird 52.3',
      "Expected actual \"Comment\" to be 'Thunderbird 52.3' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
    ...
    assert.strictEqual(
      browser['Version'],
      '52.3',
      "Expected actual \"Version\" to be '52.3' (was '" +
        browser['Version'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
