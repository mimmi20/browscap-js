...
suite('checking for issue 1621. (4 tests)', function () {
  test('issue-1621-A ["Mozilla/5.0 (Windows; U; Windows NT 5.1; fr; rv:1.9.2.19pre) Gecko/20110902 Prism zdesktop/7.2.5"]', function () {
    ...
    assert.strictEqual(browser['Browser_Maker'], 'Synacor, Inc.', 'Expected actual "Browser_Maker" to be \'Synacor, Inc.\' (was \'' + browser['Browser_Maker'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
