...
suite('checking for issue 601.', function () {
  test('issue-601 ["Mozilla/5.0 (compatible; worldwebheritage.org/1.0; +crawl@worldwebheritage.org)"]', function () {
    ...
    assert.strictEqual(browser['Browser_Maker'], 'GoDaddy, LLC', 'Expected actual "Browser_Maker" to be \'GoDaddy, LLC\' (was \'' + browser['Browser_Maker'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
