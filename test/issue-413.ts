...
suite('checking for issue 413. (1 test)', function() {
  test('issue-413 ["Mozilla/5.0 (compatible; MSIE 9.0; Windows NT 6.1; Trident/5.0); 360Spider"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      '360Spider',
      "Expected actual \"Comment\" to be '360Spider' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
    ...
    assert.strictEqual(
      browser['Browser'],
      '360Spider',
      "Expected actual \"Browser\" to be '360Spider' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
