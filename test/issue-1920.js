...
suite('checking for issue 1920. (7 tests)', function () {
  test('issue-1920-A ["Shopkeep-Pocket/4.4.0.389 (Android/7.0 LGE LG-H820)"]', function () {
    ...
    const browser = browscap.getBrowser('Shopkeep-Pocket/4.4.0.389 (Android/7.0 LGE LG-H820)');

    assert.strictEqual(browser['Comment'], 'ShopKeep App 4.4', 'Expected actual "Comment" to be \'ShopKeep App 4.4\' (was \'' + browser['Comment'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
    assert.strictEqual(browser['Browser'], 'ShopKeep App', 'Expected actual "Browser" to be \'ShopKeep App\' (was \'' + browser['Browser'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
    ...
    assert.strictEqual(browser['Browser_Maker'], 'ShopKeep Inc.', 'Expected actual "Browser_Maker" to be \'ShopKeep Inc.\' (was \'' + browser['Browser_Maker'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
    ...
    assert.strictEqual(browser['Device_Name'], 'G5 (AT&T)', 'Expected actual "Device_Name" to be \'G5 (AT&T)\' (was \'' + browser['Device_Name'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
    ...
    assert.strictEqual(browser['Device_Code_Name'], 'H820', 'Expected actual "Device_Code_Name" to be \'H820\' (was \'' + browser['Device_Code_Name'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
  ...
  test('issue-1920-B ["Shopkeep-Pocket/4.4.0.389 (Android/7.0 samsung SM-N920P)"]', function () {
    const browscap = new Browscap();
    const browser = browscap.getBrowser('Shopkeep-Pocket/4.4.0.389 (Android/7.0 samsung SM-N920P)');
  ...
  test('issue-1920-C ["Shopkeep-Pocket/4.4.0.389 (iOS/10.3.3 Apple iPhone 6s)"]', function () {
    const browscap = new Browscap();
    const browser = browscap.getBrowser('Shopkeep-Pocket/4.4.0.389 (iOS/10.3.3 Apple iPhone 6s)');
  ...
  test('issue-1920-D ["Shopkeep-Pocket/4.4.0.389 (iOS/11.1.2 Apple iPhone X)"]', function () {
    const browscap = new Browscap();
    const browser = browscap.getBrowser('Shopkeep-Pocket/4.4.0.389 (iOS/11.1.2 Apple iPhone X)');
  ...
  test('issue-1920-E ["Shopkeep-Pocket/4.4.0.389 (Android/7.1.1 motorola XT1650)"]', function () {
    const browscap = new Browscap();
    const browser = browscap.getBrowser('Shopkeep-Pocket/4.4.0.389 (Android/7.1.1 motorola XT1650)');
  ...
  test('issue-1920-F ["Shopkeep-Pocket/4.4.0.389 (Android/8.1.0 Google Pixel)"]', function () {
    const browscap = new Browscap();
    const browser = browscap.getBrowser('Shopkeep-Pocket/4.4.0.389 (Android/8.1.0 Google Pixel)');
  ...
  test('issue-1920-G ["Shopkeep-Pocket/4.4.0.389 (Android/6.0.1 motorola Moto G Play)"]', function () {
    const browscap = new Browscap();
    const browser = browscap.getBrowser('Shopkeep-Pocket/4.4.0.389 (Android/6.0.1 motorola Moto G Play)');
    ...
    assert.strictEqual(browser['isModified'], false, 'Expected actual "isModified" to be false (was \'' + browser['isModified'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
    assert.strictEqual(browser['CssVersion'], '3', 'Expected actual "CssVersion" to be \'3\' (was \'' + browser['CssVersion'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
    assert.strictEqual(browser['Device_Name'], 'Moto G Play', 'Expected actual "Device_Name" to be \'Moto G Play\' (was \'' + browser['Device_Name'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
    assert.strictEqual(browser['Device_Maker'], 'Motorola', 'Expected actual "Device_Maker" to be \'Motorola\' (was \'' + browser['Device_Maker'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
    assert.strictEqual(browser['Device_Type'], 'Mobile Phone', 'Expected actual "Device_Type" to be \'Mobile Phone\' (was \'' + browser['Device_Type'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
    assert.strictEqual(browser['Device_Pointing_Method'], 'touchscreen', 'Expected actual "Device_Pointing_Method" to be \'touchscreen\' (was \'' + browser['Device_Pointing_Method'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
    assert.strictEqual(browser['Device_Code_Name'], 'Moto G Play', 'Expected actual "Device_Code_Name" to be \'Moto G Play\' (was \'' + browser['Device_Code_Name'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
    assert.strictEqual(browser['Device_Brand_Name'], 'Motorola', 'Expected actual "Device_Brand_Name" to be \'Motorola\' (was \'' + browser['Device_Brand_Name'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
    assert.strictEqual(browser['RenderingEngine_Name'], 'WebKit', 'Expected actual "RenderingEngine_Name" to be \'WebKit\' (was \'' + browser['RenderingEngine_Name'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
    assert.strictEqual(browser['RenderingEngine_Version'], 'unknown', 'Expected actual "RenderingEngine_Version" to be \'unknown\' (was \'' + browser['RenderingEngine_Version'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
    assert.strictEqual(browser['RenderingEngine_Maker'], 'Apple Inc', 'Expected actual "RenderingEngine_Maker" to be \'Apple Inc\' (was \'' + browser['RenderingEngine_Maker'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
