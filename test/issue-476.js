...
suite('checking for issue 476.', function () {
  test('issue-476 ["Java/1.17"]', function () {
    browser = browscap.getBrowser('Java/1.17');
    ...
    assert.strictEqual(browser['Browser_Maker'], 'Oracle', 'Expected actual "Browser_Maker" to be \'Oracle\' (was \'' + browser['Browser_Maker'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
    assert.strictEqual(browser['Version'], '1.17', 'Expected actual "Version" to be \'1.17\' (was \'' + browser['Version'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
    ...
    assert.strictEqual(browser['MinorVer'], '17', 'Expected actual "MinorVer" to be \'17\' (was \'' + browser['MinorVer'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
