...
suite('checking for issue 848. (1 test)', function() {
  test('issue-848 ["Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/46.0.2490.80 Safari/537.36 ASW/1.46.1990.55"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Avast SafeZone 1.46',
      "Expected actual \"Comment\" to be 'Avast SafeZone 1.46' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
    ...
    assert.strictEqual(
      browser['Browser'],
      'Avast SafeZone',
      "Expected actual \"Browser\" to be 'Avast SafeZone' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Browser_Maker\" to be 'AVAST Software s.r.o.' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Version'],
      '1.46',
      "Expected actual \"Version\" to be '1.46' (was '" +
        browser['Version'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
