...
suite('checking for issue 484. (14 tests)', function() {
  test('issue-484-A ["Mozilla/5.0 (compatible; AskPeterBot; +http://www.askpeter.de/bot.html)"]', function() {
    ...
    assert.strictEqual(
      browser['Browser'],
      'AskPeterBot',
      "Expected actual \"Browser\" to be 'AskPeterBot' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'www.askpeter.info',
      "Expected actual \"Browser_Maker\" to be 'www.askpeter.info' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-484-B ["Mozilla/5.0 (compatible; discoverybot/2.0; +http://discoveryengine.com/discoverybot.html)"]', function() {
    ...
    assert.strictEqual(
      browser['Browser'],
      'Discovery Bot',
      "Expected actual \"Browser\" to be 'Discovery Bot' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser_Maker'],
      'discoveryengine.com',
      "Expected actual \"Browser_Maker\" to be 'discoveryengine.com' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-484-C ["Mozilla/5.0 (compatible; AcoonBot/4.11.1; +http://www.acoon.de/robot.asp)"]', function() {
    ...
    assert.strictEqual(
      browser['Browser'],
      'AcoonBot',
      "Expected actual \"Browser\" to be 'AcoonBot' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-484-D ["Mozilla/5.0 (compatible; AboutUsBot Johnny5/2.0; +http://www.AboutUs.org/)"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'AboutUs Bot',
      "Expected actual \"Comment\" to be 'AboutUs Bot' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser'],
      'AboutUs Bot Johnny5',
      "Expected actual \"Browser\" to be 'AboutUs Bot Johnny5' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser_Maker'],
      'aboutus.org',
      "Expected actual \"Browser_Maker\" to be 'aboutus.org' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-484-E ["Mozilla/5.0 (compatible; woriobot +http://worio.com)"]', function() {
    ...
    assert.strictEqual(
      browser['Browser'],
      'woriobot',
      "Expected actual \"Browser\" to be 'woriobot' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-484-G ["GIDBot/2.0 (+http://www.gidnetwork.com/tools/gzip-test.php)"]', function() {
    ...
    assert.strictEqual(
      browser['Browser'],
      'GIDBot',
      "Expected actual \"Browser\" to be 'GIDBot' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser_Maker'],
      'J de Silva',
      "Expected actual \"Browser_Maker\" to be 'J de Silva' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-484-H ["Zookabot/2.4; +http://zookabot.com"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser('Zookabot/2.4; +http://zookabot.com');
    ...
    assert.strictEqual(
      browser['Browser'],
      'Zookabot',
      "Expected actual \"Browser\" to be 'Zookabot' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser_Maker'],
      'zookabot.com',
      "Expected actual \"Browser_Maker\" to be 'zookabot.com' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-484-I ["FreeWebMonitoring SiteChecker/0.1 (+http://www.freewebmonitoring.com)"]', function() {
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Browser\" to be 'FreeWebMonitoring SiteChecker' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Browser_Maker\" to be 'www.freewebmonitoring.com' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-484-J ["IPv4Scan (+http://ipv4scan.com)"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser('IPv4Scan (+http://ipv4scan.com)');
    ...
    assert.strictEqual(
      browser['Browser'],
      'IPv4Scan',
      "Expected actual \"Browser\" to be 'IPv4Scan' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser_Maker'],
      'ipv4scan.com',
      "Expected actual \"Browser_Maker\" to be 'ipv4scan.com' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-484-K ["MetaURI API/2.0 +metauri.com"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser('MetaURI API/2.0 +metauri.com');
    ...
    assert.strictEqual(
      browser['Browser'],
      'MetaURI Bot',
      "Expected actual \"Browser\" to be 'MetaURI Bot' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser_Maker'],
      'metauri.com',
      "Expected actual \"Browser_Maker\" to be 'metauri.com' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-484-L ["domainsbot (+http://www.domainsbot.com)"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'DomainsBot',
      "Expected actual \"Comment\" to be 'DomainsBot' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser'],
      'DomainsBot',
      "Expected actual \"Browser\" to be 'DomainsBot' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser_Maker'],
      'www.domainsbot.com',
      "Expected actual \"Browser_Maker\" to be 'www.domainsbot.com' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-484-N ["RED/1 (http://redbot.org/)"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser('RED/1 (http://redbot.org/)');
    ...
    assert.strictEqual(
      browser['Browser'],
      'redbot',
      "Expected actual \"Browser\" to be 'redbot' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser_Maker'],
      'redbot.org',
      "Expected actual \"Browser_Maker\" to be 'redbot.org' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
