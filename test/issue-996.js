...
suite('checking for issue 996.', function () {
  ...
  test('issue-996-B ["Mozilla/5.0 (Linux; Android 4.4.2; SM-G800F Build/KOT49H) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/36.0.1985.135 MobileIron/1.6.0 Mobile Safari/537.36"]', function () {
    ...
    assert.strictEqual(browser['Comment'], 'Iron Mobile 1.6', 'Expected actual "Comment" to be \'Iron Mobile 1.6\' (was \'' + browser['Comment'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
