...
suite('checking for issue 1980. (7 tests)', function() {
  test('issue-1980-A ["Apache-HttpClient/4.5.1 (Java/1.7.0_79)"]', function() {
  ...
  test('issue-1980-B ["Apache-HttpClient/4.4 (Java 1.5 minimum; Java/10.0.2)"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'Apache-HttpClient/4.4 (Java 1.5 minimum; Java/10.0.2)'
    );
  ...
  test('issue-1980-C ["Apache-HttpClient/4.3.6 (java 1.5)"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser('Apache-HttpClient/4.3.6 (java 1.5)');
  ...
  test('issue-1980-D ["Apache-HttpClient/4.2.6 (java 1.5)"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser('Apache-HttpClient/4.2.6 (java 1.5)');
  ...
  test('issue-1980-E ["Apache-HttpClient/4.1.3 (java 1.5)"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser('Apache-HttpClient/4.1.3 (java 1.5)');
  ...
  test('issue-1980-F ["Apache-HttpClient/4.0-alpha4 (java 1.4)"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'Apache-HttpClient/4.0-alpha4 (java 1.4)'
    );
  ...
  test('issue-1980-G ["Apache-HttpClient/UNAVAILABLE (java 1.4)"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
