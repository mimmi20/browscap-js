...
suite('checking for issue 2162. (1 test)', function() {
  test('issue-2162-A ["Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:69.0) Gecko/20100101 Firefox/69.0"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Firefox 69.0',
      "Expected actual \"Comment\" to be 'Firefox 69.0' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
    ...
    assert.strictEqual(
      ...
      '69.0',
      "Expected actual \"RenderingEngine_Version\" to be '69.0' (was '" +
        browser['RenderingEngine_Version'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
