...
suite('checking for issue 1897. (1 test)', function () {
  test('issue-1897-A ["Mozilla/5.0 (compatible; Coveobot/2.0;+http://www.coveo.com/bot.html"]', function () {
    const browscap = new Browscap();
    const browser = browscap.getBrowser('Mozilla/5.0 (compatible; Coveobot/2.0;+http://www.coveo.com/bot.html');
    ...
    assert.strictEqual(browser['Browser'], 'Coveobot', 'Expected actual "Browser" to be \'Coveobot\' (was \'' + browser['Browser'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
    ...
    assert.strictEqual(browser['Browser_Maker'], 'Coveo Solutions Inc.', 'Expected actual "Browser_Maker" to be \'Coveo Solutions Inc.\' (was \'' + browser['Browser_Maker'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
