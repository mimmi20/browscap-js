...
suite('checking for issue 216. (1 test)', function () {
  test('issue-216 ["Mozilla/5.0 (compatible; WebmasterCoffee/0.7; +http://webmastercoffee.com/about)"]', function () {
    const browscap = new Browscap();
    const browser = browscap.getBrowser('Mozilla/5.0 (compatible; WebmasterCoffee/0.7; +http://webmastercoffee.com/about)');

    assert.strictEqual(browser['Comment'], 'WebmasterCoffee', 'Expected actual "Comment" to be \'WebmasterCoffee\' (was \'' + browser['Comment'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
    assert.strictEqual(browser['Browser'], 'WebmasterCoffee', 'Expected actual "Browser" to be \'WebmasterCoffee\' (was \'' + browser['Browser'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
