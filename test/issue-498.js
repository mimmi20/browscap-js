...
suite('checking for issue 498.', function () {
  ...
  test('issue-498-C ["python-requests/2.2.1 CPython/2.7.3 Linux/3.2.0-56-generic"]', function () {
    ...
    assert.strictEqual(browser['Comment'], 'python-requests', 'Expected actual "Comment" to be \'python-requests\' (was \'' + browser['Comment'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
  ...
  test('issue-498-D ["Apple-PubSub/65.28"]', function () {
    ...
    assert.strictEqual(browser['Comment'], 'Apple PubSub', 'Expected actual "Comment" to be \'Apple PubSub\' (was \'' + browser['Comment'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
