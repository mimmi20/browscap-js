...
suite('checking for issue 1755. (4 tests)', function() {
  test('issue-1755-A ["Mozilla/5.0 (Linux; Android 4.4.2; HUAWEI P7-L10 Build/HuaweiP7-L10) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/30.0.0.0 Mobile Safari/537.36"]', function() {
    ...
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (Linux; Android 4.4.2; HUAWEI P7-L10 Build/HuaweiP7-L10) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/30.0.0.0 Mobile Safari/537.36'
    );
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'Ascend P7',
      "Expected actual \"Device_Name\" to be 'Ascend P7' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'P7-L10',
      "Expected actual \"Device_Code_Name\" to be 'P7-L10' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1755-B ["NokiaE71/UC Browser8.0.4.121/28/444/UCWEB"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'NokiaE71/UC Browser8.0.4.121/28/444/UCWEB'
    );

    assert.strictEqual(
      browser['Comment'],
      'UC Browser 8.0 for Symbian',
      "Expected actual \"Comment\" to be 'UC Browser 8.0 for Symbian' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1755-C ["NOKIAN95 8GB/UC Browser8.0.3.107/28/444/UCWEB"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'NOKIAN95 8GB/UC Browser8.0.3.107/28/444/UCWEB'
    );
  ...
  test('issue-1755-D ["Tumblr/141 CFNetwork/672.1.14 Darwin/14.0.0"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'Tumblr/141 CFNetwork/672.1.14 Darwin/14.0.0'
    );

    assert.strictEqual(
      browser['Comment'],
      'Tumblr Agent Generic',
      "Expected actual \"Comment\" to be 'Tumblr Agent Generic' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser'],
      'Tumblr Agent',
      "Expected actual \"Browser\" to be 'Tumblr Agent' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser_Maker'],
      'Tumblr, Inc.',
      "Expected actual \"Browser_Maker\" to be 'Tumblr, Inc.' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
