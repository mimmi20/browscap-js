...
suite('checking for issue 2131. (1 test)', function() {
  test('issue-2131-A ["Mozilla/5.0 (Linux; Android 4.0.4; Galaxy Nexus Build/IMM76B) AppleWebKit/537.36 (KHTML, like Gecko; Mediapartners-Google) Chrome/41.0.2272.118 Mobile Safari/537.36"]', function() {
    ...
    assert.strictEqual(
      browser['Browser'],
      'AdSense Bot',
      "Expected actual \"Browser\" to be 'AdSense Bot' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
