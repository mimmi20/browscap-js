...
suite('checking for issue 2001. (2 tests)', function () {
  test('issue-2001-A ["Acast/1.25.2 (Phone; Android 8.0.2; OnePlus 5.0)"]', function () {
    browser = browscap.getBrowser('Acast/1.25.2 (Phone; Android 8.0.2; OnePlus 5.0)');

    assert.strictEqual(browser['Comment'], 'Acast Podcast App', 'Expected actual "Comment" to be \'Acast Podcast App\' (was \'' + browser['Comment'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
    assert.strictEqual(browser['Browser'], 'Acast Podcast App', 'Expected actual "Browser" to be \'Acast Podcast App\' (was \'' + browser['Browser'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
    ...
    assert.strictEqual(browser['Browser_Maker'], 'Acast AB', 'Expected actual "Browser_Maker" to be \'Acast AB\' (was \'' + browser['Browser_Maker'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
    ...
    assert.strictEqual(browser['Device_Name'], '5', 'Expected actual "Device_Name" to be \'5\' (was \'' + browser['Device_Name'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
  ...
  test('issue-2001-B ["Acast/1.46.0 (CarPlay; iOS 12.0.0, iPhone10,3)"]', function () {
    browser = browscap.getBrowser('Acast/1.46.0 (CarPlay; iOS 12.0.0, iPhone10,3)');
