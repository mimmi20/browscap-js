...
suite('checking for issue 1075. (1 test)', function() {
  test('issue-1075 ["Mozilla/5.0 (Linux; Android 5.0.2; K01E Build/LRX22G) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/39.0.2171.93 Safari/537.36"]', function() {
    ...
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (Linux; Android 5.0.2; K01E Build/LRX22G) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/39.0.2171.93 Safari/537.36'
    );
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'MeMO Pad 10',
      "Expected actual \"Device_Name\" to be 'MeMO Pad 10' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'K01E',
      "Expected actual \"Device_Code_Name\" to be 'K01E' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
