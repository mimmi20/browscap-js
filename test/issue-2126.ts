...
suite('checking for issue 2126. (7 tests)', function() {
  test('issue-2126-A ["Mozilla/5.0 (compatible; Embedly/0.2; +http://support.embed.ly/)"]', function() {
    ...
    assert.strictEqual(
      browser['Browser'],
      'Embedly',
      "Expected actual \"Browser\" to be 'Embedly' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'embed.ly',
      "Expected actual \"Browser_Maker\" to be 'embed.ly' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-2126-C ["Apache-HttpClient/4.5.3-SNAPSHOT (Java/1.8.0_152)"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
    ...
    assert.strictEqual(
      browser['Comment'],
      'Apache HttpClient',
      "Expected actual \"Comment\" to be 'Apache HttpClient' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser'],
      'Apache HttpClient',
      "Expected actual \"Browser\" to be 'Apache HttpClient' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Browser_Maker\" to be 'The Apache Software Foundation' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-2126-E ["curl/7.54.0"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser('curl/7.54.0');
    ...
    assert.strictEqual(
      browser['Version'],
      '7.54',
      "Expected actual \"Version\" to be '7.54' (was '" +
        browser['Version'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-2126-G ["PostmanRuntime/7.6.0"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser('PostmanRuntime/7.6.0');
    ...
    assert.strictEqual(
      browser['Browser'],
      'Postman Runtime',
      "Expected actual \"Browser\" to be 'Postman Runtime' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser_Maker'],
      'Postman, Inc.',
      "Expected actual \"Browser_Maker\" to be 'Postman, Inc.' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-2126-I ["python-requests/2.21.0"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser('python-requests/2.21.0');

    assert.strictEqual(
      browser['Comment'],
      'python-requests 2.21',
      "Expected actual \"Comment\" to be 'python-requests 2.21' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Version'],
      '2.21',
      "Expected actual \"Version\" to be '2.21' (was '" +
        browser['Version'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-2126-J ["Lynx/2.8.6rel.4 libwww-FM/2.14 SSL-MM/1.4.1 OpenSSL/0.9.8g"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
    ...
    assert.strictEqual(
      browser['Comment'],
      'Lynx',
      "Expected actual \"Comment\" to be 'Lynx' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser'],
      'Lynx',
      "Expected actual \"Browser\" to be 'Lynx' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser_Maker'],
      'Thomas Dickey',
      "Expected actual \"Browser_Maker\" to be 'Thomas Dickey' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-2126-K ["Mozilla/5.0 (Linux; Android 5.0; SM-G920A) AppleWebKit (KHTML, like Gecko) Chrome Mobile Safari (compatible; AdsBot-Google-Mobile; +http://www.google.com/mobile/adsbot.html)"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Comment\" to be 'AdsBot Google-Mobile for Android' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Browser\" to be 'AdsBot Google-Mobile' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
