...
suite('checking for issue 1902. (1 test)', function() {
  test('issue-1902-A ["Mozilla/5.0 (compatible; Statusdroid/1.0; +http://www.statusdroid.com/pages/bot/)"]', function() {
    ...
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (compatible; Statusdroid/1.0; +http://www.statusdroid.com/pages/bot/)'
    );
    ...
    assert.strictEqual(
      browser['Browser'],
      'Statusdroid Bot',
      "Expected actual \"Browser\" to be 'Statusdroid Bot' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'StatusDroid s.r.o',
      "Expected actual \"Browser_Maker\" to be 'StatusDroid s.r.o' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
