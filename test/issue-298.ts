...
suite('checking for issue 298. (1 test)', function() {
  test('issue-298 ["Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/34.0.1847.132 Safari/537.36 OPR/21.0.1432.67"]', function() {
    ...
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/34.0.1847.132 Safari/537.36 OPR/21.0.1432.67'
    );

    assert.strictEqual(
      browser['Comment'],
      'Opera 21.0',
      "Expected actual \"Comment\" to be 'Opera 21.0' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
