...
suite('checking for issue 1638. (1 test)', function() {
  test('issue-1638 ["Mozilla/5.0 (Freebox; Linux i686) AppleWebKit/538.1 (KHTML, like Gecko) Mail Free/1.0 Safari/538.1"]', function() {
    ...
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (Freebox; Linux i686) AppleWebKit/538.1 (KHTML, like Gecko) Mail Free/1.0 Safari/538.1'
    );

    assert.strictEqual(
      browser['Comment'],
      'Mail Free',
      "Expected actual \"Comment\" to be 'Mail Free' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
    ...
    assert.strictEqual(
      browser['Browser'],
      'Mail Free',
      "Expected actual \"Browser\" to be 'Mail Free' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
