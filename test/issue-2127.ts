...
suite('checking for issue 2127. (1 test)', function() {
  test('issue-2127-A ["Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_5) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3834.0 Safari/537.36 Edg/77.0.207.0"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Edge 77.0',
      "Expected actual \"Comment\" to be 'Edge 77.0' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
