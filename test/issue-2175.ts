...
suite('checking for issue 2175. (1 test)', function() {
  test('issue-2175-A ["TelegramBot (like TwitterBot)"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser('TelegramBot (like TwitterBot)');
    ...
    assert.strictEqual(
      browser['Browser'],
      'TelegramBot',
      "Expected actual \"Browser\" to be 'TelegramBot' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
