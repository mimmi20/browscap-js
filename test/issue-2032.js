...
suite('checking for issue 2032. (1 test)', function () {
  test('issue-2032-A ["TwitterAndroid/7.71.1-release.15 (8900196-r-15) TA-1028/8.0.0 (HMD Global;TA-1028;Nokia;TA-1028_00WW;0;;1;2013)"]', function () {
    const browscap = new Browscap();
    const browser = browscap.getBrowser('TwitterAndroid/7.71.1-release.15 (8900196-r-15) TA-1028/8.0.0 (HMD Global;TA-1028;Nokia;TA-1028_00WW;0;;1;2013)');
    ...
    assert.strictEqual(browser['Device_Code_Name'], 'TA-1028', 'Expected actual "Device_Code_Name" to be \'TA-1028\' (was \'' + browser['Device_Code_Name'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
