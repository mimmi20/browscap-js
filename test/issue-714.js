...
suite('checking for issue 714.', function () {
  test('issue-714 ["Mozilla/5.0 (Macintosh; ARM Mac OS X) AppleWebKit/538.15 (KHTML, like Gecko) Safari/538.15 Version/6.0 Debian/7.8 (3.8.2.0-0rpi21rpi1) Epiphany/3.8.2"]', function () {
    ...
    assert.strictEqual(browser['Platform_Maker'], 'Debian', 'Expected actual "Platform_Maker" to be \'Debian\' (was \'' + browser['Platform_Maker'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
