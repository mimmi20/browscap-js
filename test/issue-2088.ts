...
suite('checking for issue 2088. (1 test)', function() {
  test('issue-2088-A ["Mozilla/5.0 (Linux; Android 6.0.1; Nexus 5X Build/MMB29P) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2272.96 Mobile Safari/537.36 (compatible; Google-Read-Aloud; +https://support.google.com/webmasters/answer/1061943)"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Google-Read-Aloud',
      "Expected actual \"Comment\" to be 'Google-Read-Aloud' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Browser\" to be 'Google Read Aloud Bot' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
