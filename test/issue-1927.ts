...
suite('checking for issue 1927. (1 test)', function() {
  test('issue-1927-A ["Mozilla/5.0 (iPhone; CPU iPhone OS 11_4_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15G77 Safari/605.1.15 SznProhlizec/5.17i"]', function() {
    ...
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (iPhone; CPU iPhone OS 11_4_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15G77 Safari/605.1.15 SznProhlizec/5.17i'
    );

    assert.strictEqual(
      browser['Comment'],
      'Seznam Browser 5.17',
      "Expected actual \"Comment\" to be 'Seznam Browser 5.17' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
    ...
    assert.strictEqual(
      browser['Version'],
      '5.17',
      "Expected actual \"Version\" to be '5.17' (was '" +
        browser['Version'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
