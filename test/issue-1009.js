...
suite('checking for issue 1009. (1 test)', function () {
  test('issue-1009 ["Mozilla/5.0 (Linux; Android 4.4.4; F5281 Build/KTU84Q) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/26.0.1985.135 Safari/537.36"]', function () {
    const browscap = new Browscap();
    const browser = browscap.getBrowser('Mozilla/5.0 (Linux; Android 4.4.4; F5281 Build/KTU84Q) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/26.0.1985.135 Safari/537.36');

    assert.strictEqual(browser['Comment'], 'Chrome 26.0', 'Expected actual "Comment" to be \'Chrome 26.0\' (was \'' + browser['Comment'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
    ...
    assert.strictEqual(browser['Device_Name'], 'Sero 8 Pro', 'Expected actual "Device_Name" to be \'Sero 8 Pro\' (was \'' + browser['Device_Name'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
    ...
    assert.strictEqual(browser['Device_Code_Name'], 'F5281', 'Expected actual "Device_Code_Name" to be \'F5281\' (was \'' + browser['Device_Code_Name'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
