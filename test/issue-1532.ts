...
suite('checking for issue 1532. (4 tests)', function() {
  test('issue-1532-A ["Snapchat/10.12.0.2 (iPhone8,1; iOS 10.3.2; gzip)"]', function() {
    ...
    let browser = browscap.getBrowser(
      'Snapchat/10.12.0.2 (iPhone8,1; iOS 10.3.2; gzip)'
    );

    assert.strictEqual(
      browser['Comment'],
      'Snapchat Agent 10.12 for iOS',
      "Expected actual \"Comment\" to be 'Snapchat Agent 10.12 for iOS' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
    ...
    assert.strictEqual(
      browser['Browser'],
      'Snapchat Agent',
      "Expected actual \"Browser\" to be 'Snapchat Agent' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Version'],
      '10.12',
      "Expected actual \"Version\" to be '10.12' (was '" +
        browser['Version'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1532-B ["Snapchat/10.11.1.0 (iPhone6,1; iOS 10.2.1; gzip)"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'Snapchat/10.11.1.0 (iPhone6,1; iOS 10.2.1; gzip)'
    );

    assert.strictEqual(
      browser['Comment'],
      'Snapchat Agent 10.11 for iOS',
      "Expected actual \"Comment\" to be 'Snapchat Agent 10.11 for iOS' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Version'],
      '10.11',
      "Expected actual \"Version\" to be '10.11' (was '" +
        browser['Version'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1532-C ["Snapchat/10.2.0.2 (iPhone5,1; iOS 10.1.1; gzip)"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'Snapchat/10.2.0.2 (iPhone5,1; iOS 10.1.1; gzip)'
    );

    assert.strictEqual(
      browser['Comment'],
      'Snapchat Agent 10.2 for iOS',
      "Expected actual \"Comment\" to be 'Snapchat Agent 10.2 for iOS' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1532-D ["Snapchat/9.45.10.0 (iPhone6,1; iOS 10.1.1; gzip)"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'Snapchat/9.45.10.0 (iPhone6,1; iOS 10.1.1; gzip)'
    );

    assert.strictEqual(
      browser['Comment'],
      'Snapchat Agent 9.45 for iOS',
      "Expected actual \"Comment\" to be 'Snapchat Agent 9.45 for iOS' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Version'],
      '9.45',
      "Expected actual \"Version\" to be '9.45' (was '" +
        browser['Version'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
