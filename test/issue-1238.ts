...
suite('checking for issue 1238. (1 test)', function() {
  test('issue-1238 ["Mozilla/5.0 (iPad; U; CPU OS 10_2 like Mac OS X; en-us; iPad4,7) AppleWebKit/534.46 (KHTML, like Gecko) UCBrowser/2.4.0.367 U3/1 Safari/7543.48.3"]', function() {
    ...
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (iPad; U; CPU OS 10_2 like Mac OS X; en-us; iPad4,7) AppleWebKit/534.46 (KHTML, like Gecko) UCBrowser/2.4.0.367 U3/1 Safari/7543.48.3'
    );

    assert.strictEqual(
      browser['Comment'],
      'UC Browser 2.4 for iOS',
      "Expected actual \"Comment\" to be 'UC Browser 2.4 for iOS' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
