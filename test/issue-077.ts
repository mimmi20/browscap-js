...
suite('checking for issue 077. (7 tests)', function() {
  test('issue-077-G ["SAMSUNG-SGH-E250/1.0 Profile/MIDP-2.0 Configuration/CLDC-1.1 UP.Browser/6.2.3.3.c.1.101 (GUI) MMP/2.0 (compatible; Googlebot-Mobile/2.1; +http://www.google.com/bot.html)"]', function() {
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'SGH-E250',
      "Expected actual \"Device_Name\" to be 'SGH-E250' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'SGH-E250',
      "Expected actual \"Device_Code_Name\" to be 'SGH-E250' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-077-F ["DoCoMo/2.0 N905i(c100;TB;W24H16) (compatible; Googlebot-Mobile/2.1; +http://www.google.com/bot.html)"]', function() {
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'N905i',
      "Expected actual \"Device_Name\" to be 'N905i' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Maker'],
      'NEC',
      "Expected actual \"Device_Maker\" to be 'NEC' (was '" +
        browser['Device_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Code_Name'],
      'N905i',
      "Expected actual \"Device_Code_Name\" to be 'N905i' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Brand_Name'],
      'NEC',
      "Expected actual \"Device_Brand_Name\" to be 'NEC' (was '" +
        browser['Device_Brand_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-077-B ["integrity/4"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser('integrity/4');
    ...
    assert.strictEqual(
      browser['Browser'],
      'Integrity',
      "Expected actual \"Browser\" to be 'Integrity' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
