...
suite('checking for issue 1880. (4 tests)', function () {
  test('issue-1880-A ["stagefright/1.2 (Linux;Android 4.1.2)"]', function () {
    ...
    const browser = browscap.getBrowser('stagefright/1.2 (Linux;Android 4.1.2)');
  ...
  test('issue-1880-B ["stagefright/1.2 (Linux;Android NexPlayer LG-P71310c-ZAF-XX)"]', function () {
    const browscap = new Browscap();
    const browser = browscap.getBrowser('stagefright/1.2 (Linux;Android NexPlayer LG-P71310c-ZAF-XX)');
    ...
    assert.strictEqual(browser['Device_Type'], 'Mobile Phone', 'Expected actual "Device_Type" to be \'Mobile Phone\' (was \'' + browser['Device_Type'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
    assert.strictEqual(browser['Device_Pointing_Method'], 'touchscreen', 'Expected actual "Device_Pointing_Method" to be \'touchscreen\' (was \'' + browser['Device_Pointing_Method'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
    assert.strictEqual(browser['Device_Code_Name'], 'P713', 'Expected actual "Device_Code_Name" to be \'P713\' (was \'' + browser['Device_Code_Name'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
  ...
  test('issue-1880-C ["Samsung GT-N7100 stagefright/1.2 (Linux;Android 4.4.2)"]', function () {
    const browscap = new Browscap();
    const browser = browscap.getBrowser('Samsung GT-N7100 stagefright/1.2 (Linux;Android 4.4.2)');
  ...
  test('issue-1880-D ["PodcastAddict/v2 - Dalvik/2.1.0 (Linux; U; Android 5.1.1; SM-J105F Build/LMY47V)"]', function () {
    const browscap = new Browscap();
    const browser = browscap.getBrowser('PodcastAddict/v2 - Dalvik/2.1.0 (Linux; U; Android 5.1.1; SM-J105F Build/LMY47V)');

    assert.strictEqual(browser['Comment'], 'PodcastAddict', 'Expected actual "Comment" to be \'PodcastAddict\' (was \'' + browser['Comment'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
    assert.strictEqual(browser['Browser'], 'PodcastAddict', 'Expected actual "Browser" to be \'PodcastAddict\' (was \'' + browser['Browser'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
    assert.strictEqual(browser['Browser_Type'], 'Multimedia Player', 'Expected actual "Browser_Type" to be \'Multimedia Player\' (was \'' + browser['Browser_Type'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
    assert.strictEqual(browser['Browser_Bits'], '32', 'Expected actual "Browser_Bits" to be \'32\' (was \'' + browser['Browser_Bits'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
    assert.strictEqual(browser['Browser_Maker'], 'unknown', 'Expected actual "Browser_Maker" to be \'unknown\' (was \'' + browser['Browser_Maker'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
    assert.strictEqual(browser['Browser_Modus'], 'unknown', 'Expected actual "Browser_Modus" to be \'unknown\' (was \'' + browser['Browser_Modus'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
