...
suite('checking for issue 529.', function () {
  test('issue-529-A ["Mozilla/5.0 (Linux;Android 4.0.4; Digma iDsD7 3G Build/IMM76D) AppleWebKit/537.36(KHTML,like Gecko) Chrome/38.0.2125.102 Mobile Safari/537.36"]', function () {
    ...
    assert.strictEqual(browser['Device_Name'], 'iDsD7 3G', 'Expected actual "Device_Name" to be \'iDsD7 3G\' (was \'' + browser['Device_Name'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
    ...
    assert.strictEqual(browser['Device_Code_Name'], 'iDsD7 3G', 'Expected actual "Device_Code_Name" to be \'iDsD7 3G\' (was \'' + browser['Device_Code_Name'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
  ...
  test('issue-529-B ["Mozilla/5.0 (Linux;Android 4.4.2; SM - T531 Build/KOT-49H) AppleWebKit/537.36(KHTML,like Gecko) Chrome/39.0.2171.93 Safari/537.36"]', function () {
