...
suite('checking for issue 529. (2 tests)', function () {
  test('issue-529-A ["Mozilla/5.0 (Linux;Android 4.0.4; Digma iDsD7 3G Build/IMM76D) AppleWebKit/537.36(KHTML,like Gecko) Chrome/38.0.2125.102 Mobile Safari/537.36"]', function () {
    ...
    const browser = browscap.getBrowser('Mozilla/5.0 (Linux;Android 4.0.4; Digma iDsD7 3G Build/IMM76D) AppleWebKit/537.36(KHTML,like Gecko) Chrome/38.0.2125.102 Mobile Safari/537.36');
  ...
  test('issue-529-B ["Mozilla/5.0 (Linux;Android 4.4.2; SM - T531 Build/KOT-49H) AppleWebKit/537.36(KHTML,like Gecko) Chrome/39.0.2171.93 Safari/537.36"]', function () {
    const browscap = new Browscap();
    const browser = browscap.getBrowser('Mozilla/5.0 (Linux;Android 4.4.2; SM - T531 Build/KOT-49H) AppleWebKit/537.36(KHTML,like Gecko) Chrome/39.0.2171.93 Safari/537.36');
