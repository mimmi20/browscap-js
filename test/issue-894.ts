...
suite('checking for issue 894. (1 test)', function() {
  test('issue-894 ["Mozilla/5.0 (Macintosh; ARM Mac OS X) AppleWebKit/538.15 (KHTML, like Gecko) Safari/538.15 Version/6.0 Raspbian/8.0 (1:3.8.2.0-0rpi27rpi1g) Epiphany/3.8.2"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Epiphany 3.8',
      "Expected actual \"Comment\" to be 'Epiphany 3.8' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'Raspberry Pi',
      "Expected actual \"Device_Name\" to be 'Raspberry Pi' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Device_Maker\" to be 'Raspberry Pi Foundation' (was '" +
        browser['Device_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'Raspberry Pi',
      "Expected actual \"Device_Code_Name\" to be 'Raspberry Pi' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'Raspberry Pi Foundation',
      "Expected actual \"Device_Brand_Name\" to be 'Raspberry Pi Foundation' (was '" +
        browser['Device_Brand_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
