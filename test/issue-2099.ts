...
suite('checking for issue 2099. (1 test)', function() {
  test('issue-2099-A ["Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/76.0.3794.0 Safari/537.36 Edg/76.0.161.0"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Edge 76.0',
      "Expected actual \"Comment\" to be 'Edge 76.0' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
