...
suite('checking for issue 148. (1 test)', function() {
  test('issue-148 ["Yahoo:LinkExpander:Slingstone"]', function() {
    ...
    let browser = browscap.getBrowser('Yahoo:LinkExpander:Slingstone');

    assert.strictEqual(
      browser['Comment'],
      'Yahoo',
      "Expected actual \"Comment\" to be 'Yahoo' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
    ...
    assert.strictEqual(
      browser['Browser'],
      'Yahoo Slingstone',
      "Expected actual \"Browser\" to be 'Yahoo Slingstone' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
