...
suite('checking for issue 1023.', function () {
  test('issue-1023 ["Netcraft SSL Server Survey - contact info@netcraft.com"]', function () {
    ...
    assert.strictEqual(browser['Browser_Maker'], 'Netcraft Ltd.', 'Expected actual "Browser_Maker" to be \'Netcraft Ltd.\' (was \'' + browser['Browser_Maker'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
