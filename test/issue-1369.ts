...
suite('checking for issue 1369. (3 tests)', function() {
  test('issue-1369-A ["Reddit/Version 2.6.0/Build 200033/iOS Version 10.0.2 (Build 14A456)"]', function() {
    ...
    let browser = browscap.getBrowser(
      'Reddit/Version 2.6.0/Build 200033/iOS Version 10.0.2 (Build 14A456)'
    );

    assert.strictEqual(
      browser['Comment'],
      'Reddit App',
      "Expected actual \"Comment\" to be 'Reddit App' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
    ...
    assert.strictEqual(
      browser['Browser'],
      'Reddit App',
      "Expected actual \"Browser\" to be 'Reddit App' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'Reddit Inc',
      "Expected actual \"Browser_Maker\" to be 'Reddit Inc' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1369-B ["Reddit/Version 2.6.0/Build 200033/iOS Version 10.1.1 (Build 14B100)"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'Reddit/Version 2.6.0/Build 200033/iOS Version 10.1.1 (Build 14B100)'
    );
  ...
  test('issue-1369-C ["Reddit/Version 2.6.0/Build 200033/iOS Version 10.2.1 (Build 14D27)"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'Reddit/Version 2.6.0/Build 200033/iOS Version 10.2.1 (Build 14D27)'
    );
