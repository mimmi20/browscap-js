...
suite('checking for issue 985. (9 tests)', function() {
  test('issue-985-A ["Dalvik/1.6.0 (Linux; U; Android 4.4.2; MI PAD MIUI/KXFCNBF2.0)"]', function() {
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Comment\" to be 'Miui Browser Generic for Dalvik' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
    ...
    assert.strictEqual(
      browser['Platform'],
      'Miui OS',
      "Expected actual \"Platform\" to be 'Miui OS' (was '" +
        browser['Platform'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'a fork of Android OS by Xiaomi',
      "Expected actual \"Platform_Description\" to be 'a fork of Android OS by Xiaomi' (was '" +
        browser['Platform_Description'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'Xiaomi Tech',
      "Expected actual \"Platform_Maker\" to be 'Xiaomi Tech' (was '" +
        browser['Platform_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-985-D ["Dalvik/1.6.0 (Linux; U; Android 4.4.4; MI PAD MIUI/4.11.28)"]', function() {
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Comment\" to be 'Miui Browser 4.11 for Dalvik' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Platform_Version'],
      '4.11',
      "Expected actual \"Platform_Version\" to be '4.11' (was '" +
        browser['Platform_Version'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-985-E ["Dalvik/1.6.0 (Linux; U; Android 4.4.4; MI PAD MIUI/4.12.19)"]', function() {
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Comment\" to be 'Miui Browser 4.12 for Dalvik' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Platform_Version'],
      '4.12',
      "Expected actual \"Platform_Version\" to be '4.12' (was '" +
        browser['Platform_Version'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-985-F ["Dalvik/1.6.0 (Linux; U; Android 4.4.4; MI PAD MIUI/4.8.22)"]', function() {
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Comment\" to be 'Miui Browser 4.8 for Dalvik' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Platform_Version'],
      '4.8',
      "Expected actual \"Platform_Version\" to be '4.8' (was '" +
        browser['Platform_Version'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-985-G ["Dalvik/1.6.0 (Linux; U; Android 4.4.4; MI PAD MIUI/5.1.16)"]', function() {
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Comment\" to be 'Miui Browser 5.1 for Dalvik' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-985-H ["Dalvik/1.6.0 (Linux; U; Android 4.4.4; MI PAD MIUI/5.10.22)"]', function() {
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Comment\" to be 'Miui Browser 5.10 for Dalvik' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Version'],
      '5.10',
      "Expected actual \"Version\" to be '5.10' (was '" +
        browser['Version'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Platform_Version'],
      '5.10',
      "Expected actual \"Platform_Version\" to be '5.10' (was '" +
        browser['Platform_Version'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-985-I ["Dalvik/1.6.0 (Linux; U; Android 4.4.4; MI PAD MIUI/5.11.1)"]', function() {
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Comment\" to be 'Miui Browser 5.11 for Dalvik' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Platform_Version'],
      '5.11',
      "Expected actual \"Platform_Version\" to be '5.11' (was '" +
        browser['Platform_Version'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
