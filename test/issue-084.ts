...
suite('checking for issue 084. (8 tests)', function() {
  test('issue-084-H ["Mozilla/5.0 (Linux; U) AppleWebKit/537.4 (KHTML, like Gecko) Chrome/22.0.1229.79 Safari/537.4"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Chrome 22.0',
      "Expected actual \"Comment\" to be 'Chrome 22.0' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
  ...
  test('issue-084-B ["Mozilla/5.0 (Linux; U; Android 4.2.2; es-sa; LG-D805 Build/JDQ39B) AppleWebKit/534.30 (KHTML, like Gecko) Version/4.2 Mobile Safari/534.30"]', function() {
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'D805',
      "Expected actual \"Device_Name\" to be 'D805' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Code_Name'],
      'D805',
      "Expected actual \"Device_Code_Name\" to be 'D805' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
