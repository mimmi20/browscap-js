...
suite('checking for issue 1345. (59 tests)', function() {
  test('issue-1345-A ["iTunes/10.2.1 (Macintosh; Intel Mac OS X 10.7) AppleWebKit/534.20.8"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'iTunes 10.2',
      "Expected actual \"Comment\" to be 'iTunes 10.2' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
    ...
    assert.strictEqual(
      browser['Browser'],
      'iTunes',
      "Expected actual \"Browser\" to be 'iTunes' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1345-C ["iTunes/10.4.1 (Windows; Microsoft Windows Vista Home Basic Edition Service Pack 2 (Build 6002)) AppleWebKit/534.50"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'iTunes/10.4.1 (Windows; Microsoft Windows Vista Home Basic Edition Service Pack 2 (Build 6002)) AppleWebKit/534.50'
    );

    assert.strictEqual(
      browser['Comment'],
      'iTunes 10.4',
      "Expected actual \"Comment\" to be 'iTunes 10.4' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Version'],
      '10.4',
      "Expected actual \"Version\" to be '10.4' (was '" +
        browser['Version'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1345-D ["iTunes/10.5 (Macintosh; Intel Mac OS X 10.6.8) AppleWebKit/534.51.22"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'iTunes 10.5',
      "Expected actual \"Comment\" to be 'iTunes 10.5' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1345-H ["iTunes/10.7 (Windows; Microsoft Windows Vista Home Premium Edition Service Pack 1 (Build 6001)) AppleWebKit/536.26.9"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'iTunes 10.7',
      "Expected actual \"Comment\" to be 'iTunes 10.7' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Version'],
      '10.7',
      "Expected actual \"Version\" to be '10.7' (was '" +
        browser['Version'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1345-I ["iTunes/11.0.1 (Windows; Microsoft Windows 7 x64 Business Edition Service Pack 1 (Build 7601)) AppleWebKit/536.27.1"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'iTunes 11.0',
      "Expected actual \"Comment\" to be 'iTunes 11.0' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1345-O ["iTunes/11.1 (Windows; Microsoft Windows 7 x64 Business Edition Service Pack 1 (Build 7601)) AppleWebKit/536.30.1"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'iTunes 11.1',
      "Expected actual \"Comment\" to be 'iTunes 11.1' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1345-Q ["iTunes/11.2.2 (Windows; Microsoft Windows XP Home Edition Service Pack 3 (Build 2600)) AppleWebKit/537.60.15"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'iTunes/11.2.2 (Windows; Microsoft Windows XP Home Edition Service Pack 3 (Build 2600)) AppleWebKit/537.60.15'
    );

    assert.strictEqual(
      browser['Comment'],
      'iTunes 11.2',
      "Expected actual \"Comment\" to be 'iTunes 11.2' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1345-R ["iTunes/11.4 (Windows; Microsoft Windows 7 x64 Home Premium Edition Service Pack 1 (Build 7601)) AppleWebKit/537.60.17"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'iTunes/11.4 (Windows; Microsoft Windows 7 x64 Home Premium Edition Service Pack 1 (Build 7601)) AppleWebKit/537.60.17'
    );

    assert.strictEqual(
      browser['Comment'],
      'iTunes 11.4',
      "Expected actual \"Comment\" to be 'iTunes 11.4' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1345-S ["iTunes/11.4 (Windows; Microsoft Windows XP Home Edition Service Pack 3 (Build 2600)) AppleWebKit/537.60.17"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'iTunes/11.4 (Windows; Microsoft Windows XP Home Edition Service Pack 3 (Build 2600)) AppleWebKit/537.60.17'
    );
  ...
  test('issue-1345-T ["iTunes/12.0.1 (Macintosh; OS X 10.8.5) AppleWebKit/536.30.1"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'iTunes/12.0.1 (Macintosh; OS X 10.8.5) AppleWebKit/536.30.1'
    );

    assert.strictEqual(
      browser['Comment'],
      'iTunes 12.0',
      "Expected actual \"Comment\" to be 'iTunes 12.0' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1345-V ["iTunes/12.0.1 (Windows; Microsoft Windows XP Home Edition Service Pack 3 (Build 2600)) AppleWebKit/7600.1017.0.24"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'iTunes/12.0.1 (Windows; Microsoft Windows XP Home Edition Service Pack 3 (Build 2600)) AppleWebKit/7600.1017.0.24'
    );
  ...
  test('issue-1345-W ["iTunes/12.1 (Macintosh; OS X 10.10) AppleWebKit/0600.1.25"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'iTunes/12.1 (Macintosh; OS X 10.10) AppleWebKit/0600.1.25'
    );

    assert.strictEqual(
      browser['Comment'],
      'iTunes 12.1',
      "Expected actual \"Comment\" to be 'iTunes 12.1' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1345-X ["iTunes/12.1.2 (Macintosh; OS X 10.7.5) AppleWebKit/534.57.7"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'iTunes/12.1.2 (Macintosh; OS X 10.7.5) AppleWebKit/534.57.7'
    );
  ...
  test('issue-1345-Y ["iTunes/12.1.2 (Windows Microsoft Windows 8 x64 Home Premium Edition (Build 9200) x64) AppleWebKit/7600.1017.9000.3"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'iTunes/12.1.2 (Windows Microsoft Windows 8 x64 Home Premium Edition (Build 9200) x64) AppleWebKit/7600.1017.9000.3'
    );
  ...
  test('issue-1345-Z ["iTunes/12.2 (Macintosh; OS X 10.10.4) AppleWebKit/0600.7.12"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'iTunes/12.2 (Macintosh; OS X 10.10.4) AppleWebKit/0600.7.12'
    );

    assert.strictEqual(
      browser['Comment'],
      'iTunes 12.2',
      "Expected actual \"Comment\" to be 'iTunes 12.2' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1345-AA ["iTunes/12.2.1 (Macintosh; OS X 10.10.4) AppleWebKit/600.7.12"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'iTunes/12.2.1 (Macintosh; OS X 10.10.4) AppleWebKit/600.7.12'
    );
  ...
  test('issue-1345-AB ["iTunes/12.2.1 (Windows; Microsoft Windows 8 x64 Home Premium Edition (Build 9200); x64) AppleWebKit/7600.5017.0.22"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'iTunes/12.2.1 (Windows; Microsoft Windows 8 x64 Home Premium Edition (Build 9200); x64) AppleWebKit/7600.5017.0.22'
    );
  ...
  test('issue-1345-AC ["iTunes/12.2.2 (Macintosh; OS X 10.10.5) AppleWebKit/600.8.9"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'iTunes/12.2.2 (Macintosh; OS X 10.10.5) AppleWebKit/600.8.9'
    );
  ...
  test('issue-1345-AD ["iTunes/12.2.2 (Windows Microsoft Windows 7 x64 Home Premium Edition Service Pack 1 (Build 7601) x64) AppleWebKit/7600.5017.0.22"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'iTunes/12.2.2 (Windows Microsoft Windows 7 x64 Home Premium Edition Service Pack 1 (Build 7601) x64) AppleWebKit/7600.5017.0.22'
    );
  ...
  test('issue-1345-AE ["iTunes/12.3.2 (Macintosh; OS X 10.9.5) AppleWebKit/537.78.2"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'iTunes/12.3.2 (Macintosh; OS X 10.9.5) AppleWebKit/537.78.2'
    );

    assert.strictEqual(
      browser['Comment'],
      'iTunes 12.3',
      "Expected actual \"Comment\" to be 'iTunes 12.3' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Version'],
      '12.3',
      "Expected actual \"Version\" to be '12.3' (was '" +
        browser['Version'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1345-AF ["iTunes/12.4 (Windows; Microsoft Windows 8.1 x64 Business Edition (Build 9200); x64) AppleWebKit/7601.6016.1000.1"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'iTunes/12.4 (Windows; Microsoft Windows 8.1 x64 Business Edition (Build 9200); x64) AppleWebKit/7601.6016.1000.1'
    );

    assert.strictEqual(
      browser['Comment'],
      'iTunes 12.4',
      "Expected actual \"Comment\" to be 'iTunes 12.4' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Version'],
      '12.4',
      "Expected actual \"Version\" to be '12.4' (was '" +
        browser['Version'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1345-AG ["iTunes/12.5.5 (Macintosh; OS X 10.10.5) AppleWebKit/600.8.9"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'iTunes/12.5.5 (Macintosh; OS X 10.10.5) AppleWebKit/600.8.9'
    );

    assert.strictEqual(
      browser['Comment'],
      'iTunes 12.5',
      "Expected actual \"Comment\" to be 'iTunes 12.5' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Version'],
      '12.5',
      "Expected actual \"Version\" to be '12.5' (was '" +
        browser['Version'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1345-AH ["iTunes/12.5.5 (Macintosh; OS X 10.11.5) AppleWebKit/601.6.17"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'iTunes/12.5.5 (Macintosh; OS X 10.11.5) AppleWebKit/601.6.17'
    );
  ...
  test('issue-1345-AI ["iTunes/12.5.5 (Macintosh; OS X 10.9.5) AppleWebKit/537.78.2"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'iTunes/12.5.5 (Macintosh; OS X 10.9.5) AppleWebKit/537.78.2'
    );
  ...
  test('issue-1345-AJ ["iTunes/12.6 (Macintosh; OS X 10.10.5) AppleWebKit/600.8.9"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'iTunes/12.6 (Macintosh; OS X 10.10.5) AppleWebKit/600.8.9'
    );

    assert.strictEqual(
      browser['Comment'],
      'iTunes 12.6',
      "Expected actual \"Comment\" to be 'iTunes 12.6' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Version'],
      '12.6',
      "Expected actual \"Version\" to be '12.6' (was '" +
        browser['Version'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1345-AK ["iTunes/12.6 (Macintosh; OS X 10.11.6) AppleWebKit/601.7.8"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'iTunes/12.6 (Macintosh; OS X 10.11.6) AppleWebKit/601.7.8'
    );
  ...
  test('issue-1345-AL ["iTunes/4.2 (Macintosh; U; PPC Mac OS X 10.2)"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'iTunes 4.2',
      "Expected actual \"Comment\" to be 'iTunes 4.2' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1345-AM ["iTunes/4.7 (Macintosh; N; PPC)"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser('iTunes/4.7 (Macintosh; N; PPC)');

    assert.strictEqual(
      browser['Comment'],
      'iTunes 4.7',
      "Expected actual \"Comment\" to be 'iTunes 4.7' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1345-AO ["iTunes/7.0 (Macintosh; U; PPC Mac OS X 10.4.7)"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'iTunes 7.0',
      "Expected actual \"Comment\" to be 'iTunes 7.0' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1345-AP ["iTunes/7.1.1 (Macintosh; N; PPC)"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser('iTunes/7.1.1 (Macintosh; N; PPC)');

    assert.strictEqual(
      browser['Comment'],
      'iTunes 7.1',
      "Expected actual \"Comment\" to be 'iTunes 7.1' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1345-AQ ["iTunes/7.4.1"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser('iTunes/7.4.1');

    assert.strictEqual(
      browser['Comment'],
      'iTunes 7.4',
      "Expected actual \"Comment\" to be 'iTunes 7.4' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1345-AR ["iTunes/7.5 (Windows; N)"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser('iTunes/7.5 (Windows; N)');

    assert.strictEqual(
      browser['Comment'],
      'iTunes 7.5',
      "Expected actual \"Comment\" to be 'iTunes 7.5' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1345-AS ["iTunes/8.1"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser('iTunes/8.1');

    assert.strictEqual(
      browser['Comment'],
      'iTunes 8.1',
      "Expected actual \"Comment\" to be 'iTunes 8.1' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1345-AT ["iTunes/8.2 (Macintosh; U; PPC Mac OS X 10_5_6)"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'iTunes 8.2',
      "Expected actual \"Comment\" to be 'iTunes 8.2' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1345-AU ["iTunes/9.0 (Macintosh; Intel Mac OS X 10.5.8) AppleWebKit/531.9"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'iTunes 9.0',
      "Expected actual \"Comment\" to be 'iTunes 9.0' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1345-AV ["iTunes/9.0.2 (Windows; N)"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser('iTunes/9.0.2 (Windows; N)');
  ...
  test('issue-1345-AX ["iTunes/9.1.1"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser('iTunes/9.1.1');

    assert.strictEqual(
      browser['Comment'],
      'iTunes 9.1',
      "Expected actual \"Comment\" to be 'iTunes 9.1' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1345-AY ["iTunes/9.2.1 (Windows; Microsoft Windows Vista Home Basic Edition Service Pack 2 (Build 6002)) AppleWebKit/"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'iTunes/9.2.1 (Windows; Microsoft Windows Vista Home Basic Edition Service Pack 2 (Build 6002)) AppleWebKit/'
    );

    assert.strictEqual(
      browser['Comment'],
      'iTunes 9.2',
      "Expected actual \"Comment\" to be 'iTunes 9.2' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1345-AZ ["iTunes-iPad-M/5.1.1 (16GB; dt:28)"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser('iTunes-iPad-M/5.1.1 (16GB; dt:28)');

    assert.strictEqual(
      browser['Comment'],
      'iTunes 5.1 for iOS',
      "Expected actual \"Comment\" to be 'iTunes 5.1 for iOS' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1345-BA ["iTunes-iPad-M/6.1.2 (2; 32GB; dt:75)"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser('iTunes-iPad-M/6.1.2 (2; 32GB; dt:75)');

    assert.strictEqual(
      browser['Comment'],
      'iTunes 6.1 for iOS',
      "Expected actual \"Comment\" to be 'iTunes 6.1 for iOS' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1345-BB ["iTunes-iPad/5.1.1 (2; 16GB; dt:74)"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser('iTunes-iPad/5.1.1 (2; 16GB; dt:74)');
  ...
  test('issue-1345-BC ["iTunes-iPhone/5.0.1 (6; 64GB)"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser('iTunes-iPhone/5.0.1 (6; 64GB)');

    assert.strictEqual(
      browser['Comment'],
      'iTunes 5.0 for iOS',
      "Expected actual \"Comment\" to be 'iTunes 5.0 for iOS' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1345-BD ["iTunes-iPhone/5.1 (6; 16GB; dt:73)"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser('iTunes-iPhone/5.1 (6; 16GB; dt:73)');
  ...
  test('issue-1345-BE ["iTunes-iPod/4.2.1 (2; 8GB)"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser('iTunes-iPod/4.2.1 (2; 8GB)');

    assert.strictEqual(
      browser['Comment'],
      'iTunes 4.2 for iOS',
      "Expected actual \"Comment\" to be 'iTunes 4.2 for iOS' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1345-BF ["iTunes-iPod/5.0.1 (4; 32GB)"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser('iTunes-iPod/5.0.1 (4; 32GB)');
  ...
  test('issue-1345-BG ["iTunes-iPod/6.1.6 (4; 8GB; dt:71)"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser('iTunes-iPod/6.1.6 (4; 8GB; dt:71)');
