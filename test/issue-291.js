...
suite('checking for issue 291.', function () {
  ...
  test('issue-291-B', function () {
    browser = browscap.getBrowser("DomainSCAN");

    assert.strictEqual(browser['Browser'], 'DomainScan Server Monitoring');
    assert.strictEqual(browser['Browser_Type'], 'Bot/Crawler');
    assert.strictEqual(browser['Browser_Bits'], '0');
    assert.strictEqual(browser['Browser_Maker'], 'GH Software');
    assert.strictEqual(browser['Version'], '0.0');
    assert.strictEqual(browser['MajorVer'], '0');
    assert.strictEqual(browser['MinorVer'], '0');
    assert.strictEqual(browser['Platform'], 'unknown');
  ...
  test('issue-291-D', function () {
    browser = browscap.getBrowser("revolt");

    assert.strictEqual(browser['Browser'], 'Bot Revolt');
    assert.strictEqual(browser['Browser_Type'], 'Bot/Crawler');
    assert.strictEqual(browser['Browser_Bits'], '32');
    assert.strictEqual(browser['Browser_Maker'], 'Bot Revolt');
    assert.strictEqual(browser['Version'], '0.0');
    assert.strictEqual(browser['MajorVer'], '0');
    assert.strictEqual(browser['MinorVer'], '0');
  ...
  test('issue-291-F', function () {
    browser = browscap.getBrowser("Cloud mapping experiment. Contact research@pdrlabs.net");

    assert.strictEqual(browser['Browser'], 'pdrlabs Bot');
    assert.strictEqual(browser['Browser_Type'], 'Bot/Crawler');
    assert.strictEqual(browser['Browser_Bits'], '0');
    assert.strictEqual(browser['Browser_Maker'], 'pdrlabs.net');
    assert.strictEqual(browser['Version'], '0.0');
    assert.strictEqual(browser['MajorVer'], '0');
    assert.strictEqual(browser['MinorVer'], '0');
    assert.strictEqual(browser['Platform'], 'unknown');
