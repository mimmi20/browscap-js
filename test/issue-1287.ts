...
suite('checking for issue 1287. (1 test)', function() {
  test('issue-1287-A ["Mozilla/5.0 (Windows NT 4.0) AppleWebKit/537.36 (KHTML, like Gecko) Spotify/1.0.11.134 Safari/537.36"]', function() {
    ...
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (Windows NT 4.0) AppleWebKit/537.36 (KHTML, like Gecko) Spotify/1.0.11.134 Safari/537.36'
    );

    assert.strictEqual(
      browser['Comment'],
      'Spotify',
      "Expected actual \"Comment\" to be 'Spotify' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
    ...
    assert.strictEqual(
      browser['Browser'],
      'Spotify',
      "Expected actual \"Browser\" to be 'Spotify' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'Spotify AB',
      "Expected actual \"Browser_Maker\" to be 'Spotify AB' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
