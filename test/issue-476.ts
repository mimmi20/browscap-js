...
suite('checking for issue 476. (1 test)', function() {
  test('issue-476 ["Java/1.17"]', function() {
    ...
    let browser = browscap.getBrowser('Java/1.17');

    assert.strictEqual(
      browser['Comment'],
      'Java Standard Library',
      "Expected actual \"Comment\" to be 'Java Standard Library' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
    ...
    assert.strictEqual(
      browser['Browser'],
      'Java Standard Library',
      "Expected actual \"Browser\" to be 'Java Standard Library' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'Oracle',
      "Expected actual \"Browser_Maker\" to be 'Oracle' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Version'],
      '1.17',
      "Expected actual \"Version\" to be '1.17' (was '" +
        browser['Version'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
