...
suite('checking for issue 418.', function () {
  ...
  test('issue-418-B', function () {
    browser = browscap.getBrowser("Mozilla/5.0 (compatible; Abonti/0.92 - http://www.abonti.com)");

    assert.strictEqual(browser['Browser'], 'Abonti WebSearch');
    assert.strictEqual(browser['Browser_Type'], 'Bot/Crawler');
    assert.strictEqual(browser['Browser_Bits'], '0');
    assert.strictEqual(browser['Browser_Maker'], 'abonti.com');
    assert.strictEqual(browser['Version'], '0.92');
    assert.strictEqual(browser['MajorVer'], '0');
    assert.strictEqual(browser['MinorVer'], '92');
    assert.strictEqual(browser['Platform'], 'unknown');
    assert.strictEqual(browser['Platform_Version'], 'unknown');
    assert.strictEqual(browser['Platform_Bits'], '0');
    assert.strictEqual(browser['Platform_Maker'], 'unknown');
  ...
  test('issue-418-C', function () {
    browser = browscap.getBrowser("GG PeekBot 2.0 ( http://gg.pl/ http://info.gadu-gadu.pl/praca )");

    assert.strictEqual(browser['Browser'], 'GG PeekBot');
    assert.strictEqual(browser['Browser_Type'], 'Bot/Crawler');
    assert.strictEqual(browser['Browser_Bits'], '0');
    assert.strictEqual(browser['Browser_Maker'], 'gadu-gadu.pl');
