...
suite('checking for issue 590. (3 tests)', function() {
  test('issue-590-A ["Mozilla/5.0 (compatible; HyperCrawl/0.2; +http://www.seograph.net/bot.html)"]', function() {
    ...
    assert.strictEqual(
      browser['Browser'],
      'HyperCrawl',
      "Expected actual \"Browser\" to be 'HyperCrawl' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'SEOGraph',
      "Expected actual \"Browser_Maker\" to be 'SEOGraph' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-590-B ["iZSearch.com"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser('iZSearch.com');
    ...
    assert.strictEqual(
      browser['Browser'],
      'iZSearch Bot',
      "Expected actual \"Browser\" to be 'iZSearch Bot' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser_Maker'],
      'iZSearch',
      "Expected actual \"Browser_Maker\" to be 'iZSearch' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
