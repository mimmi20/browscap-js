...
suite('checking for issue 1771. (1 test)', function () {
  test('issue-1771-A ["Mozilla/5.0 (compatible; Taboolabot/3.7; +http://www.taboola.com)"]', function () {
    ...
    assert.strictEqual(browser['Browser_Maker'], 'taboola.com', 'Expected actual "Browser_Maker" to be \'taboola.com\' (was \'' + browser['Browser_Maker'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
