...
suite('checking for issue 511. (51 tests)', function() {
  ...
  test('issue-511-J ["Mozilla/5.0 (Linux; Android 4.4.4; XT1033 Build/KXB21.14-L1.40) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/39.0.2171.59 Mobile Safari/537.36"]', function() {
    ...
    assert.strictEqual(
      browser['Device_Code_Name'],
      'XT1033',
      "Expected actual \"Device_Code_Name\" to be 'XT1033' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-511-AQ ["Mozilla/5.0 (iPhone; CPU iPhone OS 8_1 like Mac OS X) AppleWebKit/534.46 (KHTML, like Gecko) Version/8.1 Mobile/9B179 Safari/7534.48.3 OktaMobile/4.0.9"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Okta Mobile 4.0',
      "Expected actual \"Comment\" to be 'Okta Mobile 4.0' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser'],
      'Okta Mobile App',
      "Expected actual \"Browser\" to be 'Okta Mobile App' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser_Maker'],
      'Okta, Inc.',
      "Expected actual \"Browser_Maker\" to be 'Okta, Inc.' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-511-AS ["Mozilla/5.0 (Linux; Android 4.4.4; SGP512 Build/23.0.1.A.0.167) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/38.0.2125.114 Safari/537.36"]', function() {
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Device_Name\" to be 'Xperia Tablet Z WiFi' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Code_Name'],
      'SGP512',
      "Expected actual \"Device_Code_Name\" to be 'SGP512' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-511-BD ["Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/534.34 (KHTML, like Gecko) kmail2/4.14.2 Safari/534.34"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'KMail2 4.14',
      "Expected actual \"Comment\" to be 'KMail2 4.14' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser'],
      'KMail2',
      "Expected actual \"Browser\" to be 'KMail2' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-511-BE ["Mozilla/5.0 (Android; Mobile; rv:33.1) Gecko/33.1 Firefox/33.1"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Firefox 33.1',
      "Expected actual \"Comment\" to be 'Firefox 33.1' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Version'],
      '33.1',
      "Expected actual \"Version\" to be '33.1' (was '" +
        browser['Version'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['RenderingEngine_Version'],
      '33.1',
      "Expected actual \"RenderingEngine_Version\" to be '33.1' (was '" +
        browser['RenderingEngine_Version'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-511-BF ["Mozilla/5.0 (Linux; Android 4.4.2; D2306 Build/18.3.C.0.37) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/38.0.2125.114 Mobile Safari/537.36"]', function() {
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'Xperia M2',
      "Expected actual \"Device_Name\" to be 'Xperia M2' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Code_Name'],
      'D2306',
      "Expected actual \"Device_Code_Name\" to be 'D2306' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
