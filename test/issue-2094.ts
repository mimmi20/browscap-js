...
suite('checking for issue 2094. (1 test)', function() {
  test('issue-2094-A ["Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:33.0) Gecko/20100101 Firefox/33.0 NETVIGIE"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:33.0) Gecko/20100101 Firefox/33.0 NETVIGIE'
    );

    assert.strictEqual(
      browser['Comment'],
      'netvigie Bot',
      "Expected actual \"Comment\" to be 'netvigie Bot' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
    ...
    assert.strictEqual(
      browser['Browser'],
      'netvigie Bot',
      "Expected actual \"Browser\" to be 'netvigie Bot' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'netvigie.com',
      "Expected actual \"Browser_Maker\" to be 'netvigie.com' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
