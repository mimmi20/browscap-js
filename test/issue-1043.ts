...
suite('checking for issue 1043. (4 tests)', function() {
  test('issue-1043-A ["Mozilla/5.0 (Linux; U; Android 4.2.2; he-il; NEO-X5-116A Build/JDQ39) AppleWebKit/534.30 (KHTML, like Gecko) Version/4.0 Safari/534.30"]', function() {
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'NEO X5',
      "Expected actual \"Device_Name\" to be 'NEO X5' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'Minix',
      "Expected actual \"Device_Maker\" to be 'Minix' (was '" +
        browser['Device_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'NEO X5',
      "Expected actual \"Device_Code_Name\" to be 'NEO X5' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'Minix',
      "Expected actual \"Device_Brand_Name\" to be 'Minix' (was '" +
        browser['Device_Brand_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1043-B ["Dalvik/2.1.0 (Linux; U; Android 6.0.1; Nexus Player Build/MMB29T)"]', function() {
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'Nexus Player',
      "Expected actual \"Device_Name\" to be 'Nexus Player' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Code_Name'],
      'Nexus Player',
      "Expected actual \"Device_Code_Name\" to be 'Nexus Player' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1043-C ["Mozilla/5.0 (Nintendo WiiU) AppleWebKit/536.30 (KHTML, like Gecko) NX/3.0.4.2.12 NintendoBrowser/4.3.1.11264.US"]', function() {
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Comment\" to be 'Nintendo Browser 4.3' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1043-D ["Mozilla/5.0 (Windows Phone 10.0; Android 4.2.1; Xbox; Xbox One) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/46.0.2486.0 Mobile Safari/537.36 Edge/13.10586"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Edge Mobile 13.0',
      "Expected actual \"Comment\" to be 'Edge Mobile 13.0' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Platform\" to be 'Xbox OS 10 (Mobile View)' (was '" +
        browser['Platform'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Platform_Description\" to be 'Windows 10 on Xbox One' (was '" +
        browser['Platform_Description'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'Xbox One',
      "Expected actual \"Device_Name\" to be 'Xbox One' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Code_Name'],
      'Xbox One',
      "Expected actual \"Device_Code_Name\" to be 'Xbox One' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
