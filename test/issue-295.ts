...
suite('checking for issue 295. (11 tests)', function() {
  test('issue-295-A ["Mozilla/5.0 (X11; Linux x86_64) KHTML/4.11.5 (like Gecko) Konqueror/4.11"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Konqueror 4.11',
      "Expected actual \"Comment\" to be 'Konqueror 4.11' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
    ...
    assert.strictEqual(
      ...
      '4.11',
      "Expected actual \"RenderingEngine_Version\" to be '4.11' (was '" +
        browser['RenderingEngine_Version'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-295-B ["Mozilla/5.0 (X11; U; Linux x86_64; en-US; rv:1.9.1.16) Gecko Kazehakase/0.5.8 Debian/0.5.8-4"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Kazehakase 0.5',
      "Expected actual \"Comment\" to be 'Kazehakase 0.5' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser'],
      'Kazehakase',
      "Expected actual \"Browser\" to be 'Kazehakase' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-295-D ["Mozilla/5.0 (X11; Linux x86_64) KHTML/4.8.4 (like Gecko) Konqueror/4.8"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Konqueror 4.8',
      "Expected actual \"Comment\" to be 'Konqueror 4.8' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['RenderingEngine_Version'],
      '4.8',
      "Expected actual \"RenderingEngine_Version\" to be '4.8' (was '" +
        browser['RenderingEngine_Version'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-295-E ["Links (2.8; Linux 3.10.17 x86_64; GNU C 4.8.1; text)"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Links 2.8',
      "Expected actual \"Comment\" to be 'Links 2.8' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser'],
      'Links',
      "Expected actual \"Browser\" to be 'Links' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser_Maker'],
      'Mikulas Patocka',
      "Expected actual \"Browser_Maker\" to be 'Mikulas Patocka' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-295-F ["Mozilla/5.0 (Linux; U; Android 4.4.2; en-gb; HTC_One Build/KOT49H) AppleWebKit/534.30 (KHTML, like Gecko) Version/4.0 Mobile Safari/534.30"]', function() {
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'One M7',
      "Expected actual \"Device_Name\" to be 'One M7' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Code_Name'],
      'M7',
      "Expected actual \"Device_Code_Name\" to be 'M7' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-295-G ["Opera/7.54 (Windows NT 5.1; U) [pl]"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser('Opera/7.54 (Windows NT 5.1; U) [pl]');

    assert.strictEqual(
      browser['Comment'],
      'Opera 7.54',
      "Expected actual \"Comment\" to be 'Opera 7.54' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-295-I ["Mozilla/5.0 (Windows NT 6.1; U;WOW64; de;rv:11.0) Gecko Firefox/11.0"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Firefox 11.0',
      "Expected actual \"Comment\" to be 'Firefox 11.0' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['RenderingEngine_Version'],
      '11.0',
      "Expected actual \"RenderingEngine_Version\" to be '11.0' (was '" +
        browser['RenderingEngine_Version'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-295-K ["Mozilla/4.0 (compatible; Opera/3.0; Windows 4.10) 3.51 [en]"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Opera 3.51',
      "Expected actual \"Comment\" to be 'Opera 3.51' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
