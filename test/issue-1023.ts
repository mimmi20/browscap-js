...
suite('checking for issue 1023. (1 test)', function() {
  test('issue-1023 ["Netcraft SSL Server Survey - contact info@netcraft.com"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Netcraft',
      "Expected actual \"Comment\" to be 'Netcraft' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Browser\" to be 'Netcraft SSL Server Survey' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'Netcraft Ltd.',
      "Expected actual \"Browser_Maker\" to be 'Netcraft Ltd.' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
