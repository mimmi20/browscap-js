...
suite('checking for issue 2124. (2 tests)', function() {
  test('issue-2124-A ["Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/13.0 Safari/605.1.15"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Safari 13.0',
      "Expected actual \"Comment\" to be 'Safari 13.0' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
    ...
    assert.strictEqual(
      ...
      '10.15',
      "Expected actual \"Platform_Version\" to be '10.15' (was '" +
        browser['Platform_Version'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-2124-B ["Mozilla/5.0 (iPad; CPU OS 13_0 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/13.0 Mobile/15E148 Safari/604.1"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
    ...
    assert.strictEqual(
      browser['Comment'],
      'Mobile Safari 13.0',
      "Expected actual \"Comment\" to be 'Mobile Safari 13.0' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Platform'],
      'ipadOS',
      "Expected actual \"Platform\" to be 'ipadOS' (was '" +
        browser['Platform'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Platform_Version'],
      '13.0',
      "Expected actual \"Platform_Version\" to be '13.0' (was '" +
        browser['Platform_Version'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
