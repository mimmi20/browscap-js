...
suite('checking for issue 1871. (1 test)', function () {
  test('issue-1871-A ["Mozilla/5.0 (Macintosh; Intel Mac OS X) AppleWebKit/538.1 (KHTML, like Gecko) ShopSpring SpringBot Safari/538.1"]', function () {
    const browscap = new Browscap();
    const browser = browscap.getBrowser('Mozilla/5.0 (Macintosh; Intel Mac OS X) AppleWebKit/538.1 (KHTML, like Gecko) ShopSpring SpringBot Safari/538.1');
    ...
    assert.strictEqual(browser['Browser'], 'SpringBot', 'Expected actual "Browser" to be \'SpringBot\' (was \'' + browser['Browser'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
    ...
    assert.strictEqual(browser['Browser_Maker'], 'Springbot, Inc.', 'Expected actual "Browser_Maker" to be \'Springbot, Inc.\' (was \'' + browser['Browser_Maker'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
