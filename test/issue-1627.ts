...
suite('checking for issue 1627. (3 tests)', function() {
  test('issue-1627-A ["Mozilla/5.0 (Windows; U; Windows NT 6.1; en-US; rv:1.9.1.9) Gecko/20100722 Eudora/3.0.4"]', function() {
    ...
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (Windows; U; Windows NT 6.1; en-US; rv:1.9.1.9) Gecko/20100722 Eudora/3.0.4'
    );

    assert.strictEqual(
      browser['Comment'],
      'Eudora Open Source Edition',
      "Expected actual \"Comment\" to be 'Eudora Open Source Edition' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
    ...
    assert.strictEqual(
      browser['Browser'],
      'Eudora OSE',
      "Expected actual \"Browser\" to be 'Eudora OSE' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1627-C ["Eudora/6.2.4b8 (MacOS)"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser('Eudora/6.2.4b8 (MacOS)');

    assert.strictEqual(
      browser['Comment'],
      'Eudora',
      "Expected actual \"Comment\" to be 'Eudora' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser'],
      'Eudora',
      "Expected actual \"Browser\" to be 'Eudora' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser_Maker'],
      'Qualcomm',
      "Expected actual \"Browser_Maker\" to be 'Qualcomm' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
