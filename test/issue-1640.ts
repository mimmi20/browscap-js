...
suite('checking for issue 1640. (2 tests)', function() {
  test('issue-1640-A ["Mozilla/5.0 SeznamEmailProxy/1.0"]', function() {
    ...
    let browser = browscap.getBrowser('Mozilla/5.0 SeznamEmailProxy/1.0');

    assert.strictEqual(
      browser['Comment'],
      'Seznam Email Proxy',
      "Expected actual \"Comment\" to be 'Seznam Email Proxy' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
    ...
    assert.strictEqual(
      browser['Browser'],
      'Seznam Email Proxy',
      "Expected actual \"Browser\" to be 'Seznam Email Proxy' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1640-B ["Mozilla/5.0 SeznamEmailProxy/2.0.178"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser('Mozilla/5.0 SeznamEmailProxy/2.0.178');
