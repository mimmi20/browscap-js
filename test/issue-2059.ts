...
suite('checking for issue 2059. (3 tests)', function() {
  test('issue-2059-A ["Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/71.0.3578.98 Safari/537.36 OPR/58.0.3135.53"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Opera 58.0',
      "Expected actual \"Comment\" to be 'Opera 58.0' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
  ...
  test('issue-2059-C ["Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/71.0.3578.98 Safari/537.36 OPR/58.0.3135.65 (Edition B2)"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/71.0.3578.98 Safari/537.36 OPR/58.0.3135.65 (Edition B2)'
    );
