...
suite('checking for issue 1103. (1 test)', function () {
  test('issue-1103 ["Mozilla/5.0 (Linux; Android 5.1.1; SAMSUNG SM-T280 Build/LMY47V) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/3.5 Chrome/38.0.2125.102 Safari/537.36"]', function () {
    const browscap = new Browscap();
    const browser = browscap.getBrowser('Mozilla/5.0 (Linux; Android 5.1.1; SAMSUNG SM-T280 Build/LMY47V) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/3.5 Chrome/38.0.2125.102 Safari/537.36');

    assert.strictEqual(browser['Comment'], 'Samsung Browser 3.5', 'Expected actual "Comment" to be \'Samsung Browser 3.5\' (was \'' + browser['Comment'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
    ...
    assert.strictEqual(browser['Device_Name'], 'Galaxy Tab A (7.0, Wi-Fi, 2016)', 'Expected actual "Device_Name" to be \'Galaxy Tab A (7.0, Wi-Fi, 2016)\' (was \'' + browser['Device_Name'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
    ...
    assert.strictEqual(browser['Device_Code_Name'], 'SM-T280', 'Expected actual "Device_Code_Name" to be \'SM-T280\' (was \'' + browser['Device_Code_Name'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
