...
suite('checking for issue 1623. (6 tests)', function () {
  test('issue-1623-A ["Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/58.0.3029.12554 Safari/537.36 Sparrow/0.1"]', function () {
    ...
    const browser = browscap.getBrowser('Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/58.0.3029.12554 Safari/537.36 Sparrow/0.1');
    ...
    assert.strictEqual(browser['Browser_Maker'], 'ViaSat Inc.', 'Expected actual "Browser_Maker" to be \'ViaSat Inc.\' (was \'' + browser['Browser_Maker'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
  ...
  test('issue-1623-B ["Mozilla/5.0 (Windows NT 6.1; WOW64)  AppleWebKit/537.36 (KHTML, like Gecko) Chrome/49.0.2623.7011  Safari/537.36 Sparrow/0.1"]', function () {
    const browscap = new Browscap();
    const browser = browscap.getBrowser('Mozilla/5.0 (Windows NT 6.1; WOW64)  AppleWebKit/537.36 (KHTML, like Gecko) Chrome/49.0.2623.7011  Safari/537.36 Sparrow/0.1');
  ...
  test('issue-1623-C ["Mozilla/5.0 (Windows NT 6.1; WOW64)  AppleWebKit/537.36 (KHTML, like Gecko) Chrome/42.0.2311.2950  Safari/537.36 Sparrow/0.1"]', function () {
    const browscap = new Browscap();
    const browser = browscap.getBrowser('Mozilla/5.0 (Windows NT 6.1; WOW64)  AppleWebKit/537.36 (KHTML, like Gecko) Chrome/42.0.2311.2950  Safari/537.36 Sparrow/0.1');
  ...
  test('issue-1623-D ["Mozilla/5.0 (X11; Linux x86_64)  AppleWebKit/537.36 (KHTML, like Gecko) Chrome/42.0.2311.2469  Safari/537.36 Sparrow/0.1"]', function () {
    const browscap = new Browscap();
    const browser = browscap.getBrowser('Mozilla/5.0 (X11; Linux x86_64)  AppleWebKit/537.36 (KHTML, like Gecko) Chrome/42.0.2311.2469  Safari/537.36 Sparrow/0.1');
  ...
  test('issue-1623-E ["Mozilla/5.0 (X11; Linux x86_64)  AppleWebKit/537.36 (KHTML, like Gecko) Chrome/42.0.2311.2950  Safari/537.36 Sparrow/0.1"]', function () {
    const browscap = new Browscap();
    const browser = browscap.getBrowser('Mozilla/5.0 (X11; Linux x86_64)  AppleWebKit/537.36 (KHTML, like Gecko) Chrome/42.0.2311.2950  Safari/537.36 Sparrow/0.1');
  ...
  test('issue-1623-F ["Mozilla/5.0 (X11; Linux x86_64)  AppleWebKit/537.36 (KHTML, like Gecko) Chrome/39.0.2171.308  Sparrow/0.0.308.0 Safari/537.36"]', function () {
    const browscap = new Browscap();
    const browser = browscap.getBrowser('Mozilla/5.0 (X11; Linux x86_64)  AppleWebKit/537.36 (KHTML, like Gecko) Chrome/39.0.2171.308  Sparrow/0.0.308.0 Safari/537.36');
