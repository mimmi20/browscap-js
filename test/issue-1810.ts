...
suite('checking for issue 1810. (6 tests)', function() {
  test('issue-1810-A ["Jersey/2.6 (HttpUrlConnection 1.8.0_152)"]', function() {
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Browser\" to be 'Jersey HttpUrlConnection' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1810-B ["Zabbix"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser('Zabbix');
    ...
    assert.strictEqual(
      browser['Browser'],
      'Zabbix',
      "Expected actual \"Browser\" to be 'Zabbix' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser_Maker'],
      'Zabbix SIA',
      "Expected actual \"Browser_Maker\" to be 'Zabbix SIA' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1810-C ["SentiBot www.sentibot.eu (compatible with Googlebot)"]', function() {
    ...
    assert.strictEqual(
      browser['Browser'],
      'SentiBot',
      "Expected actual \"Browser\" to be 'SentiBot' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser_Maker'],
      'SentiOne LLC',
      "Expected actual \"Browser_Maker\" to be 'SentiOne LLC' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1810-D ["Toweya.com bot; report abuse to abuse@toweya.net"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'Toweya.com bot; report abuse to abuse@toweya.net'
    );
    ...
    assert.strictEqual(
      browser['Browser'],
      'Toweya.com Bot',
      "Expected actual \"Browser\" to be 'Toweya.com Bot' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser_Maker'],
      'Toweya Corporation BV',
      "Expected actual \"Browser_Maker\" to be 'Toweya Corporation BV' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1810-E ["Mozilla/3.01 (compatible; Netbox/3.5 R92; Linux 2.2)"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Netbox',
      "Expected actual \"Comment\" to be 'Netbox' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser'],
      'Netbox',
      "Expected actual \"Browser\" to be 'Netbox' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'Netbox',
      "Expected actual \"Device_Name\" to be 'Netbox' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Code_Name'],
      'Netbox',
      "Expected actual \"Device_Code_Name\" to be 'Netbox' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1810-F ["elefent/1.2 (web crawler; crawler.elefent.net; webmaster at elefent dot net)"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'elefent/1.2 (web crawler; crawler.elefent.net; webmaster at elefent dot net)'
    );

    assert.strictEqual(
      browser['Comment'],
      'Elefent 1.2',
      "Expected actual \"Comment\" to be 'Elefent 1.2' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser'],
      'Elefent',
      "Expected actual \"Browser\" to be 'Elefent' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser_Maker'],
      'elefent.eu',
      "Expected actual \"Browser_Maker\" to be 'elefent.eu' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
