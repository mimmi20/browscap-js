...
suite('checking for issue 1271.', function () {
  test('issue-1271-A ["Mozilla/5.0 (Nintendo Switch; ShareApplet) AppleWebKit/601.6 (KHTML, like Gecko) NF/4.0.0.5.9 NintendoBrowser/5.1.0.13341"]', function () {
    ...
    assert.strictEqual(browser['Comment'], 'NetFront NX Generic', 'Expected actual "Comment" to be \'NetFront NX Generic\' (was \'' + browser['Comment'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
