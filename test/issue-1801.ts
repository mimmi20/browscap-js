...
suite('checking for issue 1801. (1 test)', function() {
  test('issue-1801-A ["WhatsApp/2.18.20 i"]', function() {
    ...
    let browser = browscap.getBrowser('WhatsApp/2.18.20 i');

    assert.strictEqual(
      browser['Comment'],
      'WhatsApp Bot 2.18',
      "Expected actual \"Comment\" to be 'WhatsApp Bot 2.18' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
    ...
    assert.strictEqual(
      browser['Browser'],
      'WhatsApp Bot',
      "Expected actual \"Browser\" to be 'WhatsApp Bot' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Version'],
      '2.18',
      "Expected actual \"Version\" to be '2.18' (was '" +
        browser['Version'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
