...
suite('checking for issue 716. (7 tests)', function() {
  test('issue-716-A ["Mozilla/5.0 (Windows NT 10.0) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/40.0.2214.111 Safari/537.36"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (Windows NT 10.0) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/40.0.2214.111 Safari/537.36'
    );
  ...
  test('issue-716-B ["Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/40.0.2214.115 Safari/537.36"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
  ...
  test('issue-716-C ["Mozilla/5.0 (Windows NT 10.0; WOW64; Trident/7.0; .NET4.0C; .NET4.0E; .NET CLR 2.0.50727; .NET CLR 3.0.30729; .NET CLR 3.5.30729; rv:11.0) like Gecko"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
  ...
  test('issue-716-D ["Mozilla/5.0 (Windows NT 10.0; WOW64; rv:39.0) Gecko/20100101 Firefox/39.0"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
    ...
    assert.strictEqual(
      browser['Comment'],
      'Firefox 39.0',
      "Expected actual \"Comment\" to be 'Firefox 39.0' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['RenderingEngine_Version'],
      '39.0',
      "Expected actual \"RenderingEngine_Version\" to be '39.0' (was '" +
        browser['RenderingEngine_Version'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-716-E ["Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/40.0.2214.115 Safari/537.36"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
  ...
  test('issue-716-F ["Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:39.0) Gecko/20100101 Firefox/39.0"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
  ...
  test('issue-716-G ["Mozilla/5.0 (Windows NT 10.0; rv:38.0) Gecko/20100101 Firefox/38.0"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
    ...
    assert.strictEqual(
      browser['Comment'],
      'Firefox 38.0',
      "Expected actual \"Comment\" to be 'Firefox 38.0' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
