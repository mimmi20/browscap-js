...
suite('checking for issue 227.', function () {
  test('issue-227 ["RankFlex.com Webspider"]', function () {
    ...
    assert.strictEqual(browser['Browser_Maker'], 'rankflex.com', 'Expected actual "Browser_Maker" to be \'rankflex.com\' (was \'' + browser['Browser_Maker'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
