...
suite('checking for issue 004. (1 test)', function () {
  test('issue-004 ["Mozilla/5.0 (PLAYSTATION 3; 2.00)"]', function () {
    const browscap = new Browscap();
    const browser = browscap.getBrowser('Mozilla/5.0 (PLAYSTATION 3; 2.00)');
