...
suite('checking for issue 1364. (8 tests)', function() {
  ...
  test('issue-1364-C ["UCWEB/2.0 (Windows; U; wds 10.0; en-IN; Microsoft; RM-1141_1000) U2/1.0.0 UCBrowser/4.2.1.541 U2/1.0.0 Mobile"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'UCWEB/2.0 (Windows; U; wds 10.0; en-IN; Microsoft; RM-1141_1000) U2/1.0.0 UCBrowser/4.2.1.541 U2/1.0.0 Mobile'
    );
  ...
  test('issue-1364-D ["UCWEB/2.0 (Linux; U; Opera Mini/7.1.32052/30.3697; pt-BR; SM-G530BT Build/LRX22G) U2/1.0.0 UCMini/10.9.0.946 (SpeedMode; Android 5.0.2; SM-G530BT Build/LRX22G) Mobile"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'UCWEB/2.0 (Linux; U; Opera Mini/7.1.32052/30.3697; pt-BR; SM-G530BT Build/LRX22G) U2/1.0.0 UCMini/10.9.0.946 (SpeedMode; Android 5.0.2; SM-G530BT Build/LRX22G) Mobile'
    );

    assert.strictEqual(
      browser['Comment'],
      'UC Browser Mini 10.9',
      "Expected actual \"Comment\" to be 'UC Browser Mini 10.9' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser_Modus'],
      'SpeedMode',
      "Expected actual \"Browser_Modus\" to be 'SpeedMode' (was '" +
        browser['Browser_Modus'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Device_Name\" to be 'Galaxy Gran Prime Duos TV' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Code_Name'],
      'SM-G530BT',
      "Expected actual \"Device_Code_Name\" to be 'SM-G530BT' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1364-E ["UCWEB/2.0 (Linux; U; Opera Mini/7.1.32052/30.3697; ru; GT-N7100 Build/JZO54K) U2/1.0.0 UCMini/10.9.0.946 (SpeedMode; Android 4.1.2; GT-N7100 Build/JZO54K) Mobile"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'UCWEB/2.0 (Linux; U; Opera Mini/7.1.32052/30.3697; ru; GT-N7100 Build/JZO54K) U2/1.0.0 UCMini/10.9.0.946 (SpeedMode; Android 4.1.2; GT-N7100 Build/JZO54K) Mobile'
    );
  ...
  test('issue-1364-F ["UCWEB/2.0 (Linux; U; Opera Mini/7.1.32052/30.3697; ru; SM-J120H Build/LMY47V) U2/1.0.0 UCMini/10.9.0.946 (SpeedMode; Android 5.1.1; SM-J120H Build/LMY47V) Mobile"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'UCWEB/2.0 (Linux; U; Opera Mini/7.1.32052/30.3697; ru; SM-J120H Build/LMY47V) U2/1.0.0 UCMini/10.9.0.946 (SpeedMode; Android 5.1.1; SM-J120H Build/LMY47V) Mobile'
    );
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'Galaxy J1 (2016) Duos',
      "Expected actual \"Device_Name\" to be 'Galaxy J1 (2016) Duos' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Code_Name'],
      'SM-J120H',
      "Expected actual \"Device_Code_Name\" to be 'SM-J120H' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1364-G ["UCWEB/2.0 (Linux; U; Opera Mini/7.1.32052/30.3697; en-US; ONE LTE HD Build/KTU84P) U2/1.0.0 UCMini/10.9.0.946 (SpeedMode; Android 4.4.4; ONE LTE HD Build/KTU84P) Mobile"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'UCWEB/2.0 (Linux; U; Opera Mini/7.1.32052/30.3697; en-US; ONE LTE HD Build/KTU84P) U2/1.0.0 UCMini/10.9.0.946 (SpeedMode; Android 4.4.4; ONE LTE HD Build/KTU84P) Mobile'
    );
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'ONE LTE HD',
      "Expected actual \"Device_Name\" to be 'ONE LTE HD' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Maker'],
      'Innjoo',
      "Expected actual \"Device_Maker\" to be 'Innjoo' (was '" +
        browser['Device_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Code_Name'],
      'ONE LTE HD',
      "Expected actual \"Device_Code_Name\" to be 'ONE LTE HD' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Brand_Name'],
      'Innjoo',
      "Expected actual \"Device_Brand_Name\" to be 'Innjoo' (was '" +
        browser['Device_Brand_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1364-H ["UCWEB/2.0 (Linux; U; Opera Mini/7.1.32052/30.3697; en-US; QMobile Z10 Build/LMY47D) U2/1.0.0 UCMini/10.9.0.946 (SpeedMode; Android 5.1; QMobile Z10 Build/LMY47D) Mobile"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'UCWEB/2.0 (Linux; U; Opera Mini/7.1.32052/30.3697; en-US; QMobile Z10 Build/LMY47D) U2/1.0.0 UCMini/10.9.0.946 (SpeedMode; Android 5.1; QMobile Z10 Build/LMY47D) Mobile'
    );
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'Noir',
      "Expected actual \"Device_Name\" to be 'Noir' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Maker'],
      'QMobile',
      "Expected actual \"Device_Maker\" to be 'QMobile' (was '" +
        browser['Device_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Brand_Name'],
      'QMobile',
      "Expected actual \"Device_Brand_Name\" to be 'QMobile' (was '" +
        browser['Device_Brand_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
