...
suite('checking for issue 1014.', function () {
  test('issue-1014-A ["Slackbot-LinkExpanding 1.0 (+https://api.slack.com/robots)"]', function () {
    ...
    assert.strictEqual(browser['Browser_Maker'], 'slack.com', 'Expected actual "Browser_Maker" to be \'slack.com\' (was \'' + browser['Browser_Maker'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
