...
suite('checking for issue 000-mobiles. (7 tests)', function() {
  test('issue-mobiles-G ["S8500 UCWEB6.0/UC Browser7.7.0.81"]', function() {
    ...
    let browser = browscap.getBrowser('S8500 UCWEB6.0/UC Browser7.7.0.81');

    assert.strictEqual(
      browser['Comment'],
      'UC Browser 7.7 for Bada',
      "Expected actual \"Comment\" to be 'UC Browser 7.7 for Bada' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'Wave',
      "Expected actual \"Device_Name\" to be 'Wave' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'S8500',
      "Expected actual \"Device_Code_Name\" to be 'S8500' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-mobiles-F ["Mozilla/5.0 (Linux; U; Android 2.3.4; en-us; GT-I9100G Build/GINGERBREAD) AppleWebKit/533.1 (KHTML, like Gecko) FlyFlow/2.5 Version/4.0 Mobile Safari/533.1 baidubrowser/042_6.3.5.2_diordna_008_084/gnusmas_01_4.3.2_G0019I-TG/7400001l/AFCD145CE647EC590CFE42154CB19B89%7C274573340474753/1"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'FlyFlow 2.5',
      "Expected actual \"Comment\" to be 'FlyFlow 2.5' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-mobiles-C ["Mozilla/5.0 (Linux; U; Android 4.0.4; de-de; GT-I9100 Build/IMM76D) AppleWebKit/534.30 (KHTML, like Gecko) Dolphin/INT-1.0 Mobile Safari/534.30"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Dolfin Android 1.0',
      "Expected actual \"Comment\" to be 'Dolfin Android 1.0' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
