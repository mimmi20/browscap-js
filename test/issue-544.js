...
suite('checking for issue 544.', function () {
  test('issue-544 ["Mozilla/5.0 (Linux;U;Android 4.4.2;zh-cn;Lenovo A3300-HV Build/KOT49H) AppleWebkit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/537.306;"]', function () {
    ...
    assert.strictEqual(browser['Device_Name'], 'TAB A7-30', 'Expected actual "Device_Name" to be \'TAB A7-30\' (was \'' + browser['Device_Name'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
