...
suite('checking for issue 1589. (5 tests)', function() {
  test('issue-1589-A ["Mozilla/5.0 (Nintendo WiiU) AppleWebKit/534.52 (KHTML, like Gecko) NX/2.1.0.10.9 NintendoBrowser/1.5.0.8047.EU"]', function() {
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Comment\" to be 'Nintendo Browser 1.5' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
  ...
  test('issue-1589-B ["Mozilla/5.0 (Nintendo WiiU) AppleWebKit/534.52 (KHTML, like Gecko) NX/2.1.0.8.8 Version/1.0.0.6760.JP"]', function() {
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Comment\" to be 'Nintendo Browser Generic' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1589-C ["Opera/9.10 (Nintendo Wii ; U; ; 1621; ja)"]', function() {
    ...
    assert.strictEqual(
      browser['Platform'],
      'Nintendo Wii',
      "Expected actual \"Platform\" to be 'Nintendo Wii' (was '" +
        browser['Platform'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Platform_Description\" to be 'Nintendo Wii System Software' (was '" +
        browser['Platform_Description'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'Wii',
      "Expected actual \"Device_Name\" to be 'Wii' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Code_Name'],
      'Wii',
      "Expected actual \"Device_Code_Name\" to be 'Wii' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1589-E ["Opera/9.50 (Nintendo DSi Opera/507 U de)"]', function() {
    ...
    assert.strictEqual(
      browser['Platform'],
      'Nintendo DSi',
      "Expected actual \"Platform\" to be 'Nintendo DSi' (was '" +
        browser['Platform'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Platform_Description\" to be 'Nintendo DSi System Software' (was '" +
        browser['Platform_Description'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'DSi',
      "Expected actual \"Device_Name\" to be 'DSi' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Code_Name'],
      'DSi',
      "Expected actual \"Device_Code_Name\" to be 'DSi' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
