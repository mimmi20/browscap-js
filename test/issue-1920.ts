...
suite('checking for issue 1920. (7 tests)', function() {
  test('issue-1920-A ["Shopkeep-Pocket/4.4.0.389 (Android/7.0 LGE LG-H820)"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'Shopkeep-Pocket/4.4.0.389 (Android/7.0 LGE LG-H820)'
    );

    assert.strictEqual(
      browser['Comment'],
      'ShopKeep App 4.4',
      "Expected actual \"Comment\" to be 'ShopKeep App 4.4' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
    ...
    assert.strictEqual(
      browser['Browser'],
      'ShopKeep App',
      "Expected actual \"Browser\" to be 'ShopKeep App' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'ShopKeep Inc.',
      "Expected actual \"Browser_Maker\" to be 'ShopKeep Inc.' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1920-B ["Shopkeep-Pocket/4.4.0.389 (Android/7.0 samsung SM-N920P)"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'Shopkeep-Pocket/4.4.0.389 (Android/7.0 samsung SM-N920P)'
    );
  ...
  test('issue-1920-C ["Shopkeep-Pocket/4.4.0.389 (iOS/10.3.3 Apple iPhone 6s)"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'Shopkeep-Pocket/4.4.0.389 (iOS/10.3.3 Apple iPhone 6s)'
    );
  ...
  test('issue-1920-D ["Shopkeep-Pocket/4.4.0.389 (iOS/11.1.2 Apple iPhone X)"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'Shopkeep-Pocket/4.4.0.389 (iOS/11.1.2 Apple iPhone X)'
    );
  ...
  test('issue-1920-E ["Shopkeep-Pocket/4.4.0.389 (Android/7.1.1 motorola XT1650)"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'Shopkeep-Pocket/4.4.0.389 (Android/7.1.1 motorola XT1650)'
    );
  ...
  test('issue-1920-F ["Shopkeep-Pocket/4.4.0.389 (Android/8.1.0 Google Pixel)"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'Shopkeep-Pocket/4.4.0.389 (Android/8.1.0 Google Pixel)'
    );
  ...
  test('issue-1920-G ["Shopkeep-Pocket/4.4.0.389 (Android/6.0.1 motorola Moto G Play)"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'Shopkeep-Pocket/4.4.0.389 (Android/6.0.1 motorola Moto G Play)'
    );
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'Moto G Play',
      "Expected actual \"Device_Name\" to be 'Moto G Play' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Code_Name'],
      'Moto G Play',
      "Expected actual \"Device_Code_Name\" to be 'Moto G Play' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
