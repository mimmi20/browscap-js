...
suite('checking for issue 1933. (5 tests)', function () {
  test('issue-1933-A ["Mozilla/5.0 (Linux; Android 6.0; LGUS991 Build/MRA58K) AppleWebKit/537.36 (KHTML, like Gecko) Kiwi Chrome/69.0.3440.40 Mobile Safari/537.36"]', function () {
    ...
    const browser = browscap.getBrowser('Mozilla/5.0 (Linux; Android 6.0; LGUS991 Build/MRA58K) AppleWebKit/537.36 (KHTML, like Gecko) Kiwi Chrome/69.0.3440.40 Mobile Safari/537.36');

    assert.strictEqual(browser['Comment'], 'Kiwi Browser', 'Expected actual "Comment" to be \'Kiwi Browser\' (was \'' + browser['Comment'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
    assert.strictEqual(browser['Browser'], 'Kiwi', 'Expected actual "Browser" to be \'Kiwi\' (was \'' + browser['Browser'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
    ...
    assert.strictEqual(browser['Browser_Maker'], 'Geometry OU', 'Expected actual "Browser_Maker" to be \'Geometry OU\' (was \'' + browser['Browser_Maker'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
    ...
    assert.strictEqual(browser['Device_Name'], 'G4 (US Cellular)', 'Expected actual "Device_Name" to be \'G4 (US Cellular)\' (was \'' + browser['Device_Name'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
    ...
    assert.strictEqual(browser['Device_Code_Name'], 'US991', 'Expected actual "Device_Code_Name" to be \'US991\' (was \'' + browser['Device_Code_Name'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
  ...
  test('issue-1933-B ["Mozilla/5.0 (Linux; Android 9; Pixel 2 XL Build/PPP4.180612.004) AppleWebKit/537.36 (KHTML, like Gecko) Kiwi Chrome/69.0.3440.40 Mobile Safari/537.36"]', function () {
    const browscap = new Browscap();
    const browser = browscap.getBrowser('Mozilla/5.0 (Linux; Android 9; Pixel 2 XL Build/PPP4.180612.004) AppleWebKit/537.36 (KHTML, like Gecko) Kiwi Chrome/69.0.3440.40 Mobile Safari/537.36');
  ...
  test('issue-1933-C ["Mozilla/5.0 (Linux; Android 8.1.0; Redmi Note 4 Build/OPM2.171026.006.C1) AppleWebKit/537.36 (KHTML, like Gecko) Kiwi Chrome/69.0.3462.0 Mobile Safari/537.36"]', function () {
    const browscap = new Browscap();
    const browser = browscap.getBrowser('Mozilla/5.0 (Linux; Android 8.1.0; Redmi Note 4 Build/OPM2.171026.006.C1) AppleWebKit/537.36 (KHTML, like Gecko) Kiwi Chrome/69.0.3462.0 Mobile Safari/537.36');
  ...
  test('issue-1933-D ["Mozilla/5.0 (Linux; Android 8.0.0; SM-G950F Build/R16NW) AppleWebKit/537.36 (KHTML, like Gecko) Kiwi Chrome/69.0.3440.40 Mobile Safari/537.36"]', function () {
    const browscap = new Browscap();
    const browser = browscap.getBrowser('Mozilla/5.0 (Linux; Android 8.0.0; SM-G950F Build/R16NW) AppleWebKit/537.36 (KHTML, like Gecko) Kiwi Chrome/69.0.3440.40 Mobile Safari/537.36');
  ...
  test('issue-1933-E ["Mozilla/5.0 (Linux; Android 5.1.1; KFAUWI Build/LVY48F) AppleWebKit/537.36 (KHTML, like Gecko) Kiwi Chrome/69.0.3440.40 Safari/537.36"]', function () {
    const browscap = new Browscap();
    const browser = browscap.getBrowser('Mozilla/5.0 (Linux; Android 5.1.1; KFAUWI Build/LVY48F) AppleWebKit/537.36 (KHTML, like Gecko) Kiwi Chrome/69.0.3440.40 Safari/537.36');
