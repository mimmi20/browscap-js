...
suite('checking for issue 2102. (2 tests)', function() {
  test('issue-2102-A ["Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_0) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/74.0.3729.157 Safari/537.36"]', function() {
  ...
  test('issue-2102-B ["Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/74.0.3729.157 Safari/537.36"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
