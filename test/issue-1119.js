...
suite('checking for issue 1119.', function () {
  test('issue-1119 ["Kurio/3.1.9 Build 66400(Android Kitkat 4.4.4; Phone)"]', function () {
    ...
    assert.strictEqual(browser['Browser_Maker'], 'CIDE Interactive', 'Expected actual "Browser_Maker" to be \'CIDE Interactive\' (was \'' + browser['Browser_Maker'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
