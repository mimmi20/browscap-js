...
suite('checking for issue 1622. (3 tests)', function() {
  test('issue-1622-A ["David Client (7044 Windows, IE 9/11) [Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; rv:11.0) like Gecko]"]', function() {
    ...
    let browser = browscap.getBrowser(
      'David Client (7044 Windows, IE 9/11) [Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; rv:11.0) like Gecko]'
    );

    assert.strictEqual(
      browser['Comment'],
      'David Client',
      "Expected actual \"Comment\" to be 'David Client' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
    ...
    assert.strictEqual(
      browser['Browser'],
      'David Client',
      "Expected actual \"Browser\" to be 'David Client' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'Tobit Software AG',
      "Expected actual \"Browser_Maker\" to be 'Tobit Software AG' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1622-B ["David Client (7152 Windows, IE 9/11) [Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; rv:11.0) like Gecko]"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'David Client (7152 Windows, IE 9/11) [Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; rv:11.0) like Gecko]'
    );
  ...
  test('issue-1622-C ["David Client (6707 Windows, IE 9/11)"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser('David Client (6707 Windows, IE 9/11)');
