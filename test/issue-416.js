...
suite('checking for issue 416.', function () {
  test('issue-416 ["Pinterest/0.2 (+http://www.pinterest.com/)"]', function () {
    ...
    assert.strictEqual(browser['Comment'], 'Pinterest App 0.2', 'Expected actual "Comment" to be \'Pinterest App 0.2\' (was \'' + browser['Comment'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
