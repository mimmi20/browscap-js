...
suite('checking for issue 711. (21 tests)', function() {
  ...
  test('issue-711-B ["Mozilla/5.0 (Linux; Android 4.4.2; Lenovo A5500-H Build/KOT49H) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/30.0.0.0 Safari/537.36 UCBrowser/3.0.0.357"]', function() {
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Comment\" to be 'UC Browser 3.0 for Android' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-711-D ["Mozilla/5.0 (Linux; Android 4.4.2; Lenovo B8000-H Build/KOT49H) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/43.0.2357.78 Safari/537.36 OPR/30.0.1856.93524"]', function() {
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'Yoga Tablet 10 3G',
      "Expected actual \"Device_Name\" to be 'Yoga Tablet 10 3G' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Code_Name'],
      'B8000-H',
      "Expected actual \"Device_Code_Name\" to be 'B8000-H' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-711-M ["Mozilla/5.0 (Linux; U; Android 4.2.2; ru-ru; Lenovo B6000-H/JDQ39) AppleWebKit/534.30 (KHTML, like Gecko) Version/4.2.2 Mobile Safari/534.30"]', function() {
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'Yoga 8 3G',
      "Expected actual \"Device_Name\" to be 'Yoga 8 3G' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Code_Name'],
      'B6000-H',
      "Expected actual \"Device_Code_Name\" to be 'B6000-H' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-711-N ["Mozilla/5.0 (Linux; Android 4.2.2; Lenovo B6000-HV Build/JDQ39) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/43.0.2357.93 Safari/537.36"]', function() {
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'Yoga 8 3G + WiFi',
      "Expected actual \"Device_Name\" to be 'Yoga 8 3G + WiFi' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Code_Name'],
      'B6000-HV',
      "Expected actual \"Device_Code_Name\" to be 'B6000-HV' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-711-P ["Mozilla/5.0 (Linux; Android 4.2.2; Lenovo B6000-H Build/JDQ39) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/28.0.1500.94 Safari/537.36"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Chrome 28.0',
      "Expected actual \"Comment\" to be 'Chrome 28.0' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
