...
suite('checking for issue 1179. (5 tests)', function() {
  test('issue-1179-A ["Mozilla/4.0 (compatible; MSIE 6.0; Nitro) Opera 8.50 [ja]"]', function() {
    ...
    assert.strictEqual(
      browser['Platform'],
      'Nintendo DS',
      "Expected actual \"Platform\" to be 'Nintendo DS' (was '" +
        browser['Platform'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Platform_Description\" to be 'Nintendo DS System Software' (was '" +
        browser['Platform_Description'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'DS',
      "Expected actual \"Device_Name\" to be 'DS' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'DS',
      "Expected actual \"Device_Code_Name\" to be 'DS' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1179-B ["Mozilla/4.0 (compatible; MSIE 6.0; KDDI-TS3B) Opera 8.60 [ja]"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'Mozilla/4.0 (compatible; MSIE 6.0; KDDI-TS3B) Opera 8.60 [ja]'
    );

    assert.strictEqual(
      browser['Comment'],
      'Opera Mobile 8.60',
      "Expected actual \"Comment\" to be 'Opera Mobile 8.60' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Version'],
      '8.60',
      "Expected actual \"Version\" to be '8.60' (was '" +
        browser['Version'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1179-C ["Mozilla/4.0 (compatible; MSIE 6.0; Symbian OS; Motorola A1000;735b) Opera 7.50 [en]./A1000./1.0 UP.Link/6.3.1.15.0"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'Mozilla/4.0 (compatible; MSIE 6.0; Symbian OS; Motorola A1000;735b) Opera 7.50 [en]./A1000./1.0 UP.Link/6.3.1.15.0'
    );

    assert.strictEqual(
      browser['Comment'],
      'Opera Mobile 7.50',
      "Expected actual \"Comment\" to be 'Opera Mobile 7.50' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Version'],
      '7.50',
      "Expected actual \"Version\" to be '7.50' (was '" +
        browser['Version'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'A1000',
      "Expected actual \"Device_Name\" to be 'A1000' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Code_Name'],
      'A1000',
      "Expected actual \"Device_Code_Name\" to be 'A1000' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1179-D ["Mozilla/4.0 (compatible; MSIE 6.0; Symbian OS; Motorola M1000;811) Opera 7.50 [ja]./M1000./1.0"]', function() {
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'M1000',
      "Expected actual \"Device_Name\" to be 'M1000' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Code_Name'],
      'M1000',
      "Expected actual \"Device_Code_Name\" to be 'M1000' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1179-E ["Mozilla/4.0 (compatible; MSIE 6.0; Windows Mobile; xx) Opera 10.00"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'Mozilla/4.0 (compatible; MSIE 6.0; Windows Mobile; xx) Opera 10.00'
    );
