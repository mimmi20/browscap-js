...
suite('checking for issue 405. (3 tests)', function() {
  test('issue-405-A ["Mozilla/5.0 (PlayStation 4 1.75) AppleWebKit/536.26 (KHTML, like Gecko)"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Playstation Browser',
      "Expected actual \"Comment\" to be 'Playstation Browser' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
    ...
    assert.strictEqual(
      browser['Browser'],
      'Playstation Browser',
      "Expected actual \"Browser\" to be 'Playstation Browser' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'Sony',
      "Expected actual \"Browser_Maker\" to be 'Sony' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Platform'],
      'OrbisOS',
      "Expected actual \"Platform\" to be 'OrbisOS' (was '" +
        browser['Platform'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'Sony',
      "Expected actual \"Platform_Maker\" to be 'Sony' (was '" +
        browser['Platform_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'Playstation 4',
      "Expected actual \"Device_Name\" to be 'Playstation 4' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'PS4',
      "Expected actual \"Device_Code_Name\" to be 'PS4' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-405-B ["Mozilla/5.0 (PlayStation Vita 3.18) AppleWebKit/536.26 (KHTML, like Gecko) Silk/3.2"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'PlayStation Vita',
      "Expected actual \"Comment\" to be 'PlayStation Vita' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Platform'],
      'Playstation Vita',
      "Expected actual \"Platform\" to be 'Playstation Vita' (was '" +
        browser['Platform'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Platform_Description\" to be 'Playstation Vita System Software' (was '" +
        browser['Platform_Description'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'PlayStation Vita',
      "Expected actual \"Device_Name\" to be 'PlayStation Vita' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Code_Name'],
      'PlayStation Vita',
      "Expected actual \"Device_Code_Name\" to be 'PlayStation Vita' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-405-C ["Mozilla/5.0 (PLAYSTATION 3 4.60) AppleWebKit/531.22.8 (KHTML, like Gecko)"]', function() {
    ...
    assert.strictEqual(
      browser['Platform'],
      'CellOS',
      "Expected actual \"Platform\" to be 'CellOS' (was '" +
        browser['Platform'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'Playstation 3',
      "Expected actual \"Device_Name\" to be 'Playstation 3' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Code_Name'],
      'PS3',
      "Expected actual \"Device_Code_Name\" to be 'PS3' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
