...
suite('checking for issue 2086. (1 test)', function() {
  test('issue-2086-A ["Trackuity (+http://trackuity.com)"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser('Trackuity (+http://trackuity.com)');
    ...
    assert.strictEqual(
      browser['Browser'],
      'Trackuity',
      "Expected actual \"Browser\" to be 'Trackuity' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'Trackuity bvba',
      "Expected actual \"Browser_Maker\" to be 'Trackuity bvba' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
