...
suite('checking for issue 350.', function () {
  ...
  test('issue-350-C', function () {
    browser = browscap.getBrowser("Mozilla/5.0 (compatible; AOLbot/4.0; +http://www.aol-soft.com/)");

    assert.strictEqual(browser['Browser'], 'AOLbot');
    assert.strictEqual(browser['Browser_Type'], 'Bot/Crawler');
    assert.strictEqual(browser['Browser_Bits'], '0');
    assert.strictEqual(browser['Browser_Maker'], 'AOL-SOFT.COM');
  ...
  test('issue-350-D', function () {
    browser = browscap.getBrowser("Go 1.1 package http");

    assert.strictEqual(browser['Browser'], 'GO HttpClient');
    assert.strictEqual(browser['Browser_Type'], 'Bot/Crawler');
    assert.strictEqual(browser['Browser_Bits'], '0');
  ...
  test('issue-350-F', function () {
    browser = browscap.getBrowser("Proxy Gear Pro/2.1 (Windows; N; Windows NT 6.1; en)");

    assert.strictEqual(browser['Browser'], 'Proxy Gear Pro');
    assert.strictEqual(browser['Browser_Type'], 'Bot/Crawler');
    assert.strictEqual(browser['Browser_Bits'], '32');
    assert.strictEqual(browser['Browser_Maker'], 'proxy-base.org');
