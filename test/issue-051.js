...
suite('checking for issue 051.', function () {
  test('issue-051-3 ["Mozilla/5.0 (compatible; grapeFX/0.9; crawler@grapeshot.co.uk"]', function () {
    ...
    assert.strictEqual(browser['Browser_Maker'], 'Grapeshot Limited', 'Expected actual "Browser_Maker" to be \'Grapeshot Limited\' (was \'' + browser['Browser_Maker'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
