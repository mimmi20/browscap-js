...
suite('checking for issue 1020. (11 tests)', function() {
  test('issue-1020-A ["Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/538.1 (KHTML, like Gecko) WahOO Safari/538.1"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/538.1 (KHTML, like Gecko) WahOO Safari/538.1'
    );

    assert.strictEqual(
      browser['Comment'],
      'Wahoo Browser',
      "Expected actual \"Comment\" to be 'Wahoo Browser' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
    ...
    assert.strictEqual(
      browser['Browser'],
      'Wahoo Browser',
      "Expected actual \"Browser\" to be 'Wahoo Browser' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'Kow Media sprl.',
      "Expected actual \"Browser_Maker\" to be 'Kow Media sprl.' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1020-B ["Mozilla/5.0 (Windows NT 6.2; WOW64) AppleWebKit/538.1 (KHTML, like Gecko) WahOO Safari/538.1"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (Windows NT 6.2; WOW64) AppleWebKit/538.1 (KHTML, like Gecko) WahOO Safari/538.1'
    );
  ...
  test('issue-1020-C ["Mozilla/5.0 (Windows NT 6.1) AppleWebKit/538.1 (KHTML, like Gecko) WahOO Safari/538.1"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (Windows NT 6.1) AppleWebKit/538.1 (KHTML, like Gecko) WahOO Safari/538.1'
    );
  ...
  test('issue-1020-D ["Mozilla/5.0 (Windows NT 6.0) AppleWebKit/538.1 (KHTML, like Gecko) WahOO Safari/538.1"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (Windows NT 6.0) AppleWebKit/538.1 (KHTML, like Gecko) WahOO Safari/538.1'
    );
  ...
  test('issue-1020-E ["Mozilla/5.0 (Windows NT 5.1) AppleWebKit/538.1 (KHTML, like Gecko) WahOO Safari/538.1"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (Windows NT 5.1) AppleWebKit/538.1 (KHTML, like Gecko) WahOO Safari/538.1'
    );
  ...
  test('issue-1020-F ["Mozilla/5.0 (Macintosh; Intel Mac OS X) AppleWebKit/538.1 (KHTML, like Gecko) WahOO Safari/538.1"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (Macintosh; Intel Mac OS X) AppleWebKit/538.1 (KHTML, like Gecko) WahOO Safari/538.1'
    );
  ...
  test('issue-1020-G ["Mozilla/5.0 (Windows NT 6.2) AppleWebKit/538.1 (KHTML, like Gecko) WahOO Safari/538.1"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (Windows NT 6.2) AppleWebKit/538.1 (KHTML, like Gecko) WahOO Safari/538.1'
    );
  ...
  test('issue-1020-H ["Mozilla/5.0 (Windows NT 6.0; WOW64) AppleWebKit/538.1 (KHTML, like Gecko) WahOO Safari/538.1"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (Windows NT 6.0; WOW64) AppleWebKit/538.1 (KHTML, like Gecko) WahOO Safari/538.1'
    );
  ...
  test('issue-1020-I ["Mozilla/5.0 (Windows NT 5.1; WOW64) AppleWebKit/538.1 (KHTML, like Gecko) WahOO Safari/538.1"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (Windows NT 5.1; WOW64) AppleWebKit/538.1 (KHTML, like Gecko) WahOO Safari/538.1'
    );
  ...
  test('issue-1020-J ["Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/538.1 (KHTML, like Gecko) WahOO Safari/538.1"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/538.1 (KHTML, like Gecko) WahOO Safari/538.1'
    );
  ...
  test('issue-1020-K ["Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/538.1 (KHTML, like Gecko) WahOO Safari/538.1"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/538.1 (KHTML, like Gecko) WahOO Safari/538.1'
    );
