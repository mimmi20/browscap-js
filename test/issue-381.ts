...
suite('checking for issue 381. (5 tests)', function() {
  ...
  test('issue-381-B ["NGM Dynamic Racing 2/V2 Linux/3.0.13 Android/4.2 Release/02.15.2012 Browser/AppleWebKit534.30 Mobile Safari/534.30 MBBMS/2.2 System/Android 4.2.2;"]', function() {
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'Dynamic Racing GP',
      "Expected actual \"Device_Name\" to be 'Dynamic Racing GP' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Code_Name'],
      'Dynamic Racing GP',
      "Expected actual \"Device_Code_Name\" to be 'Dynamic Racing GP' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-381-D ["PB0.6b Mozilla/5.0 (Windows NT 6.1; WOW64; rv:23.0) Gecko/20100101 Firefox/23.0"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Pirate Browser',
      "Expected actual \"Comment\" to be 'Pirate Browser' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser'],
      'Pirate Browser',
      "Expected actual \"Browser\" to be 'Pirate Browser' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser_Maker'],
      'Pirate Bay',
      "Expected actual \"Browser_Maker\" to be 'Pirate Bay' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
