...
suite('checking for issue 1626. (1 test)', function () {
  test('issue-1626 ["lua-resty-http/0.10 (Lua) ngx_lua/10000"]', function () {
    ...
    assert.strictEqual(browser['Browser_Maker'], 'James Hurst', 'Expected actual "Browser_Maker" to be \'James Hurst\' (was \'' + browser['Browser_Maker'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
