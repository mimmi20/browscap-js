...
suite('checking for issue 1281. (2 tests)', function() {
  test('issue-1281-A ["Mozilla/5.0 (Maemo; Linux; U; Jolla; Sailfish; Tablet; rv:31.0) Gecko/31.0 Firefox/31.0 SailfishBrowser/1.0"]', function() {
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Comment\" to be 'Sailfish Browser 1.0' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
    ...
    assert.strictEqual(
      browser['Browser'],
      'Sailfish Browser',
      "Expected actual \"Browser\" to be 'Sailfish Browser' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'Jolla Ltd.',
      "Expected actual \"Browser_Maker\" to be 'Jolla Ltd.' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'Jolla Tablet',
      "Expected actual \"Device_Name\" to be 'Jolla Tablet' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'Jolla Tablet',
      "Expected actual \"Device_Code_Name\" to be 'Jolla Tablet' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1281-B ["Mozilla/5.0 (Linux; Android 4.4.4; Jolla C Build/KTU84Q) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/55.0.2883.91 Mobile Safari/537.36 OPR/42.7.2246.114996"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (Linux; Android 4.4.4; Jolla C Build/KTU84Q) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/55.0.2883.91 Mobile Safari/537.36 OPR/42.7.2246.114996'
    );
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'Jolla C',
      "Expected actual \"Device_Name\" to be 'Jolla C' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Code_Name'],
      'Jolla C',
      "Expected actual \"Device_Code_Name\" to be 'Jolla C' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
