...
suite('checking for issue 1024. (1 test)', function() {
  test('issue-1024 ["Mozilla/5.0 (Linux; Android 5.1.1; SAMSUNG SM-P601 Build/LMY47X) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/3.3 Chrome/38.0.2125.102 Safari/537.36"]', function() {
    ...
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (Linux; Android 5.1.1; SAMSUNG SM-P601 Build/LMY47X) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/3.3 Chrome/38.0.2125.102 Safari/537.36'
    );

    assert.strictEqual(
      browser['Comment'],
      'Samsung Browser 3.3',
      "Expected actual \"Comment\" to be 'Samsung Browser 3.3' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Device_Name\" to be 'Galaxy Note 10.1 2014 Edition 3G & Wifi' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'SM-P601',
      "Expected actual \"Device_Code_Name\" to be 'SM-P601' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
