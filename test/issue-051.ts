...
suite('checking for issue 051. (3 tests)', function() {
  test('issue-051-3 ["Mozilla/5.0 (compatible; grapeFX/0.9; crawler@grapeshot.co.uk"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'GrapeshotCrawler',
      "Expected actual \"Comment\" to be 'GrapeshotCrawler' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
    ...
    assert.strictEqual(
      browser['Browser'],
      'grapeFX',
      "Expected actual \"Browser\" to be 'grapeFX' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'Grapeshot Limited',
      "Expected actual \"Browser_Maker\" to be 'Grapeshot Limited' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-051-2 ["Mozilla/5.0 (compatible; GrapeshotCrawler/2.0; +http://www.grapeshot.co.uk/crawler.php)"]', function() {
    ...
    assert.strictEqual(
      browser['Browser'],
      'GrapeshotCrawler',
      "Expected actual \"Browser\" to be 'GrapeshotCrawler' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-051-1 ["niki-bot"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser('niki-bot');

    assert.strictEqual(
      browser['Comment'],
      'NikiBot',
      "Expected actual \"Comment\" to be 'NikiBot' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser'],
      'NikiBot',
      "Expected actual \"Browser\" to be 'NikiBot' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
