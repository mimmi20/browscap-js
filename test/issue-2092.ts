...
suite('checking for issue 2092. (1 test)', function() {
  test('issue-2092-A ["Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) BeakerBrowser/0.8.7 Chrome/69.0.3497.128 Electron/4.1.3 Safari/537.36"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'BeakerBrowser 0.8',
      "Expected actual \"Comment\" to be 'BeakerBrowser 0.8' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
    ...
    assert.strictEqual(
      browser['Browser'],
      'Beaker',
      "Expected actual \"Browser\" to be 'Beaker' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'Blue Link Labs',
      "Expected actual \"Browser_Maker\" to be 'Blue Link Labs' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
