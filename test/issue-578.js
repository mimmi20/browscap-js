...
suite('checking for issue 578.', function () {
  test('issue-578-A ["check_http/v1.4.16 (nagios-plugins 1.4.16)"]', function () {
    ...
    assert.strictEqual(browser['Browser_Maker'], 'Nagios Enterprises, LLC.', 'Expected actual "Browser_Maker" to be \'Nagios Enterprises, LLC.\' (was \'' + browser['Browser_Maker'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
