...
suite('checking for issue 1649. (1 test)', function () {
  test('issue-1649-A ["gvfs/1.22.2"]', function () {
    ...
    assert.strictEqual(browser['Browser_Type'], 'Tool', 'Expected actual "Browser_Type" to be \'Tool\' (was \'' + browser['Browser_Type'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
    ...
    assert.strictEqual(browser['Version'], '1.22', 'Expected actual "Version" to be \'1.22\' (was \'' + browser['Version'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
