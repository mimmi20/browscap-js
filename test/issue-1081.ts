...
suite('checking for issue 1081. (1 test)', function() {
  test('issue-1081 ["Mozilla/5.0 (Linux; Android 5.1.1; ASUS MeMO Pad 7 Build/LMY47V) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/50.0.2661.89 Safari/537.36"]', function() {
    ...
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (Linux; Android 5.1.1; ASUS MeMO Pad 7 Build/LMY47V) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/50.0.2661.89 Safari/537.36'
    );
    ...
    assert.strictEqual(
      ...
      'ME176C',
      "Expected actual \"Device_Code_Name\" to be 'ME176C' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
