...
suite('checking for issue 1857. (1 test)', function () {
  test('issue-1857-00000 ["Mozilla/5.0 (Macintosh; Intel Mac OS X 10.11; rv:60.0) Gecko/20100101 Firefox/60.0"]', function () {
    const browscap = new Browscap();
    const browser = browscap.getBrowser('Mozilla/5.0 (Macintosh; Intel Mac OS X 10.11; rv:60.0) Gecko/20100101 Firefox/60.0');

    assert.strictEqual(browser['Comment'], 'Firefox 60.0', 'Expected actual "Comment" to be \'Firefox 60.0\' (was \'' + browser['Comment'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
    ...
    assert.strictEqual(browser['RenderingEngine_Version'], '60.0', 'Expected actual "RenderingEngine_Version" to be \'60.0\' (was \'' + browser['RenderingEngine_Version'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
