...
suite('checking for issue 906. (1 test)', function() {
  test('issue-906 ["SetLinks bot 1.0"]', function() {
    ...
    let browser = browscap.getBrowser('SetLinks bot 1.0');

    assert.strictEqual(
      browser['Comment'],
      'SetLinks.ru Crawler',
      "Expected actual \"Comment\" to be 'SetLinks.ru Crawler' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
    ...
    assert.strictEqual(
      browser['Browser'],
      'SetLinks.ru Crawler',
      "Expected actual \"Browser\" to be 'SetLinks.ru Crawler' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'SetLinks.ru',
      "Expected actual \"Browser_Maker\" to be 'SetLinks.ru' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
