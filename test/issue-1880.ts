...
suite('checking for issue 1880. (4 tests)', function() {
  test('issue-1880-A ["stagefright/1.2 (Linux;Android 4.1.2)"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser('stagefright/1.2 (Linux;Android 4.1.2)');
  ...
  test('issue-1880-B ["stagefright/1.2 (Linux;Android NexPlayer LG-P71310c-ZAF-XX)"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'stagefright/1.2 (Linux;Android NexPlayer LG-P71310c-ZAF-XX)'
    );
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'Optimus L7 II',
      "Expected actual \"Device_Name\" to be 'Optimus L7 II' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Code_Name'],
      'P713',
      "Expected actual \"Device_Code_Name\" to be 'P713' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1880-C ["Samsung GT-N7100 stagefright/1.2 (Linux;Android 4.4.2)"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'Samsung GT-N7100 stagefright/1.2 (Linux;Android 4.4.2)'
    );
  ...
  test('issue-1880-D ["PodcastAddict/v2 - Dalvik/2.1.0 (Linux; U; Android 5.1.1; SM-J105F Build/LMY47V)"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'PodcastAddict/v2 - Dalvik/2.1.0 (Linux; U; Android 5.1.1; SM-J105F Build/LMY47V)'
    );

    assert.strictEqual(
      browser['Comment'],
      'PodcastAddict',
      "Expected actual \"Comment\" to be 'PodcastAddict' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser'],
      'PodcastAddict',
      "Expected actual \"Browser\" to be 'PodcastAddict' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
