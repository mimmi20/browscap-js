...
suite('checking for issue 2090. (1 test)', function() {
  test('issue-2090-A ["HTTPie/1.0.2"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser('HTTPie/1.0.2');
    ...
    assert.strictEqual(
      browser['Browser'],
      'HTTPie',
      "Expected actual \"Browser\" to be 'HTTPie' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
