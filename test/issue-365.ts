...
suite('checking for issue 365. (12 tests)', function() {
  test('issue-365-A ["Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/534+ (KHTML, like Gecko) MsnBot-Media /1.0b"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'MSN-Media',
      "Expected actual \"Comment\" to be 'MSN-Media' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
    ...
    assert.strictEqual(
      browser['Browser'],
      'msnbot-media',
      "Expected actual \"Browser\" to be 'msnbot-media' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-365-B ["Mozilla/5.0 (compatible; WebThumbnail/3.x; Website Thumbnail Generator; +http://webthumbnail.org)"]', function() {
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Comment\" to be 'Website Thumbnail Generator' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser'],
      'Website Thumbnail Generator',
      "Expected actual \"Browser\" to be 'Website Thumbnail Generator' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser_Maker'],
      'webthumbnail.org',
      "Expected actual \"Browser_Maker\" to be 'webthumbnail.org' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-365-C ["Mozilla/5.0 (Linux; U; Android 4.0.3; en-us; NGM Miracle Build/IMM76D) AppleWebKit/534.30 KHTML, like Gecko) Version/4.0 Mobile Safari/534.30"]', function() {
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'WeMove Miracle',
      "Expected actual \"Device_Name\" to be 'WeMove Miracle' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Maker'],
      'NGM',
      "Expected actual \"Device_Maker\" to be 'NGM' (was '" +
        browser['Device_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Code_Name'],
      'WeMove Miracle',
      "Expected actual \"Device_Code_Name\" to be 'WeMove Miracle' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Brand_Name'],
      'NGM',
      "Expected actual \"Device_Brand_Name\" to be 'NGM' (was '" +
        browser['Device_Brand_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-365-D ["Lenovo-A880/S100 Linux/3.4.5 Android/4.2 Release/08.07.2013 Browser/AppleWebKit 534.30 Profile/ Configuration;"]', function() {
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'A880',
      "Expected actual \"Device_Name\" to be 'A880' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Code_Name'],
      'A880',
      "Expected actual \"Device_Code_Name\" to be 'A880' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-365-G ["UCWEB/2.0 (Linux; U; Opera Mini/7.1.32052/30.3697; en-US; Videocon_A15) U2/1.0.0 UCBrowser/9.2.0.419 Mobile"]', function() {
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'A15',
      "Expected actual \"Device_Name\" to be 'A15' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Device_Maker\" to be 'Videocon Industries Limited' (was '" +
        browser['Device_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Code_Name'],
      'A15',
      "Expected actual \"Device_Code_Name\" to be 'A15' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Brand_Name'],
      'Videocon',
      "Expected actual \"Device_Brand_Name\" to be 'Videocon' (was '" +
        browser['Device_Brand_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-365-K ["HTC_DesireS_S510e_Mozilla/5.0(Linux; U; Android 2.3.3;it-it; Build/GRI40) AppleWebKit/533.1 (KHTML, like Gecko) Version/4.0 Mobile Safari/533.1"]', function() {
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'Desire S',
      "Expected actual \"Device_Name\" to be 'Desire S' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Code_Name'],
      'S510e',
      "Expected actual \"Device_Code_Name\" to be 'S510e' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-365-M ["LG-KS20/TIM/V10b Browser/IEMobile/7.6 MMS/LG-MMS-WINCE-V1.0/1.2 Java/LGVM/1.0 Profile/MIDP-2.0 Configuration/CLDC-1.1 (compatible; MSIE 4.01; Windows CE; PPC)/UC Browser7.7.1.88/31/444"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'UC Browser 7.7 for WinCE',
      "Expected actual \"Comment\" to be 'UC Browser 7.7 for WinCE' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'KS20',
      "Expected actual \"Device_Name\" to be 'KS20' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Code_Name'],
      'KS20',
      "Expected actual \"Device_Code_Name\" to be 'KS20' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
