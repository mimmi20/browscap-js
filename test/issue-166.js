...
suite('checking for issue 166.', function () {
  test('issue-166 ["Mozilla/5.0 (iPhone; CPU iPhone OS 7_0_4 like Mac OS X) AppleWebKit/536.26 (KHTML, like Gecko) GSA/3.2.1.25875 Mobile/11B554a Safari/8536.25"]', function () {
    ...
    assert.strictEqual(browser['Comment'], 'Google App 3.2', 'Expected actual "Comment" to be \'Google App 3.2\' (was \'' + browser['Comment'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
