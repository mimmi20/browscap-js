...
suite('checking for issue 1943. (1 test)', function() {
  test('issue-1943-A ["Mozilla/5.0 (Linux; Android 7.0; 4G-Universal version Build/NRD90M; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/67.0.3396.81 Safari/537.36"]', function() {
    ...
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (Linux; Android 7.0; 4G-Universal version Build/NRD90M; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/67.0.3396.81 Safari/537.36'
    );

    assert.strictEqual(
      browser['Comment'],
      'Android WebView 67.0',
      "Expected actual \"Comment\" to be 'Android WebView 67.0' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'i8Max 4G',
      "Expected actual \"Device_Name\" to be 'i8Max 4G' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'Voyo',
      "Expected actual \"Device_Maker\" to be 'Voyo' (was '" +
        browser['Device_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'i8Max 4G',
      "Expected actual \"Device_Code_Name\" to be 'i8Max 4G' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'Voyo',
      "Expected actual \"Device_Brand_Name\" to be 'Voyo' (was '" +
        browser['Device_Brand_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
