...
suite('checking for issue 1833. (1 test)', function () {
  test('issue-1833-A ["Mixmax-LinkPreview 1.0 (+https://sdk.mixmax.com)"]', function () {
    const browscap = new Browscap();
    const browser = browscap.getBrowser('Mixmax-LinkPreview 1.0 (+https://sdk.mixmax.com)');
    ...
    assert.strictEqual(browser['Browser'], 'Mixmax Link Preview', 'Expected actual "Browser" to be \'Mixmax Link Preview\' (was \'' + browser['Browser'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
    ...
    assert.strictEqual(browser['Browser_Maker'], 'Mixmax, Inc.', 'Expected actual "Browser_Maker" to be \'Mixmax, Inc.\' (was \'' + browser['Browser_Maker'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
