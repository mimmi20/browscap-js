...
suite('checking for issue 862.', function () {
  test('issue-862 ["Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9) AppleWebKit/537.71 (KHTML, like Gecko) Version/7.0 Safari/537.71 (Rival IQ, rivaliq.com)"]', function () {
    ...
    assert.strictEqual(browser['Browser_Maker'], 'Rival IQ Corporation', 'Expected actual "Browser_Maker" to be \'Rival IQ Corporation\' (was \'' + browser['Browser_Maker'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
