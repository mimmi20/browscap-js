...
suite('checking for issue 1082. (5 tests)', function() {
  ...
  test('issue-1082-C ["SklikBot/2.0 (sklik@firma.seznam.cz;+http://napoveda.sklik.cz/)"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'SklikBot',
      "Expected actual \"Comment\" to be 'SklikBot' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser'],
      'SklikBot',
      "Expected actual \"Browser\" to be 'SklikBot' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1082-D ["Interdose AntiSpamBot/2.0 (+http://www.piep.net)"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'AntiSpamBot',
      "Expected actual \"Comment\" to be 'AntiSpamBot' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser'],
      'AntiSpamBot',
      "Expected actual \"Browser\" to be 'AntiSpamBot' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser_Maker'],
      'Interdose Ltd. & Co KG',
      "Expected actual \"Browser_Maker\" to be 'Interdose Ltd. & Co KG' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1082-E ["Mozilla/5.0 (compatible; archive.org_bot; Wayback Machine Live Record; +http://archive.org/details/archive.org_bot)"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Wayback Archive Bot',
      "Expected actual \"Comment\" to be 'Wayback Archive Bot' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser'],
      'Wayback Archive Bot',
      "Expected actual \"Browser\" to be 'Wayback Archive Bot' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
