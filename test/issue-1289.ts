...
suite('checking for issue 1289. (4 tests)', function() {
  test('issue-1289-A ["Mozilla/5.0 (compatible; seoscanners.net/1; +spider@seoscanners.net)"]', function() {
    ...
    assert.strictEqual(
      browser['Browser'],
      'SEO Scanners Bot',
      "Expected actual \"Browser\" to be 'SEO Scanners Bot' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'SEO Scanners',
      "Expected actual \"Browser_Maker\" to be 'SEO Scanners' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1289-B ["Mozilla/5.0 (compatible; TeeRaidBot; +https://teeraid.com/bot/)"]', function() {
    ...
    assert.strictEqual(
      browser['Browser'],
      'TeeRaidBot',
      "Expected actual \"Browser\" to be 'TeeRaidBot' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser_Maker'],
      'TeeGrasp Ltd',
      "Expected actual \"Browser_Maker\" to be 'TeeGrasp Ltd' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1289-C ["Mozilla/5.0 (compatible; ToutiaoSpider/1.0; http://web.toutiao.com/media_cooperation/;)"]', function() {
    ...
    assert.strictEqual(
      browser['Browser'],
      'ToutiaoSpider',
      "Expected actual \"Browser\" to be 'ToutiaoSpider' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser_Maker'],
      'Toutiao',
      "Expected actual \"Browser_Maker\" to be 'Toutiao' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1289-D ["Mozilla/5.0 (compatible; TrialPay URL checker; +http://www.trialpay.com) Gecko/20100101 Firefox/19.0"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (compatible; TrialPay URL checker; +http://www.trialpay.com) Gecko/20100101 Firefox/19.0'
    );
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Browser\" to be 'TrialPay URL Checker' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser_Maker'],
      'TrialPay Inc',
      "Expected actual \"Browser_Maker\" to be 'TrialPay Inc' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
