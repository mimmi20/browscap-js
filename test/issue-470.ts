...
suite('checking for issue 470. (7 tests)', function() {
  test('issue-470-A ["Evernote Clip Resolver"]', function() {
    ...
    let browser = browscap.getBrowser('Evernote Clip Resolver');

    assert.strictEqual(
      browser['Comment'],
      'Evernote Clip Resolver',
      "Expected actual \"Comment\" to be 'Evernote Clip Resolver' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
    ...
    assert.strictEqual(
      browser['Browser'],
      'Evernote Clip Resolver',
      "Expected actual \"Browser\" to be 'Evernote Clip Resolver' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Browser_Maker\" to be 'Evernote Corporation' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-470-B ["NetzCheckBot/1.0 (security seal; private-krankenversicherung.de.netzcheck.com; bot@netzcheck.com)"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'NetzCheckBot',
      "Expected actual \"Comment\" to be 'NetzCheckBot' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser'],
      'NetzCheckBot',
      "Expected actual \"Browser\" to be 'NetzCheckBot' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser_Maker'],
      'netzcheck.com',
      "Expected actual \"Browser_Maker\" to be 'netzcheck.com' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-470-C ["MOT-RAZRV3x/01.2A.01 MIB/BER2.2 Profile/MIDP-2.0 Configuration/CLDC-1.1"]', function() {
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'RAZRV3x',
      "Expected actual \"Device_Name\" to be 'RAZRV3x' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Code_Name'],
      'RAZRV3x',
      "Expected actual \"Device_Code_Name\" to be 'RAZRV3x' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-470-D ["Mozilla/5.0 (Linux; U; Android 4.2.2; de-de; BN NookHD+ Build/JDQ39E) AppleWebKit/534.30 (KHTML, like Gecko) Version/4.0 Safari/534.30 CyanogenMod/10.1.3/ovation"]', function() {
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'Nook HD+',
      "Expected actual \"Device_Name\" to be 'Nook HD+' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Code_Name'],
      'Nook HD+',
      "Expected actual \"Device_Code_Name\" to be 'Nook HD+' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-470-F ["Mozilla/5.0 (Nintendo WiiU) AppleWebKit/536.28 (KHTML, like Gecko) NX/3.0.3.12.11 NintendoBrowser/2.1.0.9559.EU"]', function() {
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Comment\" to be 'Nintendo Browser 2.1' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Platform'],
      'Nintendo WiiU',
      "Expected actual \"Platform\" to be 'Nintendo WiiU' (was '" +
        browser['Platform'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Platform_Description'],
      'Nintendo WiiU System Software',
      "Expected actual \"Platform_Description\" to be 'Nintendo WiiU System Software' (was '" +
        browser['Platform_Description'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'WiiU',
      "Expected actual \"Device_Name\" to be 'WiiU' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Code_Name'],
      'WiiU',
      "Expected actual \"Device_Code_Name\" to be 'WiiU' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
