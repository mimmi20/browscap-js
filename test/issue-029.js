...
suite('checking for issue 029.', function () {
  test('issue-029 ["Mozilla/5.0 (Mobile; rv:18.0) Gecko/18.0 Firefox/18.0"]', function () {
    browser = browscap.getBrowser('Mozilla/5.0 (Mobile; rv:18.0) Gecko/18.0 Firefox/18.0');

    assert.strictEqual(browser['Comment'], 'Firefox 18.0 for FirefoxOS 1.0', 'Expected actual "Comment" to be \'Firefox 18.0 for FirefoxOS 1.0\' (was \'' + browser['Comment'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
    ...
    assert.strictEqual(browser['RenderingEngine_Version'], '18.0', 'Expected actual "RenderingEngine_Version" to be \'18.0\' (was \'' + browser['RenderingEngine_Version'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
