...
suite('checking for issue 926. (1 test)', function() {
  test('issue-926 ["DMCA.com Page Protection Crawling Service"]', function() {
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Browser\" to be 'DMCA Page Protection Crawling Service' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Browser_Maker\" to be 'Digital Millennium Copyright Act Services Ltd.' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
