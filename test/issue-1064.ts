...
suite('checking for issue 1064. (2 tests)', function() {
  test('issue-1064-A ["NL-Crawler"]', function() {
    ...
    let browser = browscap.getBrowser('NL-Crawler');
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Browser\" to be 'Northern Light Web Search' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'Northern Light',
      "Expected actual \"Browser_Maker\" to be 'Northern Light' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1064-B ["Mozilla/5.0 (compatible; NLCrawler/2.0.27; Linux 2.6.3-7; i686; en_US)KHTML/3.4.89 (like Gecko)"]', function() {
    ...
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (compatible; NLCrawler/2.0.27; Linux 2.6.3-7; i686; en_US)KHTML/3.4.89 (like Gecko)'
    );
