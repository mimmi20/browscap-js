...
suite('checking for issue 537. (1 test)', function () {
  test('issue-537 ["ltx71 - (http://ltx71.com/)"]', function () {
    const browscap = new Browscap();
    const browser = browscap.getBrowser('ltx71 - (http://ltx71.com/)');
    ...
    assert.strictEqual(browser['Browser'], 'ltx71 Bot', 'Expected actual "Browser" to be \'ltx71 Bot\' (was \'' + browser['Browser'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
    ...
    assert.strictEqual(browser['Browser_Maker'], 'ltx71.com', 'Expected actual "Browser_Maker" to be \'ltx71.com\' (was \'' + browser['Browser_Maker'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
