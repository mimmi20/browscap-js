...
suite('checking for issue 2085. (2 tests)', function() {
  test('issue-2085-A ["Mozilla/5.0 (Linux; Android 5.1; CRONO 54 Build/LMY47I) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/63.0.3239.111 Mobile Safari/537.36"]', function() {
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'Crono 54',
      "Expected actual \"Device_Name\" to be 'Crono 54' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'Majestic',
      "Expected actual \"Device_Maker\" to be 'Majestic' (was '" +
        browser['Device_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'Crono 54',
      "Expected actual \"Device_Code_Name\" to be 'Crono 54' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'Majestic',
      "Expected actual \"Device_Brand_Name\" to be 'Majestic' (was '" +
        browser['Device_Brand_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-2085-B ["Mozilla/5.0 (Linux; Android 4.2.1; MAJESTIC Zeus21 Build/JOP40D) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/29.0.1547.72 Mobile Safari/537.36"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'Zeus 21',
      "Expected actual \"Device_Name\" to be 'Zeus 21' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Code_Name'],
      'Zeus 21',
      "Expected actual \"Device_Code_Name\" to be 'Zeus 21' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
