...
suite('checking for issue 2040. (1 test)', function() {
  test('issue-2040-A ["Mozilla/5.0 (compatible; Eyeotabot/1.0; +http://www.eyeota.com) The Audience Technology Platform | Eyeota"]', function() {
    ...
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (compatible; Eyeotabot/1.0; +http://www.eyeota.com) The Audience Technology Platform | Eyeota'
    );
    ...
    assert.strictEqual(
      browser['Browser'],
      'Eyeotabot',
      "Expected actual \"Browser\" to be 'Eyeotabot' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'Eyeota Pte Ltd',
      "Expected actual \"Browser_Maker\" to be 'Eyeota Pte Ltd' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
