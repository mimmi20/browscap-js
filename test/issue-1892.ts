...
suite('checking for issue 1892. (9 tests)', function() {
  test('issue-1892-A ["Mozilla/5.0 (iPhone; CPU iPhone OS 11_3 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Snapchat/10.33.1.1 (iPhone10,5; iOS 11.3.1; gzip)"]', function() {
    ...
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (iPhone; CPU iPhone OS 11_3 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Snapchat/10.33.1.1 (iPhone10,5; iOS 11.3.1; gzip)'
    );

    assert.strictEqual(
      browser['Comment'],
      'Snapchat 10.33 for iOS',
      "Expected actual \"Comment\" to be 'Snapchat 10.33 for iOS' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
    ...
    assert.strictEqual(
      browser['Version'],
      '10.33',
      "Expected actual \"Version\" to be '10.33' (was '" +
        browser['Version'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1892-B ["Mozilla/5.0 (iPhone; CPU iPhone OS 11_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Snapchat/10.33.1.1 (iPhone9,2; iOS 11.4; gzip)"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (iPhone; CPU iPhone OS 11_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Snapchat/10.33.1.1 (iPhone9,2; iOS 11.4; gzip)'
    );
  ...
  test('issue-1892-C ["Mozilla/5.0 (iPhone; CPU iPhone OS 11_2_6 like Mac OS X) AppleWebKit/604.5.6 (KHTML, like Gecko) Snapchat/10.33.0.25 (iPhone8,1; iOS 11.2.6; gzip)"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (iPhone; CPU iPhone OS 11_2_6 like Mac OS X) AppleWebKit/604.5.6 (KHTML, like Gecko) Snapchat/10.33.0.25 (iPhone8,1; iOS 11.2.6; gzip)'
    );
  ...
  test('issue-1892-D ["Mozilla/5.0 (iPhone; CPU iPhone OS 11_1_2 like Mac OS X) AppleWebKit/604.3.5 (KHTML, like Gecko) Snapchat/10.33.0.25 (iPhone8,1; iOS 11.1.2; gzip)"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (iPhone; CPU iPhone OS 11_1_2 like Mac OS X) AppleWebKit/604.3.5 (KHTML, like Gecko) Snapchat/10.33.0.25 (iPhone8,1; iOS 11.1.2; gzip)'
    );
  ...
  test('issue-1892-E ["Mozilla/5.0 (iPhone; CPU iPhone OS 11_0_3 like Mac OS X) AppleWebKit/604.1.38 (KHTML, like Gecko) Snapchat/10.33.0.25 (iPhone9,4; iOS 11.0.3; gzip)"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (iPhone; CPU iPhone OS 11_0_3 like Mac OS X) AppleWebKit/604.1.38 (KHTML, like Gecko) Snapchat/10.33.0.25 (iPhone9,4; iOS 11.0.3; gzip)'
    );
  ...
  test('issue-1892-F ["Mozilla/5.0 (iPhone; CPU iPhone OS 10_3_3 like Mac OS X) AppleWebKit/603.3.8 (KHTML, like Gecko) Snapchat/10.33.0.25 (iPhone5,1; iOS 10.3.3; gzip)"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (iPhone; CPU iPhone OS 10_3_3 like Mac OS X) AppleWebKit/603.3.8 (KHTML, like Gecko) Snapchat/10.33.0.25 (iPhone5,1; iOS 10.3.3; gzip)'
    );
  ...
  test('issue-1892-G ["Mozilla/5.0 (iPhone; CPU iPhone OS 10_2_1 like Mac OS X) AppleWebKit/602.4.6 (KHTML, like Gecko) Snapchat/10.33.0.25 (iPhone9,4; iOS 10.2.1; gzip)"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (iPhone; CPU iPhone OS 10_2_1 like Mac OS X) AppleWebKit/602.4.6 (KHTML, like Gecko) Snapchat/10.33.0.25 (iPhone9,4; iOS 10.2.1; gzip)'
    );
  ...
  test('issue-1892-H ["Mozilla/5.0 (iPod touch; CPU iPhone OS 11_3 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E216 Snapchat/10.32.1.1 (iPod7,1; iOS 11.3; gzip)"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (iPod touch; CPU iPhone OS 11_3 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E216 Snapchat/10.32.1.1 (iPod7,1; iOS 11.3; gzip)'
    );

    assert.strictEqual(
      browser['Comment'],
      'Snapchat 10.32 for iOS',
      "Expected actual \"Comment\" to be 'Snapchat 10.32 for iOS' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Version'],
      '10.32',
      "Expected actual \"Version\" to be '10.32' (was '" +
        browser['Version'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1892-I ["Mozilla/5.0 (iPhone; CPU iPhone OS 11_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15F79 Snapchat/10.31.5.13 (iPhone8,1; iOS 11.4; gzip)"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (iPhone; CPU iPhone OS 11_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15F79 Snapchat/10.31.5.13 (iPhone8,1; iOS 11.4; gzip)'
    );

    assert.strictEqual(
      browser['Comment'],
      'Snapchat 10.31 for iOS',
      "Expected actual \"Comment\" to be 'Snapchat 10.31 for iOS' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Version'],
      '10.31',
      "Expected actual \"Version\" to be '10.31' (was '" +
        browser['Version'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
