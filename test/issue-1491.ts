...
suite('checking for issue 1491. (8 tests)', function() {
  test('issue-1491-A ["Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/51.0.2704.79 Safari/537.36 (https://shrinktheweb.com)"]', function() {
    ...
    assert.strictEqual(
      browser['Browser'],
      'ShrinkTheWeb Bot',
      "Expected actual \"Browser\" to be 'ShrinkTheWeb Bot' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'ShrinkTheWeb',
      "Expected actual \"Browser_Maker\" to be 'ShrinkTheWeb' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1491-B ["Mozilla/5.0 (Windows; U; Windows NT 5.1; en-US) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/54.0.2840.99  Safari/537.36 HubSpot Marketing Grader"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (Windows; U; Windows NT 5.1; en-US) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/54.0.2840.99  Safari/537.36 HubSpot Marketing Grader'
    );

    assert.strictEqual(
      browser['Comment'],
      'HubSpot Grader',
      "Expected actual \"Comment\" to be 'HubSpot Grader' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser'],
      'Marketing Grader',
      "Expected actual \"Browser\" to be 'Marketing Grader' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1491-C ["Mozilla/5.0 (Linux; Android 6.0.1; Nexus 5X Build/MMB29P) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2272.96 Mobile Safari/537.36 (compatible; Pinterestbot/1.0; +http://www.pinterest.com/bot.html)"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Pinterest Bot 1.0',
      "Expected actual \"Comment\" to be 'Pinterest Bot 1.0' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser'],
      'Pinterest Bot',
      "Expected actual \"Browser\" to be 'Pinterest Bot' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1491-E ["Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/43.0.2357.134 Safari/537.36 http://notifyninja.com/monitoring"]', function() {
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Browser\" to be 'Notify Ninja Monitor' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser_Maker'],
      'Notify Ninja',
      "Expected actual \"Browser_Maker\" to be 'Notify Ninja' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1491-F ["Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/40.0.2214.93 Safari/537.36 XaxisSemanticsClassifier/1.0 http://crystalsemantics.com"]', function() {
    ...
    assert.strictEqual(
      browser['Browser'],
      'Xaxis Semantics Classifier',
      "Expected actual \"Browser\" to be 'Xaxis Semantics Classifier' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser_Maker'],
      'Xaxis',
      "Expected actual \"Browser_Maker\" to be 'Xaxis' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1491-G ["Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/40.0.2214.111 Safari/537.36 moatbot"]', function() {
    ...
    assert.strictEqual(
      browser['Browser'],
      'Moat Bot',
      "Expected actual \"Browser\" to be 'Moat Bot' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser_Maker'],
      'Moat, Inc.',
      "Expected actual \"Browser_Maker\" to be 'Moat, Inc.' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1491-H ["Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/56.0.2924.87 Safari/537.36; +collection@infegy.com"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/56.0.2924.87 Safari/537.36; +collection@infegy.com'
    );
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Browser\" to be 'Infegy Collection Bot' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
