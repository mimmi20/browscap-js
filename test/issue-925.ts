...
suite('checking for issue 925. (1 test)', function() {
  test('issue-925 ["Comodo SSL Checker"]', function() {
    ...
    let browser = browscap.getBrowser('Comodo SSL Checker');

    assert.strictEqual(
      browser['Comment'],
      'Comodo SSL Checker',
      "Expected actual \"Comment\" to be 'Comodo SSL Checker' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
    ...
    assert.strictEqual(
      browser['Browser'],
      'Comodo SSL Checker',
      "Expected actual \"Browser\" to be 'Comodo SSL Checker' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
