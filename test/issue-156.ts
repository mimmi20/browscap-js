...
suite('checking for issue 156. (1 test)', function() {
  test('issue-156 ["BOT/0.1 (BOT for JCE)"]', function() {
    ...
    let browser = browscap.getBrowser('BOT/0.1 (BOT for JCE)');

    assert.strictEqual(
      browser['Comment'],
      'JCE vulnerability scanner',
      "Expected actual \"Comment\" to be 'JCE vulnerability scanner' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
    ...
    assert.strictEqual(
      browser['Browser'],
      'BOT for JCE',
      "Expected actual \"Browser\" to be 'BOT for JCE' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
