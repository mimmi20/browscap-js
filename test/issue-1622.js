...
suite('checking for issue 1622. (3 tests)', function () {
  test('issue-1622-A ["David Client (7044 Windows, IE 9/11) [Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; rv:11.0) like Gecko]"]', function () {
    ...
    assert.strictEqual(browser['Browser_Maker'], 'Tobit Software AG', 'Expected actual "Browser_Maker" to be \'Tobit Software AG\' (was \'' + browser['Browser_Maker'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
