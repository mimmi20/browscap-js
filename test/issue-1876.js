...
suite('checking for issue 1876. (1 test)', function () {
  test('issue-1876-A ["Mozilla/5.0 (compatible; MailPoet Cron/1.0; +http://docs.mailpoet.com/article/241-cron-service)"]', function () {
    const browscap = new Browscap();
    const browser = browscap.getBrowser('Mozilla/5.0 (compatible; MailPoet Cron/1.0; +http://docs.mailpoet.com/article/241-cron-service)');
    ...
    assert.strictEqual(browser['Browser'], 'MailPoet Cron Service', 'Expected actual "Browser" to be \'MailPoet Cron Service\' (was \'' + browser['Browser'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
    ...
    assert.strictEqual(browser['Browser_Maker'], 'Wysija SARL', 'Expected actual "Browser_Maker" to be \'Wysija SARL\' (was \'' + browser['Browser_Maker'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
