...
suite('checking for issue 2087. (1 test)', function() {
  test('issue-2087-A ["Mozilla/5.0 (Linux; U; Android 7.0; en-us; MI 5 Build/NRD90M) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/53.0.2785.146 Mobile Safari/537.36 XiaoMi/MiuiBrowser/9.0.3"]', function() {
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'MI 5',
      "Expected actual \"Device_Name\" to be 'MI 5' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'MI 5',
      "Expected actual \"Device_Code_Name\" to be 'MI 5' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
