...
suite('checking for issue 099. (3 tests)', function() {
  test('issue-099-C ["DavClnt"]', function() {
    ...
    let browser = browscap.getBrowser('DavClnt');

    assert.strictEqual(
      browser['Comment'],
      'Microsoft-WebDAV',
      "Expected actual \"Comment\" to be 'Microsoft-WebDAV' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
    ...
    assert.strictEqual(
      browser['Browser'],
      'Microsoft-WebDAV',
      "Expected actual \"Browser\" to be 'Microsoft-WebDAV' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-099-B ["XING-contenttabreceiver/2.0"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser('XING-contenttabreceiver/2.0');

    assert.strictEqual(
      browser['Comment'],
      'Xing',
      "Expected actual \"Comment\" to be 'Xing' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Browser\" to be 'XING Contenttabreceiver' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-099-A ["Opera/9.60 (Windows NT 5.1; U; de) Presto/2.1.1"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Opera 9.60',
      "Expected actual \"Comment\" to be 'Opera 9.60' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Version'],
      '9.60',
      "Expected actual \"Version\" to be '9.60' (was '" +
        browser['Version'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
