...
suite('checking for issue 500. (26 tests)', function() {
  test('issue-500-A ["Mozilla/5.0 (compatible; CloudFlare-AlwaysOnline/1.0; +http://www.cloudflare.com/always-online) AppleWebKit/534.34"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Online Scanners',
      "Expected actual \"Comment\" to be 'Online Scanners' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Browser\" to be 'CloudFlare AlwaysOnline' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'CloudFlare, Inc.',
      "Expected actual \"Browser_Maker\" to be 'CloudFlare, Inc.' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-500-B ["BigBozz/BigBozz-2.2.1"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser('BigBozz/BigBozz-2.2.1');
    ...
    assert.strictEqual(
      browser['Browser'],
      'BigBozz - Financial Search',
      "Expected actual \"Browser\" to be 'BigBozz - Financial Search' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-500-C ["ECCP/1.0 (search@eniro.com)"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser('ECCP/1.0 (search@eniro.com)');
    ...
    assert.strictEqual(
      browser['Browser'],
      'ECCP',
      "Expected actual \"Browser\" to be 'ECCP' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-500-D ["Mozilla/5.0 (X11; U; Linux; C -) AppleWebKit/527+ (KHTML, like Gecko, Safari/419.3)  Webglance/0.1"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Web Glance',
      "Expected actual \"Comment\" to be 'Web Glance' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser'],
      'Web Glance',
      "Expected actual \"Browser\" to be 'Web Glance' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser_Maker'],
      'webglance.com',
      "Expected actual \"Browser_Maker\" to be 'webglance.com' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-500-G ["wp-iphone/4.4 (iPhone OS 8.0.2, iPad) Mobile"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'WordPress App',
      "Expected actual \"Comment\" to be 'WordPress App' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser'],
      'WordPress App',
      "Expected actual \"Browser\" to be 'WordPress App' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser_Maker'],
      'wordpress.org',
      "Expected actual \"Browser_Maker\" to be 'wordpress.org' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-500-H ["Mozilla/5.0 (Linux; U; Android 2.2.1; en-us; NOOK BNRV200 Build/ERD79 1.4.3) Apple WebKit/533.1 (KHTML, like Gecko) Version/4.0 Mobile Safari/533.1"]', function() {
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'Nook Color Wifi',
      "Expected actual \"Device_Name\" to be 'Nook Color Wifi' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Maker'],
      'Barnes & Noble',
      "Expected actual \"Device_Maker\" to be 'Barnes & Noble' (was '" +
        browser['Device_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Code_Name'],
      'BNRV200',
      "Expected actual \"Device_Code_Name\" to be 'BNRV200' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Brand_Name'],
      'Barnes & Noble',
      "Expected actual \"Device_Brand_Name\" to be 'Barnes & Noble' (was '" +
        browser['Device_Brand_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-500-I ["facebookexternalhit/1.1 (+http://www.facebook.com/externalhit_uatext.php)"]', function() {
    ...
    assert.strictEqual(
      browser['Browser'],
      'FacebookExternalHit',
      "Expected actual \"Browser\" to be 'FacebookExternalHit' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-500-J ["Mozilla/5.0 (Mobile; ALCATEL ONE TOUCH 4012A; rv:18.1) Gecko/18.1 Firefox/18.1"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Firefox 18.1 for FirefoxOS 1.1',
      "Expected actual \"Comment\" to be 'Firefox 18.1 for FirefoxOS 1.1' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Platform'],
      'FirefoxOS',
      "Expected actual \"Platform\" to be 'FirefoxOS' (was '" +
        browser['Platform'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Platform_Version'],
      '1.1',
      "Expected actual \"Platform_Version\" to be '1.1' (was '" +
        browser['Platform_Version'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Platform_Description'],
      'FirefoxOS',
      "Expected actual \"Platform_Description\" to be 'FirefoxOS' (was '" +
        browser['Platform_Description'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Platform_Maker'],
      'Mozilla Foundation',
      "Expected actual \"Platform_Maker\" to be 'Mozilla Foundation' (was '" +
        browser['Platform_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'One Touch Fire',
      "Expected actual \"Device_Name\" to be 'One Touch Fire' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Code_Name'],
      'OT-4012A',
      "Expected actual \"Device_Code_Name\" to be 'OT-4012A' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['RenderingEngine_Version'],
      '18.1',
      "Expected actual \"RenderingEngine_Version\" to be '18.1' (was '" +
        browser['RenderingEngine_Version'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-500-K ["Mozilla/5.0 (Linux;U; Android 4.2.2;  en-us;  Nuqleo; Zaffire 785 Build/ICS) AppleWebKit/531.21.10(KTHML,like Gecko) Version/4.0.4 Mobile/7B367 Safari/531.21.10"]', function() {
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'Zaffire 785',
      "Expected actual \"Device_Name\" to be 'Zaffire 785' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Maker'],
      'Nuqleo',
      "Expected actual \"Device_Maker\" to be 'Nuqleo' (was '" +
        browser['Device_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Code_Name'],
      'Zaffire 785',
      "Expected actual \"Device_Code_Name\" to be 'Zaffire 785' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Brand_Name'],
      'Nuqleo',
      "Expected actual \"Device_Brand_Name\" to be 'Nuqleo' (was '" +
        browser['Device_Brand_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-500-L ["Mozilla/5.0 (LG-C199 AppleWebkit/531 Browser/Phantom/V2.0 Widget/LGMW/3.0 MMS/LG-MMS-V1.0/1.2 Java/ASVM/1.1 Profile/MIDP-2.1 Configuration/CLDC-1.1)"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Phantom Browser',
      "Expected actual \"Comment\" to be 'Phantom Browser' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser'],
      'Phantom Browser',
      "Expected actual \"Browser\" to be 'Phantom Browser' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'C199',
      "Expected actual \"Device_Name\" to be 'C199' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Code_Name'],
      'C199',
      "Expected actual \"Device_Code_Name\" to be 'C199' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-500-M ["GigablastOpenSource/1.0"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser('GigablastOpenSource/1.0');
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Browser\" to be 'Gigablast Search Engine' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser_Maker'],
      'gigablast.com',
      "Expected actual \"Browser_Maker\" to be 'gigablast.com' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-500-N ["Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10) AppleWebKit/600.1.25 (KHTML, like Gecko) Shrook/434l"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Shrook',
      "Expected actual \"Comment\" to be 'Shrook' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser'],
      'Shrook',
      "Expected actual \"Browser\" to be 'Shrook' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser_Maker'],
      'Utsire Software',
      "Expected actual \"Browser_Maker\" to be 'Utsire Software' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-500-Q ["Mozilla/5.0 (Macintosh; U; Intel Mac OS X; de) AppleWebKit/533.19.4 (KHTML, like Gecko) AdobeAIR/13.0"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Adobe AIR 13.0',
      "Expected actual \"Comment\" to be 'Adobe AIR 13.0' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser'],
      'Adobe AIR',
      "Expected actual \"Browser\" to be 'Adobe AIR' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Browser_Maker\" to be 'Adobe Systems Incorporated' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-500-R ["Mozilla/5.0 (Windows; N; ; ru-RU) AppleWebKit/527+ (KHTML, like Gecko, Safari/419.3) Qt/4.5.3"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Qt 4.5',
      "Expected actual \"Comment\" to be 'Qt 4.5' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-500-S ["WebIndex"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser('WebIndex');
    ...
    assert.strictEqual(
      browser['Browser'],
      'WebIndex',
      "Expected actual \"Browser\" to be 'WebIndex' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-500-T ["Prince/7.1 (http://www.princexml.com)"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser('Prince/7.1 (http://www.princexml.com)');

    assert.strictEqual(
      browser['Comment'],
      'Prince',
      "Expected actual \"Comment\" to be 'Prince' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser'],
      'Prince',
      "Expected actual \"Browser\" to be 'Prince' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser_Maker'],
      'YesLogic Pty. Ltd.',
      "Expected actual \"Browser_Maker\" to be 'YesLogic Pty. Ltd.' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-500-U ["Mozilla/5.0 (compatible; MetaJobBot; http://www.metajob.at/crawler)"]', function() {
    ...
    assert.strictEqual(
      browser['Browser'],
      'MetaJobBot',
      "Expected actual \"Browser\" to be 'MetaJobBot' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser_Maker'],
      'Dr. Manfred Schauer',
      "Expected actual \"Browser_Maker\" to be 'Dr. Manfred Schauer' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-500-W ["ArchiveTeam ArchiveBot/20141009.02 (wpull 0.1002a1) and not Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/38.0.2125.101 Safari/537.36"]', function() {
    ...
    assert.strictEqual(
      browser['Browser'],
      'ArchiveBot',
      "Expected actual \"Browser\" to be 'ArchiveBot' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser_Maker'],
      'ArchiveTeam',
      "Expected actual \"Browser_Maker\" to be 'ArchiveTeam' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-500-Y ["Smartsite HTTPClient - Mozilla/4.0 (compatible; MSIE 6.0)"]', function() {
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Browser\" to be 'Smartsite HTTPClient' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-500-Z ["Mozilla/4.0 (jig browser web; 1.0.4; N02A)"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Jig Browser',
      "Expected actual \"Comment\" to be 'Jig Browser' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser'],
      'jig browser web',
      "Expected actual \"Browser\" to be 'jig browser web' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser_Maker'],
      'W3C',
      "Expected actual \"Browser_Maker\" to be 'W3C' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-500-AA ["Mozilla/4.0 (compatible; MSIE 9.0;IPMS/FFFFFFFF-1518D070BFB-000000000000; Windows NT 6.1; Trident/6.0; SLCC2; .NET CLR 2.0.50727; .NET CLR 3.5.30729; .NET CLR 3.0.30729; Media Center PC 6.0; .NET4.0C; .NET4.0E; Tablet PC 2.0; InfoPath.3; MASMJS)"]', function() {
    ...
    assert.strictEqual(
      browser['Browser_Modus'],
      'IE 9.0 Compatibility Mode',
      "Expected actual \"Browser_Modus\" to be 'IE 9.0 Compatibility Mode' (was '" +
        browser['Browser_Modus'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
