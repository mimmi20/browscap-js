...
suite('checking for issue 2093. (1 test)', function() {
  test('issue-2093-A ["Mozilla/5.0 (Linux; Android 8.1.0; SM-T380) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/73.0.3683.90 Mobile Safari/537.36"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (Linux; Android 8.1.0; SM-T380) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/73.0.3683.90 Mobile Safari/537.36'
    );

    assert.strictEqual(
      browser['Comment'],
      'Chrome 73.0',
      "Expected actual \"Comment\" to be 'Chrome 73.0' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Device_Name\" to be 'Galaxy Tab A 8.0 Wi-Fi (2017)' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'SM-T380',
      "Expected actual \"Device_Code_Name\" to be 'SM-T380' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
