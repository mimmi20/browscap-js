...
suite('checking for issue 227. (1 test)', function() {
  test('issue-227 ["RankFlex.com Webspider"]', function() {
    ...
    let browser = browscap.getBrowser('RankFlex.com Webspider');

    assert.strictEqual(
      browser['Comment'],
      'RankFlex',
      "Expected actual \"Comment\" to be 'RankFlex' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
    ...
    assert.strictEqual(
      browser['Browser'],
      'RankFlex',
      "Expected actual \"Browser\" to be 'RankFlex' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'rankflex.com',
      "Expected actual \"Browser_Maker\" to be 'rankflex.com' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
