...
suite('checking for issue 1057. (3 tests)', function() {
  test('issue-1057-A ["Mozilla/5.0(Linux;Android 4.4.2;es-us;CHC-U03 Build/HuweiCHC-U03)AppleWebKit/537.36 (KHTML, likeGecko) Version/4.0 Chrome/30.0.0.0 Mobile Safari/537.36"]', function() {
    ...
    let browser = browscap.getBrowser(
      'Mozilla/5.0(Linux;Android 4.4.2;es-us;CHC-U03 Build/HuweiCHC-U03)AppleWebKit/537.36 (KHTML, likeGecko) Version/4.0 Chrome/30.0.0.0 Mobile Safari/537.36'
    );
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'G Play mini',
      "Expected actual \"Device_Name\" to be 'G Play mini' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'CHC-U03',
      "Expected actual \"Device_Code_Name\" to be 'CHC-U03' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1057-B ["Mozilla/5.1 (Linux; U; Android 5.1; es-cl; Bmobile_AX810 Build/ JDQ39) AppleWebKit/534.30 (KHTML, like Gecko) Version/4.0 Mobile Safari/534.30"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'Mozilla/5.1 (Linux; U; Android 5.1; es-cl; Bmobile_AX810 Build/ JDQ39) AppleWebKit/534.30 (KHTML, like Gecko) Version/4.0 Mobile Safari/534.30'
    );
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'AX810',
      "Expected actual \"Device_Name\" to be 'AX810' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Maker'],
      'Bmobile',
      "Expected actual \"Device_Maker\" to be 'Bmobile' (was '" +
        browser['Device_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Code_Name'],
      'AX810',
      "Expected actual \"Device_Code_Name\" to be 'AX810' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Brand_Name'],
      'Bmobile',
      "Expected actual \"Device_Brand_Name\" to be 'Bmobile' (was '" +
        browser['Device_Brand_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1057-C ["Mozilla/5.0(Linux;U;Android 4.2.2;ru-ru;MTC 982 Build/JDQ39) AppleWebKit/534.30(KHTML,like Gecko) Version/4.2 Mobile Safari/534.30 SVN/160HVG1"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'Mozilla/5.0(Linux;U;Android 4.2.2;ru-ru;MTC 982 Build/JDQ39) AppleWebKit/534.30(KHTML,like Gecko) Version/4.2 Mobile Safari/534.30 SVN/160HVG1'
    );
    ...
    assert.strictEqual(
      browser['Device_Name'],
      '982',
      "Expected actual \"Device_Name\" to be '982' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Code_Name'],
      '982',
      "Expected actual \"Device_Code_Name\" to be '982' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
