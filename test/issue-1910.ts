...
suite('checking for issue 1910. (4 tests)', function() {
  test('issue-1910-A ["Mozilla/5.0 (Windows NT 6.2; WOW64; rv:31.0) Gecko/20100101 Firefox/31.0 K-Meleon/75.1"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'K-Meleon 75.1',
      "Expected actual \"Comment\" to be 'K-Meleon 75.1' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
    ...
    assert.strictEqual(
      browser['Version'],
      '75.1',
      "Expected actual \"Version\" to be '75.1' (was '" +
        browser['Version'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1910-B ["Mozilla/5.0 (Windows NT 6.2; WOW64; rv:31.0) Gecko/20100101 K-Meleon/75.1"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (Windows NT 6.2; WOW64; rv:31.0) Gecko/20100101 K-Meleon/75.1'
    );
  ...
  test('issue-1910-C ["Mozilla/5.0 (Windows NT 5.2; WOW64; rv:31.0) Gecko/20100101 Firefox/31.0 K-Meleon/75.1"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (Windows NT 5.2; WOW64; rv:31.0) Gecko/20100101 Firefox/31.0 K-Meleon/75.1'
    );
  ...
  test('issue-1910-D ["Mozilla/5.0 (Windows NT 6.2; WOW64; rv:38.0) Gecko/20100101 Firefox/38.0 K-Meleon/76.0"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
    ...
    assert.strictEqual(
      browser['Comment'],
      'K-Meleon 76.0',
      "Expected actual \"Comment\" to be 'K-Meleon 76.0' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
