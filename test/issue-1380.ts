...
suite('checking for issue 1380. (8 tests)', function() {
  test('issue-1380-A ["Mozilla/5.0 (Windows Phone 8.1; ARM; Trident/7.0; Touch; rv:11.0; IEMobile/11.0; NOKIA; Lumia 530) like Gecko (compatible; bingbot/2.0; +http://www.bing.com/bingbot.htm)"]', function() {
    ...
    assert.strictEqual(
      browser['Browser'],
      'BingBot',
      "Expected actual \"Browser\" to be 'BingBot' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1380-B ["Mozilla/5.0 (Windows Phone 8.1; ARM; Trident/7.0; Touch; rv:11.0; IEMobile/11.0; NOKIA; Lumia 530) like Gecko BingPreview/1.0b"]', function() {
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Comment\" to be 'BingPreview for Windows Phone 1.0b' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1380-C ["Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/46.0.2486.0 Safari/537.36 Edge/13.11098 BingPreview/1.0b"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/46.0.2486.0 Safari/537.36 Edge/13.11098 BingPreview/1.0b'
    );
  ...
  test('issue-1380-F ["Mozilla/5.0 (compatible; WebHistoryBot/1.2.1 IS NOT SE bot like Googlebot/2.1; +http://www.google.com/bot.html,Yahoo! Slurp or Bingbot)"]', function() {
    ...
    assert.strictEqual(
      browser['Browser'],
      'WebHistoryBot',
      "Expected actual \"Browser\" to be 'WebHistoryBot' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1380-G ["Mozilla/5.0 (Windows NT 6.3; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/54.0.2840.99 Safari/537.36 (BingLocalSearch)"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (Windows NT 6.3; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/54.0.2840.99 Safari/537.36 (BingLocalSearch)'
    );

    assert.strictEqual(
      browser['Comment'],
      'Bing Local Search Bot',
      "Expected actual \"Comment\" to be 'Bing Local Search Bot' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser'],
      'Bing Local Search Bot',
      "Expected actual \"Browser\" to be 'Bing Local Search Bot' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1380-H ["BingAdsAdInsight"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser('BingAdsAdInsight');
    ...
    assert.strictEqual(
      browser['Browser'],
      'Bing Ads AdInsight Bot',
      "Expected actual \"Browser\" to be 'Bing Ads AdInsight Bot' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
