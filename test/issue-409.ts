...
suite('checking for issue 409. (1 test)', function() {
  test('issue-409 ["CRAZYWEBCRAWLER 0.9.0, http://www.crazywebcrawler.com"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Crazywebcrawler',
      "Expected actual \"Comment\" to be 'Crazywebcrawler' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
    ...
    assert.strictEqual(
      browser['Browser'],
      'Crazywebcrawler',
      "Expected actual \"Browser\" to be 'Crazywebcrawler' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'crazywebcrawler.com',
      "Expected actual \"Browser_Maker\" to be 'crazywebcrawler.com' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
