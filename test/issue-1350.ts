...
suite('checking for issue 1350. (18 tests)', function() {
  test('issue-1350-A ["Mozilla/5.0 (Mobile; OPENC; rv:40.0) Gecko/40.0 Firefox/40.0"]', function() {
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Comment\" to be 'Firefox 40.0 for FirefoxOS 2.2' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'Open C',
      "Expected actual \"Device_Name\" to be 'Open C' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'Open C',
      "Expected actual \"Device_Code_Name\" to be 'Open C' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      '40.0',
      "Expected actual \"RenderingEngine_Version\" to be '40.0' (was '" +
        browser['RenderingEngine_Version'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1350-B ["Mozilla/5.0 (Mobile; OPENC; rv:41.0) Gecko/41.0 Firefox/41.0"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (Mobile; OPENC; rv:41.0) Gecko/41.0 Firefox/41.0'
    );

    assert.strictEqual(
      browser['Comment'],
      'Firefox 41.0 for FirefoxOS 2.2',
      "Expected actual \"Comment\" to be 'Firefox 41.0 for FirefoxOS 2.2' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['RenderingEngine_Version'],
      '41.0',
      "Expected actual \"RenderingEngine_Version\" to be '41.0' (was '" +
        browser['RenderingEngine_Version'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1350-C ["Mozilla/5.0 (Mobile; OPENC; rv:42.0) Gecko/42.0 Firefox/42.0"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (Mobile; OPENC; rv:42.0) Gecko/42.0 Firefox/42.0'
    );

    assert.strictEqual(
      browser['Comment'],
      'Firefox 42.0 for FirefoxOS 2.2',
      "Expected actual \"Comment\" to be 'Firefox 42.0 for FirefoxOS 2.2' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['RenderingEngine_Version'],
      '42.0',
      "Expected actual \"RenderingEngine_Version\" to be '42.0' (was '" +
        browser['RenderingEngine_Version'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1350-D ["Mozilla/5.0 (Mobile; OPENC; rv:43.0) Gecko/43.0 Firefox/43.0"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (Mobile; OPENC; rv:43.0) Gecko/43.0 Firefox/43.0'
    );

    assert.strictEqual(
      browser['Comment'],
      'Firefox 43.0 for FirefoxOS 2.2',
      "Expected actual \"Comment\" to be 'Firefox 43.0 for FirefoxOS 2.2' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1350-E ["Mozilla/5.0 (Mobile; OPENC; rv:44.0) Gecko/44.0 Firefox/44.0"]', function() {
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Comment\" to be 'Firefox 44.0 for FirefoxOS 2.5' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Platform_Version'],
      '2.5',
      "Expected actual \"Platform_Version\" to be '2.5' (was '" +
        browser['Platform_Version'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['RenderingEngine_Version'],
      '44.0',
      "Expected actual \"RenderingEngine_Version\" to be '44.0' (was '" +
        browser['RenderingEngine_Version'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1350-F ["Mozilla/5.0 (Mobile; OPENC; rv:45.0) Gecko/45.0 Firefox/45.0"]', function() {
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Comment\" to be 'Firefox 45.0 for FirefoxOS 2.5' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1350-G ["Mozilla/5.0 (Mobile; OPENC; rv:48.0) Gecko/48.0 Firefox/48.0"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (Mobile; OPENC; rv:48.0) Gecko/48.0 Firefox/48.0'
    );

    assert.strictEqual(
      browser['Comment'],
      'Firefox 48.0 for FirefoxOS 2.5',
      "Expected actual \"Comment\" to be 'Firefox 48.0 for FirefoxOS 2.5' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1350-H ["Mozilla/5.0 (Mobile; OPENC; rv:49.0) Gecko/49.0 Firefox/49.0"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (Mobile; OPENC; rv:49.0) Gecko/49.0 Firefox/49.0'
    );

    assert.strictEqual(
      browser['Comment'],
      'Firefox 49.0 for FirefoxOS 2.5',
      "Expected actual \"Comment\" to be 'Firefox 49.0 for FirefoxOS 2.5' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1350-I ["Mozilla/5.0 (Mobile; OPENC; rv:37.0) Gecko/37.0 Firefox/37.0"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (Mobile; OPENC; rv:37.0) Gecko/37.0 Firefox/37.0'
    );

    assert.strictEqual(
      browser['Comment'],
      'Firefox 37.0 for FirefoxOS 2.2',
      "Expected actual \"Comment\" to be 'Firefox 37.0 for FirefoxOS 2.2' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1350-J ["Mozilla/5.0 (Mobile; Orange KLIF; rv:32.0) Gecko/32.0 Firefox/32.0"]', function() {
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Comment\" to be 'Firefox 32.0 for FirefoxOS 2.0' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'Klif',
      "Expected actual \"Device_Name\" to be 'Klif' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Code_Name'],
      'Klif',
      "Expected actual \"Device_Code_Name\" to be 'Klif' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Brand_Name'],
      'Orange',
      "Expected actual \"Device_Brand_Name\" to be 'Orange' (was '" +
        browser['Device_Brand_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1350-K ["Mozilla/5.0 (Mobile; Orange KLIFD; rv:32.0) Gecko/32.0 Firefox/32.0"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (Mobile; Orange KLIFD; rv:32.0) Gecko/32.0 Firefox/32.0'
    );
  ...
  test('issue-1350-L ["Mozilla/5.0 (Mobile; OPENC; rv:33.0) Gecko/33.0 Firefox/33.0"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (Mobile; OPENC; rv:33.0) Gecko/33.0 Firefox/33.0'
    );

    assert.strictEqual(
      browser['Comment'],
      'Firefox 33.0 for FirefoxOS 2.0',
      "Expected actual \"Comment\" to be 'Firefox 33.0 for FirefoxOS 2.0' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1350-N ["Mozilla/5.0 (Mobile; ALCATELOneTouch6015X SVN:01004P MMS:1.1; rv:28.0) Gecko/28.0 Firefox/28.0"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Firefox 28.0 for FirefoxOS 1.3',
      "Expected actual \"Comment\" to be 'Firefox 28.0 for FirefoxOS 1.3' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Platform_Version'],
      '1.3',
      "Expected actual \"Platform_Version\" to be '1.3' (was '" +
        browser['Platform_Version'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'One Touch Fire E',
      "Expected actual \"Device_Name\" to be 'One Touch Fire E' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Code_Name'],
      'OT-6015X',
      "Expected actual \"Device_Code_Name\" to be 'OT-6015X' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['RenderingEngine_Version'],
      '28.0',
      "Expected actual \"RenderingEngine_Version\" to be '28.0' (was '" +
        browser['RenderingEngine_Version'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1350-O ["Mozilla/5.0 (Mobile; ALCATELOneTouch4019A; rv:28.0) Gecko/28.0 Firefox/28.0"]', function() {
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'One Touch Fire C',
      "Expected actual \"Device_Name\" to be 'One Touch Fire C' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Code_Name'],
      'OT-4019A',
      "Expected actual \"Device_Code_Name\" to be 'OT-4019A' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1350-P ["Mozilla/5.0 (Mobile; OneTouch4019A; rv:28.0) Gecko/28.0 Firefox/28.0"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (Mobile; OneTouch4019A; rv:28.0) Gecko/28.0 Firefox/28.0'
    );
  ...
  test('issue-1350-Q ["Mozilla/5.0 (Mobile; OPEN2; rv:28.0) Gecko/28.0 Firefox/28.0"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (Mobile; OPEN2; rv:28.0) Gecko/28.0 Firefox/28.0'
    );
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'Open 2',
      "Expected actual \"Device_Name\" to be 'Open 2' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Code_Name'],
      'Open 2',
      "Expected actual \"Device_Code_Name\" to be 'Open 2' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
