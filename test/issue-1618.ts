...
suite('checking for issue 1618. (2 tests)', function() {
  test('issue-1618-A ["CamelHttpStream/1.0 Evolution/3.2.3"]', function() {
    ...
    let browser = browscap.getBrowser('CamelHttpStream/1.0 Evolution/3.2.3');

    assert.strictEqual(
      browser['Comment'],
      'Evolution 3.2',
      "Expected actual \"Comment\" to be 'Evolution 3.2' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
    ...
    assert.strictEqual(
      browser['Browser'],
      'Evolution',
      "Expected actual \"Browser\" to be 'Evolution' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1618-B ["Evolution/3.26.1"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser('Evolution/3.26.1');

    assert.strictEqual(
      browser['Comment'],
      'Evolution 3.26',
      "Expected actual \"Comment\" to be 'Evolution 3.26' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Version'],
      '3.26',
      "Expected actual \"Version\" to be '3.26' (was '" +
        browser['Version'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
