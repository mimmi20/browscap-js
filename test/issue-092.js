...
suite('checking for issue 092. (2 tests)', function () {
  test('issue-092-B ["Mozilla/5.0 (Series40; Nokia306/03.63; Profile/MIDP-2.1 Configuration/CLDC-1.1) Gecko/20100401 S40OviBrowser/3.9.0.0.22"]', function () {
    ...
    assert.strictEqual(browser['Device_Name'], 'Asha 306', 'Expected actual "Device_Name" to be \'Asha 306\' (was \'' + browser['Device_Name'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
    ...
    assert.strictEqual(browser['Device_Code_Name'], '306', 'Expected actual "Device_Code_Name" to be \'306\' (was \'' + browser['Device_Code_Name'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
