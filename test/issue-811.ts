...
suite('checking for issue 811. (14 tests)', function() {
  test('issue-811-A ["Mozilla/5.0 (compatible; Scopia Crawler 1.2; +http://www.scopia.co)"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Scopia Crawler',
      "Expected actual \"Comment\" to be 'Scopia Crawler' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
    ...
    assert.strictEqual(
      browser['Browser'],
      'Scopia Crawler',
      "Expected actual \"Browser\" to be 'Scopia Crawler' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'Pagedesign GmbH',
      "Expected actual \"Browser_Maker\" to be 'Pagedesign GmbH' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-811-B ["Mozilla/5.0 (Windows NT 6.3; Win64; x64; rv:26.0.0b2) Goanna/20150828 Gecko/20100101 AppleWebKit/601.1.37 (KHTML, like Gecko) Version/9.0 Safari/601.1.37 PaleMoon/26.0.0b2"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'PaleMoon 26.0',
      "Expected actual \"Comment\" to be 'PaleMoon 26.0' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-811-D ["Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:43.0) Gecko/20100101 Firefox/43.0"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Firefox 43.0',
      "Expected actual \"Comment\" to be 'Firefox 43.0' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-811-F ["Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:44.0) Gecko/20100101 Firefox/44.0"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Firefox 44.0',
      "Expected actual \"Comment\" to be 'Firefox 44.0' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-811-J ["Mozilla/4.0 (compatible; MSIE 5.5;Windows NT)"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'IE 5.5',
      "Expected actual \"Comment\" to be 'IE 5.5' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-811-L ["Mozilla/5.0 (Unknown; Linux x86_64) AppleWebKit/538.1 (KHTML, like Gecko) PhantomJS/2.0.1-development Safari/538.1"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'PhantomJS 2.0',
      "Expected actual \"Comment\" to be 'PhantomJS 2.0' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-811-O ["fastbot crawler beta 4.0 (+http://www.fastbot.de)"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'fastbot crawler',
      "Expected actual \"Comment\" to be 'fastbot crawler' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser'],
      'fastbot crawler',
      "Expected actual \"Browser\" to be 'fastbot crawler' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
