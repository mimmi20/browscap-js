...
suite('checking for issue 266. (1 test)', function () {
  test('issue-266 ["Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:32.0) Gecko/20100101 Firefox/32.0"]', function () {
    const browscap = new Browscap();
    const browser = browscap.getBrowser('Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:32.0) Gecko/20100101 Firefox/32.0');

    assert.strictEqual(browser['Comment'], 'Firefox 32.0', 'Expected actual "Comment" to be \'Firefox 32.0\' (was \'' + browser['Comment'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
