...
suite('checking for issue 627. (1 test)', function () {
  test('issue-627 ["dv(GT-S6102);pr(UCBrowser/9.8.5.442);ov(Android 2.3.6);ss(240*301);bt(GJ);pm(1);bv(0);nm(0);im(0);sr(0);nt(2);"]', function () {
    ...
    assert.strictEqual(browser['Device_Name'], 'Galaxy Y Duos', 'Expected actual "Device_Name" to be \'Galaxy Y Duos\' (was \'' + browser['Device_Name'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
    ...
    assert.strictEqual(browser['Device_Code_Name'], 'GT-S6102', 'Expected actual "Device_Code_Name" to be \'GT-S6102\' (was \'' + browser['Device_Code_Name'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
