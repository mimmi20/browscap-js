...
suite('checking for issue 902.', function () {
  test('issue-902-A ["Microsoft Office/16.0 (Microsoft Outlook Mail 16.0.6416; Pro)"]', function () {
    ...
    assert.strictEqual(browser['MajorVer'], '2016', 'Expected actual "MajorVer" to be \'2016\' (was \'' + browser['MajorVer'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
