...
suite('checking for issue 1663. (1 test)', function () {
  test('issue-1663-A ["Mozilla/5.0 (rv:38) Thunderbird/MSSante-1.2.0"]', function () {
    const browscap = new Browscap();
    const browser = browscap.getBrowser('Mozilla/5.0 (rv:38) Thunderbird/MSSante-1.2.0');

    assert.strictEqual(browser['Comment'], 'Thunderbird for MSSante', 'Expected actual "Comment" to be \'Thunderbird for MSSante\' (was \'' + browser['Comment'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
