...
suite('checking for issue 291. (6 tests)', function() {
  test('issue-291-A ["Browsershots"]', function() {
    ...
    let browser = browscap.getBrowser('Browsershots');
    ...
    assert.strictEqual(
      browser['Browser'],
      'Browsershots',
      "Expected actual \"Browser\" to be 'Browsershots' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'browsershots.org',
      "Expected actual \"Browser_Maker\" to be 'browsershots.org' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-291-B ["DomainSCAN"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser('DomainSCAN');

    assert.strictEqual(
      browser['Comment'],
      'DomainScan Server Monitoring',
      "Expected actual \"Comment\" to be 'DomainScan Server Monitoring' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser'],
      'DomainScan Server Monitoring',
      "Expected actual \"Browser\" to be 'DomainScan Server Monitoring' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser_Maker'],
      'GH Software',
      "Expected actual \"Browser_Maker\" to be 'GH Software' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-291-C ["Dillo/2.1.1"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser('Dillo/2.1.1');

    assert.strictEqual(
      browser['Comment'],
      'Dillo 2.1',
      "Expected actual \"Comment\" to be 'Dillo 2.1' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-291-D ["revolt"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser('revolt');
    ...
    assert.strictEqual(
      browser['Browser'],
      'Bot Revolt',
      "Expected actual \"Browser\" to be 'Bot Revolt' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser_Maker'],
      'Bot Revolt',
      "Expected actual \"Browser_Maker\" to be 'Bot Revolt' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-291-E ["Mozilla/5.0 (Linux i686) AppleWebKit/535.22+ (KHTML, like Gecko) WebKitGTK+/1.8.0 luakit"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'luakit',
      "Expected actual \"Comment\" to be 'luakit' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser'],
      'luakit',
      "Expected actual \"Browser\" to be 'luakit' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser_Maker'],
      'Mason Larobina',
      "Expected actual \"Browser_Maker\" to be 'Mason Larobina' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-291-F ["Cloud mapping experiment. Contact research@pdrlabs.net"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Research Projects',
      "Expected actual \"Comment\" to be 'Research Projects' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser'],
      'pdrlabs Bot',
      "Expected actual \"Browser\" to be 'pdrlabs Bot' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser_Maker'],
      'pdrlabs.net',
      "Expected actual \"Browser_Maker\" to be 'pdrlabs.net' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
