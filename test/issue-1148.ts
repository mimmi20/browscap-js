...
suite('checking for issue 1148. (1 test)', function() {
  test('issue-1148 ["Mozilla/5.0 (Linux; Android 6.0.1; ATH-AL00 Build/HONORATH-AL00; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/53.0.2785.124 Mobile Safari/537.36 JsKit/1.0 (Android) SohuNews/5.7.3 BuildCode/113"]', function() {
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Comment\" to be 'SohuNews App 5.7 for Android' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
    ...
    assert.strictEqual(
      browser['Browser'],
      'SohuNews App',
      "Expected actual \"Browser\" to be 'SohuNews App' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'Sohu.com Inc.',
      "Expected actual \"Browser_Maker\" to be 'Sohu.com Inc.' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'Honor 7i',
      "Expected actual \"Device_Name\" to be 'Honor 7i' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'ATH-AL00',
      "Expected actual \"Device_Code_Name\" to be 'ATH-AL00' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
