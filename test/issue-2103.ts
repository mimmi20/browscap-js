...
suite('checking for issue 2103. (1 test)', function() {
  test('issue-2103-A ["Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/75.0.3770.80 Safari/537.36"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Chrome 75.0',
      "Expected actual \"Comment\" to be 'Chrome 75.0' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
