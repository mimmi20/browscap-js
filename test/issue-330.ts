...
suite('checking for issue 330. (10 tests)', function() {
  test('issue-330-A ["Instagram 4.2.5 (iPad3,6; iPhone OS 7_0_6; en_US; en) AppleWebKit/420+"]', function() {
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Comment\" to be 'Instagram App 4.2 for iOS' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
  ...
  test('issue-330-B ["Instagram 6.0.1 (iPad3,4; iPhone OS 7_0_3; en_AU; en-GB) AppleWebKit/420+"]', function() {
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Comment\" to be 'Instagram App 6.0 for iOS' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-330-C ["Instagram 4.1.0 (iPad3,3; iPhone OS 6_1_3; en_US; en) AppleWebKit/420+"]', function() {
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Comment\" to be 'Instagram App 4.1 for iOS' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
