...
suite('checking for issue 1668. (1 test)', function () {
  test('issue-1668 ["ZoomBot (Linkbot 1.0 http://suite.seozoom.it/bot.html)"]', function () {
    ...
    assert.strictEqual(browser['Browser_Maker'], 'SEO Cube S.r.l.', 'Expected actual "Browser_Maker" to be \'SEO Cube S.r.l.\' (was \'' + browser['Browser_Maker'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
