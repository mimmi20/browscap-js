...
suite('checking for issue 1646. (1 test)', function() {
  test('issue-1646-A ["Athens15_TD/V2 Linux/3.0.13 Android/5.1 andy_5EI3 Release/02.15.2012 Browser/AppleWebKit534.30 Mobile Safari/534.30 System/Android 5.1;"]', function() {
    ...
    let browser = browscap.getBrowser(
      'Athens15_TD/V2 Linux/3.0.13 Android/5.1 andy_5EI3 Release/02.15.2012 Browser/AppleWebKit534.30 Mobile Safari/534.30 System/Android 5.1;'
    );
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'Andy 5EI3',
      "Expected actual \"Device_Name\" to be 'Andy 5EI3' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'Yezz',
      "Expected actual \"Device_Maker\" to be 'Yezz' (was '" +
        browser['Device_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'Andy 5EI3',
      "Expected actual \"Device_Code_Name\" to be 'Andy 5EI3' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'Yezz',
      "Expected actual \"Device_Brand_Name\" to be 'Yezz' (was '" +
        browser['Device_Brand_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
