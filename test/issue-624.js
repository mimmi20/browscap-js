...
suite('checking for issue 624.', function () {
  test('issue-624-A', function () {
    ...
    assert.strictEqual(browser['Device_Name'], 'G Vista (Verizon)');
    assert.strictEqual(browser['Device_Maker'], 'LG');
    assert.strictEqual(browser['Device_Type'], 'Mobile Phone');
    assert.strictEqual(browser['Device_Pointing_Method'], 'touchscreen');
    assert.strictEqual(browser['Device_Code_Name'], 'VS880');
