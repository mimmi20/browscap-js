...
suite('checking for issue 2044. (1 test)', function () {
  test('issue-2044-A ["Mozilla/5.0 (Linux; Android 8.0.0; SAMSUNG SM-G965F/G965FXXS2BRK3 Build/R16NW) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/8.2 Chrome/63.0.3239.111 Mobile Safari/537.36"]', function () {
    const browscap = new Browscap();
    const browser = browscap.getBrowser('Mozilla/5.0 (Linux; Android 8.0.0; SAMSUNG SM-G965F/G965FXXS2BRK3 Build/R16NW) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/8.2 Chrome/63.0.3239.111 Mobile Safari/537.36');

    assert.strictEqual(browser['Comment'], 'Samsung Browser 8.2', 'Expected actual "Comment" to be \'Samsung Browser 8.2\' (was \'' + browser['Comment'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
    ...
    assert.strictEqual(browser['Device_Name'], 'Galaxy S9+', 'Expected actual "Device_Name" to be \'Galaxy S9+\' (was \'' + browser['Device_Name'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
    ...
    assert.strictEqual(browser['Device_Code_Name'], 'SM-G965F', 'Expected actual "Device_Code_Name" to be \'SM-G965F\' (was \'' + browser['Device_Code_Name'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
