...
suite('checking for issue 526. (2 tests)', function() {
  test('issue-526-A ["bot-pge.chlooe.com/1.0.0 (+http://www.chlooe.com/)"]', function() {
    ...
    assert.strictEqual(
      browser['Browser'],
      'chlooe Bot',
      "Expected actual \"Browser\" to be 'chlooe Bot' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'AsiaWS network',
      "Expected actual \"Browser_Maker\" to be 'AsiaWS network' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-526-B ["seebot/2.0 (+http://www.seegnify.com/bot)"]', function() {
    ...
    assert.strictEqual(
      browser['Browser'],
      'SeeBot',
      "Expected actual \"Browser\" to be 'SeeBot' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser_Maker'],
      'Seegnify',
      "Expected actual \"Browser_Maker\" to be 'Seegnify' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
