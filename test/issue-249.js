...
suite('checking for issue 249. (1 test)', function () {
  test('issue-249 ["Mozilla/5.0 (FHScan Core 1.1)"]', function () {
    ...
    assert.strictEqual(browser['Browser_Maker'], 'tarasco.org', 'Expected actual "Browser_Maker" to be \'tarasco.org\' (was \'' + browser['Browser_Maker'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
