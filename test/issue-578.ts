...
suite('checking for issue 578. (2 tests)', function() {
  test('issue-578-A ["check_http/v1.4.16 (nagios-plugins 1.4.16)"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Nagios',
      "Expected actual \"Comment\" to be 'Nagios' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
    ...
    assert.strictEqual(
      browser['Browser'],
      'Nagios',
      "Expected actual \"Browser\" to be 'Nagios' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Browser_Maker\" to be 'Nagios Enterprises, LLC.' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-578-B ["check_http/v2.0 (nagios-plugins 2.0)"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser('check_http/v2.0 (nagios-plugins 2.0)');
