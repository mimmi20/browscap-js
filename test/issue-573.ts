...
suite('checking for issue 573. (19 tests)', function() {
  test('issue-573-A ["Microsoft Office Word 2013 (15.0.4693) Windows NT 6.2"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Microsoft Word',
      "Expected actual \"Comment\" to be 'Microsoft Word' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
    ...
    assert.strictEqual(
      browser['Browser'],
      'Word',
      "Expected actual \"Browser\" to be 'Word' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-573-E ["Microsoft Office OneNote 2013"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser('Microsoft Office OneNote 2013');

    assert.strictEqual(
      browser['Comment'],
      'Microsoft OneNote',
      "Expected actual \"Comment\" to be 'Microsoft OneNote' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser'],
      'OneNote',
      "Expected actual \"Browser\" to be 'OneNote' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-573-G ["Microsoft Office Outlook 2013 (15.0.4693) Windows NT 6.2"]', function() {
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Comment\" to be 'Microsoft Outlook 2013' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-573-I ["Microsoft Office PowerPoint 2013 (15.0.4693) Windows NT 6.2"]', function() {
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Comment\" to be 'Microsoft PowerPoint' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser'],
      'PowerPoint',
      "Expected actual \"Browser\" to be 'PowerPoint' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-573-K ["Microsoft Office Visio 2013 (15.0.4693) Windows NT 6.2"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Microsoft Visio',
      "Expected actual \"Comment\" to be 'Microsoft Visio' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser'],
      'Visio',
      "Expected actual \"Browser\" to be 'Visio' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-573-M ["Microsoft Office/15.0 (Windows NT 6.2; Access Web Datasheet 15.0.4693; Pro)"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Microsoft Access',
      "Expected actual \"Comment\" to be 'Microsoft Access' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser'],
      'Access',
      "Expected actual \"Browser\" to be 'Access' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-573-O ["Microsoft Office/15.0 (Windows NT 6.2; Microsoft Lync 15.0.4675; Pro)"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Microsoft Lync',
      "Expected actual \"Comment\" to be 'Microsoft Lync' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser'],
      'Lync',
      "Expected actual \"Browser\" to be 'Lync' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-573-P ["MSFrontPage/15.0"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser('MSFrontPage/15.0');

    assert.strictEqual(
      browser['Comment'],
      'Microsoft FrontPage',
      "Expected actual \"Comment\" to be 'Microsoft FrontPage' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser'],
      'FrontPage',
      "Expected actual \"Browser\" to be 'FrontPage' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-573-Q ["Microsoft Office SyncProc 2013 (15.0.4693) Windows NT 6.2"]', function() {
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Comment\" to be 'Microsoft Office SyncProc' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser'],
      'Office SyncProc',
      "Expected actual \"Browser\" to be 'Office SyncProc' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-573-R ["Microsoft Office Upload Center 2013 (15.0.4693) Windows NT 6.2"]', function() {
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Comment\" to be 'Microsoft Office Upload Center' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Browser\" to be 'Office Upload Center' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-573-S ["non-browser; Microsoft Office/15.0 (Windows NT 6.2; 15.0.4691; Pro)"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Microsoft Office',
      "Expected actual \"Comment\" to be 'Microsoft Office' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
