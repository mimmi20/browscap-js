...
suite('checking for issue 1428. (2 tests)', function () {
  test('issue-1428-A ["LG-GS290/V100 Obigo/WAP2.0 Profile/MIDP-2.1 Configuration/CLDC-1.1"]', function () {
    ...
    assert.strictEqual(browser['Device_Name'], 'Cookie Fresh', 'Expected actual "Device_Name" to be \'Cookie Fresh\' (was \'' + browser['Device_Name'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
    ...
    assert.strictEqual(browser['Device_Code_Name'], 'GS290', 'Expected actual "Device_Code_Name" to be \'GS290\' (was \'' + browser['Device_Code_Name'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
