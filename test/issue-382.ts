...
suite('checking for issue 382. (1 test)', function() {
  test('issue-382 ["iOS/6.1.3 (10B329) dataaccessd/1.0"]', function() {
    ...
    let browser = browscap.getBrowser('iOS/6.1.3 (10B329) dataaccessd/1.0');

    assert.strictEqual(
      browser['Comment'],
      'iOS dataaccessd',
      "Expected actual \"Comment\" to be 'iOS dataaccessd' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
    ...
    assert.strictEqual(
      browser['Browser'],
      'iOS dataaccessd',
      "Expected actual \"Browser\" to be 'iOS dataaccessd' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
