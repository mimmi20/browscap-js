...
suite('checking for issue 1244. (1 test)', function() {
  test('issue-1244 ["RedFlagDealsApp/3.7.2 (Linux; U; Android 4.1.1; en-ca; Arc Build/JRO03L) AppleWebKit/534.30 (KHTML, like Gecko) Version/4.0 Safari/534.30"]', function() {
    ...
    let browser = browscap.getBrowser(
      'RedFlagDealsApp/3.7.2 (Linux; U; Android 4.1.1; en-ca; Arc Build/JRO03L) AppleWebKit/534.30 (KHTML, like Gecko) Version/4.0 Safari/534.30'
    );

    assert.strictEqual(
      browser['Comment'],
      'RedFlagDeals Mobile App',
      "Expected actual \"Comment\" to be 'RedFlagDeals Mobile App' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
    ...
    assert.strictEqual(
      browser['Browser'],
      'RedFlagDeals Mobile App',
      "Expected actual \"Browser\" to be 'RedFlagDeals Mobile App' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Browser_Maker\" to be 'Yellow Pages Digital & Media Solutions Limited' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'Arc',
      "Expected actual \"Device_Name\" to be 'Arc' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'Kobo',
      "Expected actual \"Device_Maker\" to be 'Kobo' (was '" +
        browser['Device_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'Arc',
      "Expected actual \"Device_Code_Name\" to be 'Arc' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'Kobo',
      "Expected actual \"Device_Brand_Name\" to be 'Kobo' (was '" +
        browser['Device_Brand_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
