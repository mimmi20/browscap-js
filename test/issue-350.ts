...
suite('checking for issue 350. (6 tests)', function() {
  test('issue-350-A ["Mozilla/5.0 (compatible; XoviBot/2.0; +http://www.xovibot.net/)"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'XoviBot',
      "Expected actual \"Comment\" to be 'XoviBot' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
    ...
    assert.strictEqual(
      browser['Browser'],
      'XoviBot',
      "Expected actual \"Browser\" to be 'XoviBot' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'Xovi GmbH',
      "Expected actual \"Browser_Maker\" to be 'Xovi GmbH' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-350-B ["Mozilla/5.0 (compatible; 007ac9 Crawler; http://crawler.007ac9.net/)"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Sistrix Crawler',
      "Expected actual \"Comment\" to be 'Sistrix Crawler' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser'],
      '007AC9 Crawler',
      "Expected actual \"Browser\" to be '007AC9 Crawler' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser_Maker'],
      'SISTRIX GmbH',
      "Expected actual \"Browser_Maker\" to be 'SISTRIX GmbH' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-350-C ["Mozilla/5.0 (compatible; AOLbot/4.0; +http://www.aol-soft.com/)"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'AOLbot',
      "Expected actual \"Comment\" to be 'AOLbot' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser'],
      'AOLbot',
      "Expected actual \"Browser\" to be 'AOLbot' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser_Maker'],
      'AOL-SOFT.COM',
      "Expected actual \"Browser_Maker\" to be 'AOL-SOFT.COM' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-350-D ["Go 1.1 package http"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser('Go 1.1 package http');

    assert.strictEqual(
      browser['Comment'],
      'HttpClient for Google Go Programming Language',
      "Expected actual \"Comment\" to be 'HttpClient for Google Go Programming Language' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser'],
      'GO HttpClient',
      "Expected actual \"Browser\" to be 'GO HttpClient' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-350-F ["Proxy Gear Pro/2.1 (Windows; N; Windows NT 6.1; en)"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Proxy Gear Pro',
      "Expected actual \"Comment\" to be 'Proxy Gear Pro' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser'],
      'Proxy Gear Pro',
      "Expected actual \"Browser\" to be 'Proxy Gear Pro' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser_Maker'],
      'proxy-base.org',
      "Expected actual \"Browser_Maker\" to be 'proxy-base.org' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
