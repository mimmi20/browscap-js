...
suite('checking for issue 1271. (9 tests)', function() {
  test('issue-1271-A ["Mozilla/5.0 (Nintendo Switch; ShareApplet) AppleWebKit/601.6 (KHTML, like Gecko) NF/4.0.0.5.9 NintendoBrowser/5.1.0.13341"]', function() {
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Comment\" to be 'Nintendo Browser 5.1' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
    ...
    assert.strictEqual(
      browser['Platform'],
      'Nintendo Switch',
      "Expected actual \"Platform\" to be 'Nintendo Switch' (was '" +
        browser['Platform'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Platform_Description\" to be 'Nintendo Switch System Software' (was '" +
        browser['Platform_Description'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'Switch',
      "Expected actual \"Device_Name\" to be 'Switch' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'Switch',
      "Expected actual \"Device_Code_Name\" to be 'Switch' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1271-B ["Mozilla/5.0 (Windows NT 10.0; Win64; x64; Xbox; Xbox One) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/51.0.2704.79 Safari/537.36 Edge/14.14393"]', function() {
    ...
    assert.strictEqual(
      browser['Platform'],
      'Xbox OS 10',
      "Expected actual \"Platform\" to be 'Xbox OS 10' (was '" +
        browser['Platform'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1271-C ["Mozilla/5.0 (compatible; MSIE 9.0; Windows Phone OS 7.5; Trident/5.0; IEMobile/9.0; Xbox)"]', function() {
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Platform\" to be 'Xbox 360 (Mobile View)' (was '" +
        browser['Platform'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Platform_Description\" to be 'Xbox 360 System Software' (was '" +
        browser['Platform_Description'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'Xbox 360',
      "Expected actual \"Device_Name\" to be 'Xbox 360' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Code_Name'],
      'Xbox 360',
      "Expected actual \"Device_Code_Name\" to be 'Xbox 360' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1271-E ["Mozilla/4.0 (compatible; MSIE 7.0; Windows NT 6.1; Trident/3.1; Xbox)"]', function() {
    ...
    assert.strictEqual(
      browser['Platform'],
      'Xbox 360',
      "Expected actual \"Platform\" to be 'Xbox 360' (was '" +
        browser['Platform'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1271-F ["Mozilla/4.0 (compatible; MSIE 7.0; Windows NT 6.2; Trident/3.1; Xbox; Xbox One)"]', function() {
    ...
    assert.strictEqual(
      browser['Platform'],
      'Xbox OS',
      "Expected actual \"Platform\" to be 'Xbox OS' (was '" +
        browser['Platform'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Platform_Description\" to be 'Xbox One System Software' (was '" +
        browser['Platform_Description'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1271-H ["Mozilla/5.0 (compatible; MSIE 10.0; Windows Phone 8.0; Trident/6.0; IEMobile/10.0; Xbox; Xbox One)"]', function() {
    ...
    assert.strictEqual(
      browser['Platform'],
      'Xbox OS (Mobile View)',
      "Expected actual \"Platform\" to be 'Xbox OS (Mobile View)' (was '" +
        browser['Platform'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
