...
suite('checking for issue 270. (3 tests)', function() {
  test('issue-270-A ["Mozilla/5.0 (compatible; Alexabot/1.0; +http://www.alexa.com/help/certifyscan; certifyscan@alexa.com)"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Alexabot',
      "Expected actual \"Comment\" to be 'Alexabot' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
    ...
    assert.strictEqual(
      browser['Browser'],
      'Alexabot',
      "Expected actual \"Browser\" to be 'Alexabot' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'Alexa Internet, Inc',
      "Expected actual \"Browser_Maker\" to be 'Alexa Internet, Inc' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-270-C ["Mozilla/4.0 (compatible; MSIE 4.01; Digital AlphaServer 1000A 4/233; Windows NT; Powered By 64-Bit Alpha Processor)"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'IE 4.01',
      "Expected actual \"Comment\" to be 'IE 4.01' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-270-F ["WebTarantula.com Crawler"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser('WebTarantula.com Crawler');
    ...
    assert.strictEqual(
      browser['Browser'],
      'WebTarantula',
      "Expected actual \"Browser\" to be 'WebTarantula' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser_Maker'],
      'webtarantula.com',
      "Expected actual \"Browser_Maker\" to be 'webtarantula.com' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
