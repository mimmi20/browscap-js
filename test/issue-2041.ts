...
suite('checking for issue 2041. (7 tests)', function() {
  test('issue-2041-A ["WinampMPEG/2.8"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser('WinampMPEG/2.8');

    assert.strictEqual(
      browser['Comment'],
      'Winamp',
      "Expected actual \"Comment\" to be 'Winamp' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
    ...
    assert.strictEqual(
      browser['Browser'],
      'WinAmp',
      "Expected actual \"Browser\" to be 'WinAmp' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'Nullsoft',
      "Expected actual \"Browser_Maker\" to be 'Nullsoft' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-2041-B ["Nullsoft Winamp3"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser('Nullsoft Winamp3');
  ...
  test('issue-2041-C ["AlexaMediaPlayer/2.0.204008.0 (Linux;Android 7.1.2) ExoPlayerLib/1.5.9"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'AlexaMediaPlayer/2.0.204008.0 (Linux;Android 7.1.2) ExoPlayerLib/1.5.9'
    );

    assert.strictEqual(
      browser['Comment'],
      'Alexa MediaPlayer',
      "Expected actual \"Comment\" to be 'Alexa MediaPlayer' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser'],
      'Alexa MediaPlayer',
      "Expected actual \"Browser\" to be 'Alexa MediaPlayer' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser_Maker'],
      'Mark Miller',
      "Expected actual \"Browser_Maker\" to be 'Mark Miller' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-2041-D ["Echo/1.0(APNG)"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser('Echo/1.0(APNG)');
    ...
    assert.strictEqual(
      browser['Browser'],
      'Alexa',
      "Expected actual \"Browser\" to be 'Alexa' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-2041-E ["AvsDeviceSdk/1.10.0"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser('AvsDeviceSdk/1.10.0');
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Browser\" to be 'Alexa Voice Service Device SDK' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-2041-F ["Karadio/1.5"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser('Karadio/1.5');
    ...
    assert.strictEqual(
      browser['Browser'],
      'Ka-Radio',
      "Expected actual \"Browser\" to be 'Ka-Radio' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-2041-G ["SA-MP/0.3"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser('SA-MP/0.3');
