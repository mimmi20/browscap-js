...
suite('checking for issue 1804. (1 test)', function() {
  test('issue-1804-A ["Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) QtWebEngine/5.9.3 Chrome/56.0.2924.122 Safari/537.36"]', function() {
    ...
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) QtWebEngine/5.9.3 Chrome/56.0.2924.122 Safari/537.36'
    );

    assert.strictEqual(
      browser['Comment'],
      'QtWebEngine 5.9 for Desktop',
      "Expected actual \"Comment\" to be 'QtWebEngine 5.9 for Desktop' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
