...
suite('checking for issue 1529. (23 tests)', function() {
  test('issue-1529-A ["Mozilla/5.0 (Windows NT 6.1; rv:45.0) Gecko/20100101 Thunderbird/45.5.0"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Thunderbird 45.5',
      "Expected actual \"Comment\" to be 'Thunderbird 45.5' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
    ...
    assert.strictEqual(
      browser['Version'],
      '45.5',
      "Expected actual \"Version\" to be '45.5' (was '" +
        browser['Version'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1529-B ["Mozilla/5.0 (X11; Linux x86_64; rv:45.0) Gecko/20100101 Thunderbird/45.4.0"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Thunderbird 45.4',
      "Expected actual \"Comment\" to be 'Thunderbird 45.4' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Version'],
      '45.4',
      "Expected actual \"Version\" to be '45.4' (was '" +
        browser['Version'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1529-C ["Mozilla/5.0 (Windows; U; Windows NT 5.0; en-US; rv:1.7.10) Gecko/20050716 Thunderbird/1.0.6"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Thunderbird 1.0',
      "Expected actual \"Comment\" to be 'Thunderbird 1.0' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1529-D ["Mozilla/5.0 (X11; Linux x86_64; rv:14.0) Gecko/20120714 Thunderbird/14.0"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Thunderbird 14.0',
      "Expected actual \"Comment\" to be 'Thunderbird 14.0' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['RenderingEngine_Version'],
      '14.0',
      "Expected actual \"RenderingEngine_Version\" to be '14.0' (was '" +
        browser['RenderingEngine_Version'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1529-F ["Mozilla/5.0 (Windows NT 6.0; rv:17.0) Gecko/20130620 Thunderbird/17.0.7"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Thunderbird 17.0',
      "Expected actual \"Comment\" to be 'Thunderbird 17.0' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Version'],
      '17.0',
      "Expected actual \"Version\" to be '17.0' (was '" +
        browser['Version'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['RenderingEngine_Version'],
      '17.0',
      "Expected actual \"RenderingEngine_Version\" to be '17.0' (was '" +
        browser['RenderingEngine_Version'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1529-G ["Mozilla/5.0 (Windows; U; Windows NT 6.0; de; rv:1.8.1.23) Gecko/20090812 Thunderbird/2.0.0.23"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Thunderbird 2.0',
      "Expected actual \"Comment\" to be 'Thunderbird 2.0' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1529-J ["Mozilla/5.0 (Windows NT 6.2; WOW64; rv:24.0) Gecko/20100101 Thunderbird/24.2.0"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Thunderbird 24.2',
      "Expected actual \"Comment\" to be 'Thunderbird 24.2' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Version'],
      '24.2',
      "Expected actual \"Version\" to be '24.2' (was '" +
        browser['Version'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1529-K ["Mozilla/5.0 (Macintosh; Intel Mac OS X 10.9; rv:24.0) Gecko/20100101 Thunderbird/24.6.0"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Thunderbird 24.6',
      "Expected actual \"Comment\" to be 'Thunderbird 24.6' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Version'],
      '24.6',
      "Expected actual \"Version\" to be '24.6' (was '" +
        browser['Version'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1529-L ["Mozilla/5.0 (Windows; U; Windows NT 6.1; de; rv:1.9.2.18) Gecko/20110616 Thunderbird/3.1.11"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Thunderbird 3.1',
      "Expected actual \"Comment\" to be 'Thunderbird 3.1' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1529-M ["Mozilla/5.0 (Windows; U; Windows NT 5.1; ja; rv:1.9.2.8) Gecko/20100802 Thunderbird/3.1.2"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (Windows; U; Windows NT 5.1; ja; rv:1.9.2.8) Gecko/20100802 Thunderbird/3.1.2'
    );
  ...
  test('issue-1529-N ["Mozilla/5.0 (X11; U; Linux i686; en-US; rv:1.9.1.10) Gecko/20100527 Thunderbird/3.0.5"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Thunderbird 3.0',
      "Expected actual \"Comment\" to be 'Thunderbird 3.0' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1529-O ["Mozilla/5.0 (Windows NT 6.1; rv:7.0.1) Gecko/20110929 Thunderbird/7.0.1"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Thunderbird 7.0',
      "Expected actual \"Comment\" to be 'Thunderbird 7.0' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1529-P ["Mozilla/5.0 (Windows NT 10.0; WOW64; rv:45.0) Gecko/20100101 Thunderbird/45.8.0"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Thunderbird 45.8',
      "Expected actual \"Comment\" to be 'Thunderbird 45.8' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Version'],
      '45.8',
      "Expected actual \"Version\" to be '45.8' (was '" +
        browser['Version'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1529-Q ["Mozilla/5.0 (Windows NT 10.0; WOW64; rv:52.0) Gecko/20100101 Thunderbird/52.2.1 Lightning/5.4.2.1"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (Windows NT 10.0; WOW64; rv:52.0) Gecko/20100101 Thunderbird/52.2.1 Lightning/5.4.2.1'
    );

    assert.strictEqual(
      browser['Comment'],
      'Thunderbird 52.2',
      "Expected actual \"Comment\" to be 'Thunderbird 52.2' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Version'],
      '52.2',
      "Expected actual \"Version\" to be '52.2' (was '" +
        browser['Version'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1529-R ["Mozilla/5.0 (Windows NT 6.1; WOW64; rv:52.0) Gecko/20100101 Thunderbird/52.0.1 Lightning/5.4.0.1"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (Windows NT 6.1; WOW64; rv:52.0) Gecko/20100101 Thunderbird/52.0.1 Lightning/5.4.0.1'
    );

    assert.strictEqual(
      browser['Comment'],
      'Thunderbird 52.0',
      "Expected actual \"Comment\" to be 'Thunderbird 52.0' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Version'],
      '52.0',
      "Expected actual \"Version\" to be '52.0' (was '" +
        browser['Version'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1529-S ["Mozilla/5.0 (Windows NT 6.0; WOW64; rv:38.0) Gecko/20100101 Thunderbird/38.3.0 Lightning/4.0.3.1"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (Windows NT 6.0; WOW64; rv:38.0) Gecko/20100101 Thunderbird/38.3.0 Lightning/4.0.3.1'
    );

    assert.strictEqual(
      browser['Comment'],
      'Thunderbird 38.3',
      "Expected actual \"Comment\" to be 'Thunderbird 38.3' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Version'],
      '38.3',
      "Expected actual \"Version\" to be '38.3' (was '" +
        browser['Version'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1529-T ["Mozilla/5.0 (Windows NT 5.1; rv:45.0) Gecko/20100101 Thunderbird/45.8.0 Lightning/4.7.8"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (Windows NT 5.1; rv:45.0) Gecko/20100101 Thunderbird/45.8.0 Lightning/4.7.8'
    );
  ...
  test('issue-1529-U ["Mozilla/5.0 (Macintosh; Intel Mac OS X 10.8; rv:45.0) Gecko/20100101 Thunderbird/45.8.0 Lightning/4.7.8"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (Macintosh; Intel Mac OS X 10.8; rv:45.0) Gecko/20100101 Thunderbird/45.8.0 Lightning/4.7.8'
    );
  ...
  test('issue-1529-V ["Mozilla/5.0 (Macintosh; Intel Mac OS X 10.12; rv:52.0) Gecko/20100101 Thunderbird/52.2.0 Lightning/5.4.2"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (Macintosh; Intel Mac OS X 10.12; rv:52.0) Gecko/20100101 Thunderbird/52.2.0 Lightning/5.4.2'
    );
  ...
  test('issue-1529-W ["Mozilla/5.0 (Windows NT 6.3; rv:31.0) Gecko/20100101 Thunderbird/31.6.0 Lightning/3.3.2"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (Windows NT 6.3; rv:31.0) Gecko/20100101 Thunderbird/31.6.0 Lightning/3.3.2'
    );

    assert.strictEqual(
      browser['Comment'],
      'Thunderbird 31.6',
      "Expected actual \"Comment\" to be 'Thunderbird 31.6' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Version'],
      '31.6',
      "Expected actual \"Version\" to be '31.6' (was '" +
        browser['Version'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['RenderingEngine_Version'],
      '31.0',
      "Expected actual \"RenderingEngine_Version\" to be '31.0' (was '" +
        browser['RenderingEngine_Version'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
