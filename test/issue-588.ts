...
suite('checking for issue 588. (9 tests)', function() {
  test('issue-588-A ["Mozilla/5.0 (compatible; MegaIndex.ru/2.0; +https://www.megaindex.ru/?tab=linkAnalyze)"]', function() {
    ...
    assert.strictEqual(
      browser['Browser'],
      'MegaIndex Bot',
      "Expected actual \"Browser\" to be 'MegaIndex Bot' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'MegaIndex.ru',
      "Expected actual \"Browser_Maker\" to be 'MegaIndex.ru' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-588-B ["Mozilla/5.0 (compatible; Cliqzbot/0.1 +http://cliqz.com/company/cliqzbot)"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Cliqzbot',
      "Expected actual \"Comment\" to be 'Cliqzbot' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser'],
      'Cliqzbot',
      "Expected actual \"Browser\" to be 'Cliqzbot' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser_Maker'],
      '10betterpages GmbH',
      "Expected actual \"Browser_Maker\" to be '10betterpages GmbH' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-588-C ["Mozilla/4.0 (compatible; DAWINCI ANTIPLAG SPIDER)"]', function() {
    ...
    assert.strictEqual(
      browser['Browser'],
      'DAWINCI ANTIPLAG SPIDER',
      "Expected actual \"Browser\" to be 'DAWINCI ANTIPLAG SPIDER' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-588-D ["AccServer[HOGANMIDSCHOOL]/5.0.2.20(24517) 64-bit HTTP-Agent"]', function() {
    ...
    assert.strictEqual(
      browser['Browser'],
      'AccServer',
      "Expected actual \"Browser\" to be 'AccServer' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-588-E ["SafeSearch microdata crawler (https://safesearch.avira.com, safesearch-abuse@avira.com)"]', function() {
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Browser\" to be 'SafeSearch microdata crawler' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-588-F ["Mozilla/5.0 (compatible; AdvBot/2.0; +http://advbot.net/bot.html)"]', function() {
    ...
    assert.strictEqual(
      browser['Browser'],
      'AdvBot',
      "Expected actual \"Browser\" to be 'AdvBot' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser_Maker'],
      'advbot.net',
      "Expected actual \"Browser_Maker\" to be 'advbot.net' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-588-G ["Mozilla/5.0 (compatible; DuckDuckGo-Favicons-Bot/1.0; +http://duckduckgo.com)"]', function() {
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Browser\" to be 'DuckDuck Favicons Bot' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-588-H ["Mozilla/4.0 compatible ZyBorg/1.0"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser('Mozilla/4.0 compatible ZyBorg/1.0');
    ...
    assert.strictEqual(
      browser['Browser'],
      'WiseNut search engine crawler',
      "Expected actual \"Browser\" to be 'WiseNut search engine crawler' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser_Maker'],
      'LookSmart',
      "Expected actual \"Browser_Maker\" to be 'LookSmart' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-588-I ["Mozilla/5.0 (Macintosh; Butterfly/1.0; +http://labs.topsy.com/butterfly/) Gecko/2009032608 Firefox/3.0.8"]', function() {
    ...
    assert.strictEqual(
      browser['Browser'],
      'Butterfly Robot',
      "Expected actual \"Browser\" to be 'Butterfly Robot' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser_Maker'],
      'Topsy Labs',
      "Expected actual \"Browser_Maker\" to be 'Topsy Labs' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
