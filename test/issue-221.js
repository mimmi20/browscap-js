...
suite('checking for issue 221. (1 test)', function () {
  test('issue-221 ["securepoint cf"]', function () {
    const browscap = new Browscap();
    const browser = browscap.getBrowser('securepoint cf');
    ...
    assert.strictEqual(browser['Browser'], 'Securepoint Content Filter', 'Expected actual "Browser" to be \'Securepoint Content Filter\' (was \'' + browser['Browser'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
    ...
    assert.strictEqual(browser['Browser_Maker'], 'Securepoint GmbH', 'Expected actual "Browser_Maker" to be \'Securepoint GmbH\' (was \'' + browser['Browser_Maker'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
