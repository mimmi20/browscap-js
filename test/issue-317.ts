...
suite('checking for issue 317. (41 tests)', function() {
  test('issue-317-A ["Android-Cloud-X2/1.0 Linux/2.6.35.7 Android/2.3 Release/06.17.2013 Browser/AppleWebKit533.1 (KHTML, like Gecko) Mozilla/5.0 Mobile"]', function() {
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Comment\" to be 'Android Browser Generic' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
  ...
  test('issue-317-B ["ultrafone 303 Linux/3.0.13 Android/4.0.4 Release/06.19.2013 Browser/AppleWebKit534.30 Profile/MIDP-2.0 Configuration/CLDC-1.1 Mobile Safari/534.30 Android 4.0.1;"]', function() {
    ...
    assert.strictEqual(
      browser['Device_Name'],
      '303',
      "Expected actual \"Device_Name\" to be '303' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Maker'],
      'ultrafone',
      "Expected actual \"Device_Maker\" to be 'ultrafone' (was '" +
        browser['Device_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Brand_Name'],
      'ultrafone',
      "Expected actual \"Device_Brand_Name\" to be 'ultrafone' (was '" +
        browser['Device_Brand_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-317-E ["MALATA I50 Linux/2.6.35.7 Android/2.3.6 Release/10.10.2012 Browser/AppleWebKit533.1 Profile/MIDP-2.0 Configuration/CLDC-1.1 Mobile Safari/533.1"]', function() {
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'I50',
      "Expected actual \"Device_Name\" to be 'I50' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Maker'],
      'Malata',
      "Expected actual \"Device_Maker\" to be 'Malata' (was '" +
        browser['Device_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Code_Name'],
      'I50',
      "Expected actual \"Device_Code_Name\" to be 'I50' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Brand_Name'],
      'Malata',
      "Expected actual \"Device_Brand_Name\" to be 'Malata' (was '" +
        browser['Device_Brand_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-317-F ["Opera/9.80 (VRE; Opera Mini/4.2/34.1000; U; en) Presto/2.8.119 Version/11.10"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Opera Mini 4.2',
      "Expected actual \"Comment\" to be 'Opera Mini 4.2' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-317-K ["OneBrowser/3.1 (SAMSUNG-GT-S3653/S365MDDIJ1)"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'OneBrowser 3.1',
      "Expected actual \"Comment\" to be 'OneBrowser 3.1' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'GT-S3653',
      "Expected actual \"Device_Name\" to be 'GT-S3653' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Code_Name'],
      'GT-S3653',
      "Expected actual \"Device_Code_Name\" to be 'GT-S3653' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-317-L ["samsung-gt-s5620/UC Browser8.0.3.107/69/444 UNTRUSTED/1.0"]', function() {
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Comment\" to be 'UC Browser 8.0 for Java' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'S5620 Monte',
      "Expected actual \"Device_Name\" to be 'S5620 Monte' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Code_Name'],
      'GT-S5620',
      "Expected actual \"Device_Code_Name\" to be 'GT-S5620' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-317-M ["Z221; Mozilla/5.0 (Profile/MIDP-2.0 Configuration/CLDC-1.1; Opera Mini/att/4.2.22250; U; en-US) Opera 9.50"]', function() {
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'Z221',
      "Expected actual \"Device_Name\" to be 'Z221' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Code_Name'],
      'Z221',
      "Expected actual \"Device_Code_Name\" to be 'Z221' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Brand_Name'],
      'AT&T',
      "Expected actual \"Device_Brand_Name\" to be 'AT&T' (was '" +
        browser['Device_Brand_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-317-N ["Mozilla/5.0 (compatible; MSIE 9.0; Windows NT 6.0; Trident/4.0; GTB7.4; InfoPath.3; SV1; .NET CLR 3.1.76908; WOW64; en-US)"]', function() {
    ...
    assert.strictEqual(
      browser['isModified'],
      true,
      'Expected actual "isModified" to be true (was \'' +
        browser['isModified'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-317-O ["PantechP9020/JEUS04262010; Mozilla/5.0 (Profile/MIDP-2.0 Configuration/CLDC-1.1; Opera Mini/att/4.2.18216; U; en-US) Opera 9.50"]', function() {
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'Pursuit P9020',
      "Expected actual \"Device_Name\" to be 'Pursuit P9020' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Maker'],
      'Pantech',
      "Expected actual \"Device_Maker\" to be 'Pantech' (was '" +
        browser['Device_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Code_Name'],
      'P9020',
      "Expected actual \"Device_Code_Name\" to be 'P9020' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Brand_Name'],
      'Pantech',
      "Expected actual \"Device_Brand_Name\" to be 'Pantech' (was '" +
        browser['Device_Brand_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-317-P ["OneBrowser/3.0 (GT-S5233S/S5233SDDJE2)"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser('OneBrowser/3.0 (GT-S5233S/S5233SDDJE2)');

    assert.strictEqual(
      browser['Comment'],
      'OneBrowser 3.0',
      "Expected actual \"Comment\" to be 'OneBrowser 3.0' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'GT-S5233S',
      "Expected actual \"Device_Name\" to be 'GT-S5233S' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Code_Name'],
      'GT-S5233S',
      "Expected actual \"Device_Code_Name\" to be 'GT-S5233S' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-317-Q ["SonyEricssonW580i/R8BE Profile/MIDP-2.0 Configuration/CLDC-1.1 UNTRUSTED/1.0"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'SonyEricsson',
      "Expected actual \"Comment\" to be 'SonyEricsson' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-317-S ["UTSTARCOM-GTX75/UC1.88 POLARIS/6.00 Profile/MIDP-2.0 Configuration/CLDC-1.1 UNTRUSTED/1.0"]', function() {
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'Quickfire',
      "Expected actual \"Device_Name\" to be 'Quickfire' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Maker'],
      'UTStarcom',
      "Expected actual \"Device_Maker\" to be 'UTStarcom' (was '" +
        browser['Device_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Code_Name'],
      'GTX75',
      "Expected actual \"Device_Code_Name\" to be 'GTX75' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-317-T ["samsung-gt-s3370/UC Browser8.0.3.107/69/444 UNTRUSTED/1.0"]', function() {
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'Corby 3G',
      "Expected actual \"Device_Name\" to be 'Corby 3G' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Code_Name'],
      'GT-S3370',
      "Expected actual \"Device_Code_Name\" to be 'GT-S3370' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-317-U ["LG-GT550/V11b; Mozilla/5.0 (Profile/MIDP-2.0 Configuration/CLDC-1.1; Opera Mini/att/4.2.18377; U; en-US) Opera 9.50"]', function() {
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'Encore',
      "Expected actual \"Device_Name\" to be 'Encore' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Code_Name'],
      'GT550',
      "Expected actual \"Device_Code_Name\" to be 'GT550' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-317-V ["Instagram 5.0.2 (iPhone5,1; iPhone OS 7_0_4; en_US; en) AppleWebKit/420+"]', function() {
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Comment\" to be 'Instagram App 5.0 for iOS' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-317-W ["Airmail 1.3.1 rv:223 (Macintosh; Mac OS X 10.9.1; de_DE)"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Airmail 1.3',
      "Expected actual \"Comment\" to be 'Airmail 1.3' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser'],
      'Airmail',
      "Expected actual \"Browser\" to be 'Airmail' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser_Maker'],
      'Bloop S.R.L.',
      "Expected actual \"Browser_Maker\" to be 'Bloop S.R.L.' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-317-X ["WEB.DE MailCheck/2.4.0"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser('WEB.DE MailCheck/2.4.0');

    assert.strictEqual(
      browser['Comment'],
      'Miscellaneous Browsers',
      "Expected actual \"Comment\" to be 'Miscellaneous Browsers' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser'],
      'WEB.DE MailCheck',
      "Expected actual \"Browser\" to be 'WEB.DE MailCheck' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser_Maker'],
      '1 & 1',
      "Expected actual \"Browser_Maker\" to be '1 & 1' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-317-Y ["Mozilla/5.0 (compatible; CareerBot/1.1; +http://www.career-x.de/bot.html)"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'CareerBot',
      "Expected actual \"Comment\" to be 'CareerBot' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser'],
      'CareerBot',
      "Expected actual \"Browser\" to be 'CareerBot' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser_Maker'],
      'career-x.de',
      "Expected actual \"Browser_Maker\" to be 'career-x.de' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-317-Z ["Screaming Frog SEO Spider/2,22"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser('Screaming Frog SEO Spider/2,22');

    assert.strictEqual(
      browser['Comment'],
      'Screaming Frog SEO Spider 2.22',
      "Expected actual \"Comment\" to be 'Screaming Frog SEO Spider 2.22' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Browser\" to be 'Screaming Frog SEO Spider' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Version'],
      '2.22',
      "Expected actual \"Version\" to be '2.22' (was '" +
        browser['Version'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-317-AA ["Mozilla/5.0 (compatible; oBot/2.3.1; http://filterdb.iss.net/crawler/)"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'oBot',
      "Expected actual \"Comment\" to be 'oBot' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser'],
      'oBot',
      "Expected actual \"Browser\" to be 'oBot' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser_Maker'],
      'IBM',
      "Expected actual \"Browser_Maker\" to be 'IBM' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-317-AB ["Mozilla/5.0 (compatible; SeznamBot/3.1-test1; +http://fulltext.sblog.cz/)"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'SeznamBot',
      "Expected actual \"Comment\" to be 'SeznamBot' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser'],
      'SeznamBot',
      "Expected actual \"Browser\" to be 'SeznamBot' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-317-AC ["Microsoft Office/14.0 (Windows NT 6.1; Microsoft Outlook 14.0.4760; Pro; ms-office; MSOffice 14)"]', function() {
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Comment\" to be 'Microsoft Outlook 2010' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser'],
      'Outlook',
      "Expected actual \"Browser\" to be 'Outlook' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-317-AE ["AndroidDownloadManager/4.3 (Linux; U; Android 4.3; ME302C Build/JSS15Q)"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Android Download Manager 4.3',
      "Expected actual \"Comment\" to be 'Android Download Manager 4.3' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Browser\" to be 'Android Download Manager' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-317-AF ["UCWEB/2.0(Linux; U; Opera Mini/7.1.32052/30.3697; en-us; GT-S5670 Build/GINGERBREAD) U2/1.0.0 UCBrowser/9.4.1.362 Mobile"]', function() {
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'Galaxy Fit',
      "Expected actual \"Device_Name\" to be 'Galaxy Fit' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Code_Name'],
      'GT-S5670',
      "Expected actual \"Device_Code_Name\" to be 'GT-S5670' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-317-AH ["Mozilla/5.0 (compatible; Wada.vn Vietnamese Image Search)"]', function() {
    ...
    assert.strictEqual(
      browser['Browser'],
      'Wada.vn Search Bot',
      "Expected actual \"Browser\" to be 'Wada.vn Search Bot' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser_Maker'],
      'WADA',
      "Expected actual \"Browser_Maker\" to be 'WADA' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-317-AJ ["Mozilla/5.0 (Randomized by FreeSafeIP.com/upgrade-to-remove; compatible; MSIE 9.0; Windows NT 5.0WOW64) Chrome/18.0.1229.79"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Anonymizied',
      "Expected actual \"Comment\" to be 'Anonymizied' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser'],
      'Anonymizied',
      "Expected actual \"Browser\" to be 'Anonymizied' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-317-AL ["Mozilla/5.0 (Windows NT 6.2; WOW64) AppleWebKit/534+ (KHTML, like Gecko)"]', function() {
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Comment\" to be 'Apple Mail for Windows' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-317-AO ["Mozilla/5.0 (Linux; webOS/2.2.4; U; en-US) AppleWebKit/534.6 (KHTML, like Gecko) webOSBrowser/221.56 Safari/534.6 Pre/3.0"]', function() {
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'Pre3',
      "Expected actual \"Device_Name\" to be 'Pre3' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Code_Name'],
      'Pre3',
      "Expected actual \"Device_Code_Name\" to be 'Pre3' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
