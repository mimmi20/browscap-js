...
suite('checking for issue 434. (1 test)', function () {
  test('issue-434 ["Mozilla/5.0 (X11; Ubuntu; Linux i686; rv:28.0) Gecko/20100101 Firefox/28.0"]', function () {
    const browscap = new Browscap();
    const browser = browscap.getBrowser('Mozilla/5.0 (X11; Ubuntu; Linux i686; rv:28.0) Gecko/20100101 Firefox/28.0');

    assert.strictEqual(browser['Comment'], 'Firefox 28.0', 'Expected actual "Comment" to be \'Firefox 28.0\' (was \'' + browser['Comment'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
