...
suite('checking for issue 2111. (1 test)', function() {
  test('issue-2111-A ["Mozilla/5.0 (Linux; U; Android 9; zh-cn; GM1910 Build/PKQ1.190110.001) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/53.0.2785.134 Mobile Safari/537.36 OnePlusBrowser/30.5.0.8"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (Linux; U; Android 9; zh-cn; GM1910 Build/PKQ1.190110.001) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/53.0.2785.134 Mobile Safari/537.36 OnePlusBrowser/30.5.0.8'
    );

    assert.strictEqual(
      browser['Comment'],
      'OnePlus Browser 30.5',
      "Expected actual \"Comment\" to be 'OnePlus Browser 30.5' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
    ...
    assert.strictEqual(
      browser['Browser'],
      'OnePlus Browser',
      "Expected actual \"Browser\" to be 'OnePlus Browser' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Version'],
      '30.5',
      "Expected actual \"Version\" to be '30.5' (was '" +
        browser['Version'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
