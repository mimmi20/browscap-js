...
suite('checking for issue 587.', function () {
  test('issue-587-A ["Mozilla/5.0 (Linux; U; Android 4.4.2; zh-cn; HM NOTE 1LTETD Build/KVT49L) AppleWebKit/533.1 (KHTML, like Gecko)Version/4.0 MQQBrowser/5.4 TBS/025410 Mobile Safari/533.1 MicroMessenger/6.1.0.66_r1062275.542 NetType/cmnet"]', function () {
    ...
    assert.strictEqual(browser['Device_Name'], 'HM NOTE 1LTETD', 'Expected actual "Device_Name" to be \'HM NOTE 1LTETD\' (was \'' + browser['Device_Name'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
    ...
    assert.strictEqual(browser['Device_Code_Name'], 'HM NOTE 1LTETD', 'Expected actual "Device_Code_Name" to be \'HM NOTE 1LTETD\' (was \'' + browser['Device_Code_Name'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
