...
suite('checking for issue 1436. (4 tests)', function () {
  test('issue-1436-A ["Dalvik/1.5.1 (Linux; U; Android 3.2.1; A500 Build/HTK55D)"]', function () {
    ...
    assert.strictEqual(browser['Device_Code_Name'], 'A500', 'Expected actual "Device_Code_Name" to be \'A500\' (was \'' + browser['Device_Code_Name'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
  ...
  test('issue-1436-B ["Dalvik/1.5.1 (Linux; U; Android 3.1; GT-P7510 Build/HMJ37)"]', function () {
    ...
    assert.strictEqual(browser['Device_Type'], 'Tablet', 'Expected actual "Device_Type" to be \'Tablet\' (was \'' + browser['Device_Type'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
    assert.strictEqual(browser['Device_Pointing_Method'], 'touchscreen', 'Expected actual "Device_Pointing_Method" to be \'touchscreen\' (was \'' + browser['Device_Pointing_Method'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
    assert.strictEqual(browser['Device_Code_Name'], 'GT-P7510', 'Expected actual "Device_Code_Name" to be \'GT-P7510\' (was \'' + browser['Device_Code_Name'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
