...
suite('checking for issue 262. (1 test)', function() {
  test('issue-262 ["Mozilla/5.0 (compatible; AhrefsBot/5.0; +http://ahrefs.com/robot/)"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'AhrefsBot',
      "Expected actual \"Comment\" to be 'AhrefsBot' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
    ...
    assert.strictEqual(
      browser['Browser'],
      'AhrefsBot',
      "Expected actual \"Browser\" to be 'AhrefsBot' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'Ahrefs Pte Ltd',
      "Expected actual \"Browser_Maker\" to be 'Ahrefs Pte Ltd' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
