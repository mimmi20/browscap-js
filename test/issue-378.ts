...
suite('checking for issue 378. (21 tests)', function() {
  ...
  test('issue-378-B ["Z15A-Z15A/1.0 Linux/2.6.35.7 Android/4.0 Release/03.25.2013 Browser/AppleWebKit533.1 (KHTML, like Gecko) Mozilla/5.0 Mobile"]', function() {
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'Galaxy S3 Clone',
      "Expected actual \"Device_Name\" to be 'Galaxy S3 Clone' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Code_Name'],
      'Z15A',
      "Expected actual \"Device_Code_Name\" to be 'Z15A' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-378-C ["YahooMobile/1.0 (Yahoo! Search; 3.1.2) (Apple; iPod touch; iPhone OS/7.1.1); YHOO_Search_App/3.1.2"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Yahoo Mobile App 3.1',
      "Expected actual \"Comment\" to be 'Yahoo Mobile App 3.1' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser'],
      'Yahoo Mobile App',
      "Expected actual \"Browser\" to be 'Yahoo Mobile App' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-378-E ["WordPress 4.0-alpha Feed Client Mozilla/5.0 Compatible"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'WordPress 4.0',
      "Expected actual \"Comment\" to be 'WordPress 4.0' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser'],
      'WordPress',
      "Expected actual \"Browser\" to be 'WordPress' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-378-F ["Windows-RSS-Platform/2.0 (IE 11.0; Windows NT 6.3)"]', function() {
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Comment\" to be 'Windows-RSS-Platform 2.0' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Browser\" to be 'Windows-RSS-Platform' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-378-G ["Windows Phone Search (Windows Phone OS 7.10;NOKIA;Lumia 900;7.10;8862)"]', function() {
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Browser\" to be 'Windows Phone Search' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Platform'],
      'WinPhone7.10',
      "Expected actual \"Platform\" to be 'WinPhone7.10' (was '" +
        browser['Platform'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Platform_Version'],
      '7.10',
      "Expected actual \"Platform_Version\" to be '7.10' (was '" +
        browser['Platform_Version'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Platform_Description'],
      'Windows Phone OS 7.10',
      "Expected actual \"Platform_Description\" to be 'Windows Phone OS 7.10' (was '" +
        browser['Platform_Description'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-378-H ["UCWEB/2.0(Linux; U; Opera Mini/7.1.32052/30.3697; fr-fr; MB525 Build/JRDNEM_U3_2.24.0) U2/1.0.0 UCBrowser/9.5.0.360 Mobile"]', function() {
    ...
    assert.strictEqual(
      browser['Device_Code_Name'],
      'MB525',
      "Expected actual \"Device_Code_Name\" to be 'MB525' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-378-I ["UCWEB/2.0 (MIDP-2.0; U; Adr 4.4; en-US; SPHS_on_Hsdroid) U2/1.0.0 UCBrowser/8.9.2.373 U2/1.0.0 Mobile"]', function() {
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Comment\" to be 'UC Browser 8.9 for Android' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'SPHS On HSDroid',
      "Expected actual \"Device_Name\" to be 'SPHS On HSDroid' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Code_Name'],
      'SPHS On HSDroid',
      "Expected actual \"Device_Code_Name\" to be 'SPHS On HSDroid' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-378-J ["Tiny Tiny RSS/1.10 (http://tt-rss.org/)"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Tiny Tiny RSS 1.10',
      "Expected actual \"Comment\" to be 'Tiny Tiny RSS 1.10' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser'],
      'Tiny Tiny RSS',
      "Expected actual \"Browser\" to be 'Tiny Tiny RSS' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-378-K ["stagefright/1.2 (Linux;Android 4.2.1)"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser('stagefright/1.2 (Linux;Android 4.2.1)');

    assert.strictEqual(
      browser['Comment'],
      'stagefright 1.2',
      "Expected actual \"Comment\" to be 'stagefright 1.2' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser'],
      'stagefright',
      "Expected actual \"Browser\" to be 'stagefright' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-378-L ["Screaming Frog SEO Spider/2.40"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser('Screaming Frog SEO Spider/2.40');

    assert.strictEqual(
      browser['Comment'],
      'Screaming Frog SEO Spider 2.40',
      "Expected actual \"Comment\" to be 'Screaming Frog SEO Spider 2.40' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Version'],
      '2.40',
      "Expected actual \"Version\" to be '2.40' (was '" +
        browser['Version'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-378-M ["Readability/de31a5 - http://readability.com/about/"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Readability',
      "Expected actual \"Comment\" to be 'Readability' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser'],
      'Readability',
      "Expected actual \"Browser\" to be 'Readability' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Browser_Maker\" to be 'SFX Entertainment, Inc.' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-378-N ["Opera/9.80 (MTK; Opera Mini/2.1198/34.2336; U; fr) Presto/2.8.119 Version/11.10"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Opera Mini 2.0',
      "Expected actual \"Comment\" to be 'Opera Mini 2.0' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-378-O ["NSPlayer/12.00.9200.16550 WMFSDK/12.00.9200.16550"]', function() {
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Comment\" to be 'Windows Media Player' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser'],
      'Windows Media Player',
      "Expected actual \"Browser\" to be 'Windows Media Player' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-378-P ["NewsBlur Feed Fetcher - 0 subscribers - http://www.newsblur.com/site/1719739/nouvelles-cinema (Mozilla/5.0 (Macintosh; Intel Mac OS X 10_7_1) AppleWebKit/534.48.3 (KHTML, like Gecko) Version/5.1 Safari/534.48.3)"]', function() {
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Browser\" to be 'NewsBlur Feed Fetcher' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser_Maker'],
      'www.newsblur.com',
      "Expected actual \"Browser_Maker\" to be 'www.newsblur.com' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-378-R ["AppleCoreMedia/1.0.0.11D5145e (iPad; U; CPU OS 7_1 like Mac OS X; fr_fr)"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'AppleCoreMedia 1.0',
      "Expected actual \"Comment\" to be 'AppleCoreMedia 1.0' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser'],
      'AppleCoreMedia',
      "Expected actual \"Browser\" to be 'AppleCoreMedia' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
