...
suite('checking for issue 1872. (1 test)', function () {
  test('issue-1872-A ["MauiBot (crawler.feedback+dc@gmail.com)"]', function () {
    const browscap = new Browscap();
    const browser = browscap.getBrowser('MauiBot (crawler.feedback+dc@gmail.com)');
    ...
    assert.strictEqual(browser['Browser'], 'MauiBot', 'Expected actual "Browser" to be \'MauiBot\' (was \'' + browser['Browser'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
