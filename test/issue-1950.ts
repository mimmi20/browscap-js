...
suite('checking for issue 1950. (1 test)', function() {
  test('issue-1950-A ["Mozilla/5.0 (Linux; Android 6.0; Lenovo TB3-X70F Build/MRA58K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/50.0.2661.89 Safari/537.36"]', function() {
    ...
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (Linux; Android 6.0; Lenovo TB3-X70F Build/MRA58K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/50.0.2661.89 Safari/537.36'
    );
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'Tab 3 10 Wi-Fi',
      "Expected actual \"Device_Name\" to be 'Tab 3 10 Wi-Fi' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'TB3-X70F',
      "Expected actual \"Device_Code_Name\" to be 'TB3-X70F' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
