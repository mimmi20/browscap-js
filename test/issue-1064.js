...
suite('checking for issue 1064.', function () {
  test('issue-1064-A ["NL-Crawler"]', function () {
    ...
    assert.strictEqual(browser['Browser_Maker'], 'Northern Light', 'Expected actual "Browser_Maker" to be \'Northern Light\' (was \'' + browser['Browser_Maker'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
