...
suite('checking for issue 975. (1 test)', function() {
  test('issue-975 ["Dalvik/2.1.0 (Linux; U; Android 6.0.1; MI 4LTE MIUI/V7.3.2.0.MXDCNDD) NewsArticle/5.1.3"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'NewsArticle App',
      "Expected actual \"Comment\" to be 'NewsArticle App' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
    ...
    assert.strictEqual(
      browser['Browser'],
      'NewsArticle App',
      "Expected actual \"Browser\" to be 'NewsArticle App' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      '7.3',
      "Expected actual \"Platform_Version\" to be '7.3' (was '" +
        browser['Platform_Version'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'Mi 4 LTE',
      "Expected actual \"Device_Name\" to be 'Mi 4 LTE' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'Mi 4 LTE',
      "Expected actual \"Device_Code_Name\" to be 'Mi 4 LTE' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
