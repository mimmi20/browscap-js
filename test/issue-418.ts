...
suite('checking for issue 418. (3 tests)', function() {
  test('issue-418-A ["Mozilla/5.0 (compatible; 200PleaseBot/1.0; +http://www.200please.com/bot)"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      '200PleaseBot',
      "Expected actual \"Comment\" to be '200PleaseBot' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
    ...
    assert.strictEqual(
      browser['Browser'],
      '200PleaseBot',
      "Expected actual \"Browser\" to be '200PleaseBot' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      '200please.com',
      "Expected actual \"Browser_Maker\" to be '200please.com' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-418-B ["Mozilla/5.0 (compatible; Abonti/0.92 - http://www.abonti.com)"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Abonti WebSearch',
      "Expected actual \"Comment\" to be 'Abonti WebSearch' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser'],
      'Abonti WebSearch',
      "Expected actual \"Browser\" to be 'Abonti WebSearch' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser_Maker'],
      'abonti.com',
      "Expected actual \"Browser_Maker\" to be 'abonti.com' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Version'],
      '0.92',
      "Expected actual \"Version\" to be '0.92' (was '" +
        browser['Version'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-418-C ["GG PeekBot 2.0 ( http://gg.pl/ http://info.gadu-gadu.pl/praca )"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'GG PeekBot',
      "Expected actual \"Comment\" to be 'GG PeekBot' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser'],
      'GG PeekBot',
      "Expected actual \"Browser\" to be 'GG PeekBot' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser_Maker'],
      'gadu-gadu.pl',
      "Expected actual \"Browser_Maker\" to be 'gadu-gadu.pl' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
