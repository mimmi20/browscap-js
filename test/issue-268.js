...
suite('checking for issue 268. (1 test)', function () {
  test('issue-268 ["Mozilla/5.0 (compatible; Embedly/0.2; snap; +http://support.embed.ly/)"]', function () {
    ...
    assert.strictEqual(browser['Browser_Maker'], 'embed.ly', 'Expected actual "Browser_Maker" to be \'embed.ly\' (was \'' + browser['Browser_Maker'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
