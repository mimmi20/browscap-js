...
suite('checking for issue 2204. (3 tests)', function() {
  test('issue-2204-A ["Mozilla/5.0 (Windows; U; Windows NT 10.0; en-US; Valve Steam Client/pw_csgo/1576550251; ) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.120 Safari/537.36"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (Windows; U; Windows NT 10.0; en-US; Valve Steam Client/pw_csgo/1576550251; ) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.120 Safari/537.36'
    );
  ...
  test('issue-2204-B ["Mozilla/5.0 (Windows; U; Windows NT 10.0; en-US; Valve Steam Client/pw_dota2/1576550241; ) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.120 Safari/537.36"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (Windows; U; Windows NT 10.0; en-US; Valve Steam Client/pw_dota2/1576550241; ) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.120 Safari/537.36'
    );
  ...
  test('issue-2204-C ["Mozilla/5.0 (Windows; U; Windows NT 10.0; en-US; Valve Steam Client/default/1579321278; ) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.120 Safari/537.36"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (Windows; U; Windows NT 10.0; en-US; Valve Steam Client/default/1579321278; ) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.120 Safari/537.36'
    );
