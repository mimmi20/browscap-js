...
suite('checking for issue 236.', function () {
  test('issue-236 ["Mozilla/5.0 (compatible;picmole/1.0 +http://www.picmole.com)"]', function () {
    ...
    assert.strictEqual(browser['Browser_Maker'], 'picmole.com', 'Expected actual "Browser_Maker" to be \'picmole.com\' (was \'' + browser['Browser_Maker'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
