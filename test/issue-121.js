...
suite('checking for issue 121.', function () {
  test('issue-121 ["Mozilla/5.0 (Windows; U; Windows NT 5.1; de; rv:1.9.0.7) Gecko/2009021910 Firefox/3.0.7 (via ggpht.com GoogleImageProxy)"]', function () {
    ...
    assert.strictEqual(browser['Comment'], 'Google Image Proxy', 'Expected actual "Comment" to be \'Google Image Proxy\' (was \'' + browser['Comment'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
