...
suite('checking for issue 409. (1 test)', function () {
  test('issue-409 ["CRAZYWEBCRAWLER 0.9.0, http://www.crazywebcrawler.com"]', function () {
    const browscap = new Browscap();
    const browser = browscap.getBrowser('CRAZYWEBCRAWLER 0.9.0, http://www.crazywebcrawler.com');

    assert.strictEqual(browser['Comment'], 'Crazywebcrawler', 'Expected actual "Comment" to be \'Crazywebcrawler\' (was \'' + browser['Comment'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
    assert.strictEqual(browser['Browser'], 'Crazywebcrawler', 'Expected actual "Browser" to be \'Crazywebcrawler\' (was \'' + browser['Browser'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
    ...
    assert.strictEqual(browser['Browser_Maker'], 'crazywebcrawler.com', 'Expected actual "Browser_Maker" to be \'crazywebcrawler.com\' (was \'' + browser['Browser_Maker'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
