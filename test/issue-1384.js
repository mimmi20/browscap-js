...
suite('checking for issue 1384. (3 tests)', function () {
  test('issue-1384-A ["Mozilla/5.0 (Linux; Android 7.0; F5321 Build/34.2.A.0.333; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/57.0.2987.132 Mobile Safari/537.36"]', function () {
    ...
    assert.strictEqual(browser['Comment'], 'Android WebView 57.0', 'Expected actual "Comment" to be \'Android WebView 57.0\' (was \'' + browser['Comment'] + '\'; used pattern: ' + browser['browser_name_regex'] + ')');
