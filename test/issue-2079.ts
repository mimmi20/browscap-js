...
suite('checking for issue 2079. (1 test)', function() {
  test('issue-2079-A ["Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/75.0.3738.0 Safari/537.36 Edg/75.0.107.0"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Edge 75.0',
      "Expected actual \"Comment\" to be 'Edge 75.0' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
    ...
    assert.strictEqual(
      browser['Version'],
      '75.0',
      "Expected actual \"Version\" to be '75.0' (was '" +
        browser['Version'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
