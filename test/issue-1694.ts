...
suite('checking for issue 1694. (1 test)', function() {
  test('issue-1694-A ["Mozilla/5.0 (Linux; Android 4.4.4; Vodafone Smart Tab 4G Build/KTU84P) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/33.0.0.0 Safari/537.36 Tablet SznProhlizec/4.0.2a"]', function() {
    ...
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (Linux; Android 4.4.4; Vodafone Smart Tab 4G Build/KTU84P) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/33.0.0.0 Safari/537.36 Tablet SznProhlizec/4.0.2a'
    );

    assert.strictEqual(
      browser['Comment'],
      'Seznam Browser 4.0',
      "Expected actual \"Comment\" to be 'Seznam Browser 4.0' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
