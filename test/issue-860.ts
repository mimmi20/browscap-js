...
suite('checking for issue 860. (2 tests)', function() {
  test('issue-860-A ["SoundCloud/3.0.0 build 2547; iPhone/iPhone OS/7.1.1"]', function() {
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Comment\" to be 'SoundCloud App 3.0 for iOS' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
    ...
    assert.strictEqual(
      browser['Browser'],
      'SoundCloud App',
      "Expected actual \"Browser\" to be 'SoundCloud App' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      'SoundCloud Limited',
      "Expected actual \"Browser_Maker\" to be 'SoundCloud Limited' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-860-B ["SoundCloud-Android/14.08.21-17 (Android 4.4.2; samsung SAMSUNG-SGH-I337)"]', function() {
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Comment\" to be 'SoundCloud App 14.08 for Android' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Version'],
      '14.08',
      "Expected actual \"Version\" to be '14.08' (was '" +
        browser['Version'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
