...
suite('checking for issue 1296. (1 test)', function() {
  test('issue-1296-A ["Mozilla/5.0 (Linux; Android 6.0; Archos 97c Platinum Build/MRA58K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/52.0.2743.98 Safari/537.36"]', function() {
    ...
    let browser = browscap.getBrowser(
      'Mozilla/5.0 (Linux; Android 6.0; Archos 97c Platinum Build/MRA58K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/52.0.2743.98 Safari/537.36'
    );
    ...
    assert.strictEqual(
      browser['Device_Name'],
      '97c Platinum',
      "Expected actual \"Device_Name\" to be '97c Platinum' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      ...
      '97c Platinum',
      "Expected actual \"Device_Code_Name\" to be '97c Platinum' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
