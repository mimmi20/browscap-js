...
suite('checking for issue 1044. (5 tests)', function() {
  test('issue-1044-A ["Mozilla/4.0 (compatible; Lotus-Notes/5.0; Windows-NT)"]', function() {
    ...
    assert.strictEqual(
      browser['Comment'],
      'Lotus Notes 5.0',
      "Expected actual \"Comment\" to be 'Lotus Notes 5.0' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
    ...
    assert.strictEqual(
      browser['Browser'],
      'Lotus Notes',
      "Expected actual \"Browser\" to be 'Lotus Notes' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1044-B ["YahooMobileMail/1.0 (Android Mail; 1.3.10) (supersonic;HTC;PC36100;2.3.5/GRJ90)"]', function() {
    ...
    assert.strictEqual(
      ...
      "Expected actual \"Comment\" to be 'Yahoo Mail Mobile 1.0' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser'],
      'Yahoo Mail Mobile',
      "Expected actual \"Browser\" to be 'Yahoo Mail Mobile' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Name'],
      'EVO 4G',
      "Expected actual \"Device_Name\" to be 'EVO 4G' (was '" +
        browser['Device_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Device_Code_Name'],
      'PC36100',
      "Expected actual \"Device_Code_Name\" to be 'PC36100' (was '" +
        browser['Device_Code_Name'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1044-C ["Barca/2.8.2"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser('Barca/2.8.2');

    assert.strictEqual(
      browser['Comment'],
      'Barca Mail Client',
      "Expected actual \"Comment\" to be 'Barca Mail Client' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser'],
      'Barca Mail Client',
      "Expected actual \"Browser\" to be 'Barca Mail Client' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser_Maker'],
      'Poco Systems Inc.',
      "Expected actual \"Browser_Maker\" to be 'Poco Systems Inc.' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
  ...
  test('issue-1044-D ["BarcaPro/1.4.12"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser('BarcaPro/1.4.12');
  ...
  test('issue-1044-E ["The Bat! 4.0.0.22"]', function() {
    let browscap = new Browscap();
    let browser = browscap.getBrowser('The Bat! 4.0.0.22');

    assert.strictEqual(
      browser['Comment'],
      'The Bat!',
      "Expected actual \"Comment\" to be 'The Bat!' (was '" +
        browser['Comment'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser'],
      'The Bat!',
      "Expected actual \"Browser\" to be 'The Bat!' (was '" +
        browser['Browser'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
    ...
    assert.strictEqual(
      browser['Browser_Maker'],
      'Ritlabs SRL.',
      "Expected actual \"Browser_Maker\" to be 'Ritlabs SRL.' (was '" +
        browser['Browser_Maker'] +
        "'; used pattern: " +
        browser['browser_name_regex'] +
        ')'
